...
### runs/2026-09-25-53/target.json
...
### runs/2026-09-25-53/research.json
...
```json
{
  ...
  "research_questions": [
    ...
    "IDTA 02047 템플릿 JSON 원문에서 ECLASS 분류 클래스 코드(0173-1#01-…)는 어느 요소에 붙으며, 무인운반차·이동로봇 자체를 가리키는 클래스가 있는가? (단계 1 페이지 3절 q1-09 겨냥)",
    "IDTA 공식 저장소에 이동로봇·스킬·충전을 다루는 다른 게시 서브모델 템플릿이 있는가? (q1-09 의미 식별자 원천 후보, 16. 공용 자원·충전·에너지 최적화 연결)",
    "AAS 기술 데이터 틀(IDTA 02003·ZVEI Technical Data)의 제품 분류 항목은 어떤 의미 식별자를 쓰며 최신판 2.0.1 에서 바뀌었는가? (제품 분류 층 식별자 추정 보강)",
    "ECLASS·IEC CDD 에 무인운반차(FTF)·자율이동로봇 클래스나 ISO 22166 계열 속성이 등록되었다는 공개 자료가 있는가(영·독 검색)?",
    "국내 자료에 ECLASS 기반 물류로봇 분류·속성 사전이나 AAS 의미 식별자 적용을 다룬 것이 있는가? (한국 자료 우선 규칙)"
  ],
  "findings": [
    {
      "id": "f1",
      "claim": "IDTA 02047 무인운반차 기술 데이터 1.0 템플릿 JSON 에서 ECLASS 분류 클래스 코드(0173-1#01-…)는 GeneralInformation(0173-1#02-ABK161#002/0173-1#01-AHX838#002), 제품 이미지(0173-1#02-ABM220#001/0173-1#01-AHY911#001), SpecificDescriptions(0173-1#02-ABM221#001/0173-1#01-AHY912#001) 같은 일반 블록의 복합 의미 식별자에만 나타나고, 무인운반차·이동로봇 자체를 가리키는 클래스 코드로 쓰인 곳은 열람 범위에서 확인되지 않았다.",
      "tag": "사실",
      "source_ids": [
        "ref-245"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "원문 JSON 줄 인용: \"0173-1#02-ABM220#001/0173-1#01-AHY911#001\", \"0173-1#02-ABM221#001/0173-1#01-AHY912#001\" 등 6줄. 같은 블록에 https://api.eclass-cdp.com/ 형식 식별자도 병기. 열람 응답은 DecelerationMax 에서 절단되어 그 뒤 요소는 대상 밖(확인일 2026-09-25)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null
    },
    {
      "id": "f2",
      "claim": "다섯 번째 실행에서도 IDTA 02047 템플릿 JSON 열람 응답은 최상위 GeneralInformation·SpecificDescriptions 뒤 TechnicalParameters 의 DecelerationMax 에서 잘려 Charg·Battery·Energy·VDA5050 문자열이 보이지 않았으므로, 템플릿 원문으로는 충전 요소 유무를 판정할 수 없고 oq-060 출처 충돌은 이번에도 해소되지 않는 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-245",
        "ref-198"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "열람 응답: 'Last visible idShort: DecelerationMax', 'The content appears truncated'. 명세 PDF 검색 요약(ref-198, 원문 미열람)은 EnergyAndCommunication/Battery 묶음을 전함 — 한쪽을 고르지 않음",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
    ...
    {
      "id": "f3",
      "claim": "IDTA 공식 서브모델 템플릿 저장소 README 의 게시 목록에서 기술 데이터·능력·AGV·배터리 관련 게시 템플릿은 Technical Data 1.1·2.0.1, Capability Description 1.0, Technical Data for Automated Guided Vehicles 1.0 과 Digital Battery Passport Part 1~7 이며, 로봇·스킬·충전·모바일을 이름에 둔 게시 템플릿은 목록에서 확인되지 않았다.",
      "tag": "사실",
      "source_ids": [
        "ref-439"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "README 표 기준: Digital Battery Passport Part 4: Technical Data 1.0.1 (published/Digital%20Battery%20Passport/4_Technical%20Data/1/0/1) 등. 'No templates matching Robot, Charging, Skill, or Mobile' (열람 요약, 확인일 2026-09-25, 목록 기준의 부재 관찰)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
    ...
    {
      "id": "f4",
      "claim": "IDTA 공식 저장소에 배터리 관련 템플릿이 Digital Battery Passport 계열로 게시되어 있지만, 그것이 이동로봇의 범위 능력 '충전'(충전 장치 요구·충전 조건)을 기술하는지는 확인하지 않았으므로, 충전 속성의 의미 식별자 원천 후보일 뿐인 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-439"
      ],
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "게시 목록에 Digital Battery Passport Part 1~7(명판·인계 문서·탄소 발자국·기술 데이터·제품 상태·물질 구성·순환성) 존재. 각 템플릿 본문은 미열람",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f5",
      "claim": "IDTA 02003 기술 데이터 일반 틀 2.0.1 README 는 2.0 의 GitHub 이슈 6건을 고친 버그 수정판으로 예시값 한정자·ProductImages→ProductImage 이름 변경·TechnicalPropertyAreas 카디널리티·의미 식별자 구분을 다루며, 제품 분류 항목·ECLASS·IEC CDD 에 관한 변경은 적지 않는다.",
      "tag": "사실",
      "source_ids": [
        "ref-659"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "README: 'ready for productive use', ProductImages 를 ProductImage 로 개명, TechnicalPropertyAreas SML 카디널리티 0..1 로 수정. ProductClassifications·ECLASS·IEC CDD 언급 없음(발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null
    },
    {
      "id": "f6",
      "claim": "ZVEI 기술 데이터 서브모델 1.1 명세에서 제품 분류 항목(ProductClassificationItem)은 https://admin-shell.io/ZVEI/TechnicalData/ProductClassificationItem/1/1 의미 식별자를 가진 요소 모음으로 제품을 특정 분류 체계·속성 사전의 제품 클래스와 연결하며, 분류 체계 이름(ProductClassificationSystem)은 …/ProductClassificationSystem/1/1 식별자를 가진다.",
      "tag": "사실",
      "source_ids": [
        "ref-660",
        "ref-438"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: ProductClassificationItem 'single product classification by association with a product class in a particular classification system or property dictionary'. ZVEI 1.1 과 IDTA 02003-1-2 는 승계 관계라 독립 출처 아님",
      "as_of": "2020-11",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f7",
      "claim": "다섯 번째 실행의 영·독·한 검색에서도 ECLASS 에 무인운반차(FTF)·자율이동로봇을 가리키는 분류 클래스 코드나 IEC CDD 에 로봇 도메인·ISO 22166 계열 속성이 등록됐다는 공개 자료는 나오지 않아, 웹 검색만으로는 q1-09 의 항목 존재 여부를 판정할 수 없는 것으로 보인다(데이터베이스 미조회, 부재 확정 아님).",
      "tag": "추정",
      "source_ids": [
        "ref-184",
        "ref-185",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "검색어: 'fahrerloses Transportfahrzeug' ECLASS IRDI, 'automated guided vehicle' 0173-1#01, 'cdd.iec.ch robot ISO 22166', ECLASS 16.0 Robotik. 결과는 ECLASS 기술 명세 페이지·특허·기사뿐(발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f8",
      "claim": "IDTA 02047 템플릿의 ECLASS 분류 클래스 코드가 일반 블록에만 붙고(f1) 제품 분류 항목이 분류 체계·클래스를 값으로 지정하게 하는 구조(f6)를 보면, 분류 원문 질문(누가 이 화물을 취급할 수 있는가)에 쓰일 로봇 제품 클래스는 템플릿이 고정하지 않고 제조사가 인스턴스 값으로 채우는 것이어서, ROP 는 제품 클래스 값이 없거나 제조사마다 다를 때를 대비한 자체 분류를 가져야 할 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-245",
        "ref-660"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "f1(템플릿 원문)과 f6(검색 요약)을 대응시킨 이 위키의 추론",
      "as_of": "2026-09-25",
      "flow_step": "적치",
      "flow_item": "수행 자원",
      "source_unopened": false
  ...
  "sources": [
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "IDTA 02047 무인운반차 기술 데이터 1.0 서브모델 템플릿 JSON. 이번 열람도 DecelerationMax 에서 절단.",
      "fetched": true,
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "IDTA 공식 서브모델 템플릿 저장소 README 의 게시 템플릿 목록.",
      "fetched": false,
      "fetched_via": null,
    ...
    },
    {
      "id": "ref-659",
      "org": "IDTA (admin-shell-io/submodel-templates)",
      "title": "Generic Frame for Technical Data for Industrial Equipment in Manufacturing 2.0.1 — README (published/Technical_Data/2/0/1)",
      "published": null,
      "url": "https://github.com/admin-shell-io/submodel-templates/blob/main/published/Technical_Data/2/0/1/README.md",
      "type": "표준",
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "IDTA 02003 기술 데이터 일반 틀 2.0.1 버그 수정판의 변경 요약 README.",
      "fetched": true,
      "fetched_via": "github_raw",
      "fetch_url": "https://raw.githubusercontent.com/admin-shell-io/submodel-templates/main/published/Technical_Data/2/0/1/README.md",
      "source_unopened": false
    },
    {
      "id": "ref-660",
      "org": "ZVEI / Plattform Industrie 4.0",
      "title": "Submodel Templates of the Asset Administration Shell — ZVEI Technical Data Version 1.1",
      "published": "2020-11",
      "url": "https://www.zvei.org/fileadmin/user_upload/Presse_und_Medien/Publikationen/2020/Dezember/Submodel_Templates_of_the_Asset_Administration_Shell/201117_I40_ZVEI_SG2_Submodel_Spec_ZVEI_Technical_Data_Version_1_1.pdf",
      "type": "표준",
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. ZVEI 기술 데이터 서브모델 1.1 명세(IDTA 02003 의 전신)로, 제품 분류 항목과 분류 체계 이름 요소의 의미 식별자를 정의한다(검색 요약 기준).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. IDTA 02003 1.2 기술 데이터 일반 틀. 제품 분류 항목으로 ECLASS·IEC CDD 제품 클래스를 가리킨다.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. IDTA 02047 1.0 명세 PDF. 검색 요약상 EnergyAndCommunication/Battery 묶음과 충전 관련 요소를 둔다.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. IEC TC 3 의 IEC CDD 안내 페이지(제품 온톨로지 도메인 목록).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. ECLASS 분류 클래스 구조(4단계 8자리 코드, IRDI) 설명.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. ECLASS 최신 판(16.0) 안내.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
  ...
  "page_proposals": [
    ...
    },
    {
      ...
      "rationale": "트랙 산출물 갱신: IDTA 02047 행 종류 칸의 ECLASS 분류 클래스 코드 메모에 AHY911(제품 이미지)·AHY912(SpecificDescriptions) 복합 식별자 추가(f1), 상태 칸에 실행 2026-09-25-53 재열람도 절단(f2)"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 manual-capability-ontology 단계 1 반영 제안 (f3, f6): IDTA 게시 템플릿 목록에 이동로봇 능력·충전 전용 템플릿이 없고 Digital Battery Passport 계열이 있음, 기술 데이터 제품 분류 항목의 의미 식별자"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 manual-capability-ontology 단계 1 반영 제안 (f3, f4): IDTA Digital Battery Passport 계열 템플릿이 배터리 속성의 의미 식별자 원천 후보(본문 미열람, 추정)"
    }
  ],
  "glossary_candidates": [],
  "open_questions_new": [],
...
### runs/2026-09-25-53/verification.json
...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "부분 확인: 검증 열람에서도 DecelerationMax 에서 잘렸고 Charg·Battery·Energy 문자열은 보이지 않았다. 그러나 'VDA5050' 문자열은 잘리기 전 범위에서 보였다(기구학 유형·차량 등급·위치추정·주행 방식 값 설명). 주장 가운데 'VDA5050 문자열이 보이지 않았다'는 부분은 검증 결과와 맞지 않는다(required_fixes). ref-198 은 원문 미열람이다. oq-060 은 해소되지 않았으며 [추정]을 유지한다."
    },
    {
      "finding_id": "f3",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: 검증자가 저장소 README 를 raw 경로로 열었다. Technical Data 1.1·2.0.1, Capability Description 1.0, Technical Data for AGV 1.0, Digital Battery Passport Part 1~7(1.0 또는 1.0.1)을 확인했다. 이름에 Robot·Skill·Charging·Mobile 이 들어간 템플릿은 없다. 브리프는 ref-439 를 fetched=false·source_unopened=true 로 적었지만 self_check.limits 에는 raw 로 열었다고 적어 표시가 서로 어긋난다. evidence_excerpt 의 영어 문장은 열람 도구의 요약이며 원문 인용이 아니다. 목록 이름 기준의 부재 관찰이다."
    },
    {
      "finding_id": "f4",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "Digital Battery Passport Part 1~7 이 있다는 점은 README 로 확인했다. 템플릿 본문은 미열람이다. 충전 능력과의 관련성은 추론이므로 [추정] low 를 유지한다."
    },
    {
      "finding_id": "f5",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: 2.0.1 README 를 raw 로 열었다. 2.0 의 버그 수정판이며 이슈 #190·#178·#174·#173·#168·#161(6건)을 다룬다. ProductImages→ProductImage 개명, TechnicalPropertyAreas 카디널리티 0..1, 중복 semanticId 제거가 있다. ProductClassifications·ECLASS·IEC CDD 언급은 없다. 발행일은 미확인이다."
    },
    {
      "finding_id": "f6",
      "source_exists": true,
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "검색 결과 기준의 부재 관찰이며 데이터베이스는 미조회다. 실행 2026-09-25-41·45·47 의 같은 관찰을 되풀이한다. [추정] low 를 유지한다. ref-183·184·185 는 원문 미열람이다."
    },
    {
      "finding_id": "f8",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "f1(원문)과 f6(검색 요약)을 대응시킨 이 위키의 추론이다. [추정] low 를 유지한다. 실행 2026-09-25-47 의 '세 층 의미 식별자' 추정과 겹치므로 새 결론이 아니라 보강으로 쓴다."
    }
  ],
  "category_fit": {
    "ok": true,
  ...
  "duplication": {
    "ok": false,
    "overlaps": [
      "f1 의 GeneralInformation 복합 식별자(0173-1#02-ABK161#002/0173-1#01-AHX838#002)는 단계 1 페이지 3절 q1-09 부분 답(실행 2026-09-25-35)에 이미 있다. 새 내용은 AHY911·AHY912 두 식별자뿐이다",
      "f7 은 실행 2026-09-25-41·45·47 의 ECLASS·IEC CDD 미검출 관찰을 되풀이한다",
      "f8 은 실행 2026-09-25-47 의 '세 층 의미 식별자' 추정과 겹친다",
      "f6 은 실행 2026-09-25-47 의 IDTA 02003 제품 분류 항목(ref-438) 서술을 식별자 수준으로 보강한다(승계 관계)",
      "f2 는 oq-060 출처 충돌의 근거 보강이며 해소가 아니다"
    ]
  },
  "terminology": {
    "ok": true,
  ...
  "quotation_check": {
    "ok": true,
    "issues": [
      "f3 evidence_excerpt 의 'No templates matching Robot, Charging, Skill, or Mobile' 은 열람 도구 요약문이며 원문 인용이 아니다. 페이지에서 직접 인용으로 쓰지 않는다"
    ]
  },
  "corrections_applied": [],
...
```json
{
  ...
  "outline": [
    {
      ...
      "section": "3. 조사 결과",
      "budget_chars": 2200,
      "summary": "q1-09 부분 답에 '실행 2026-09-25-53 보강' 소절을 덧붙인다. IDTA 02047 템플릿에서 새로 확인한 제품 이미지·SpecificDescriptions 복합 식별자(AHY911·AHY912)만 새 사실로 적고 [사실][^ref-245], 게시 템플릿 목록·IDTA 02003 2.0.1·제품 분류 항목 식별자를 보강한다.",
      "planned_findings": [
        "f1",
        "f2",
        "f3",
    ...
    },
    {
      ...
      "budget_chars": 900,
      "summary": "다섯 실행이 같은 벽(ECLASS·IEC CDD 데이터베이스 미조회)에 막혔으며 사용자 결정이 필요하다는 점과 oq-060 미해소를 적는다.",
      "planned_findings": [
        "f1",
        "f3",
        "f6"
    ...
    },
    {
      ...
      "budget_chars": 300,
      "summary": "새 질문 q4-16(Digital Battery Passport 배터리 요소 재사용, 단계 4, f4)을 표에 더한다.",
      "planned_findings": [
        "f4"
      ]
    },
    {
      ...
      "budget_chars": 200,
      "summary": "두 완료 조건 모두 미충족·미승인 유지, 전환 아니오."
    },
    {
      "path": "docs/tracks/manual-capability-ontology/stage-1-existing-models-and-standards.md",
      "section": "7. 관련 세부영역",
      "budget_chars": 400,
      "summary": "5·16·28 세부영역 7절 반영 제안을 적는다."
    },
    {
      "path": "docs/tracks/manual-capability-ontology/model-standard-comparison.md",
      "section": "4. 비교표",
      "budget_chars": 300,
      "summary": "IDTA 02047 행 종류 칸에 AHY911·AHY912 복합 식별자 [사실], 상태 칸에 재열람 절단 추가.",
      "planned_findings": [
        "f1",
        "f2"
      ]
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q1-09 부분 답에 실행 2026-09-25-53 보강 소절 추가(AHY911·AHY912 복합 식별자, 템플릿 열람 다섯 번째 절단, 게시 템플릿 목록, IDTA 02003 2.0.1, 제품 분류 항목 식별자), 4절 결론·사용자 결정 필요, 새 질문 q4-16, 6절 미충족 유지, 7절 반영 제안, 출처 ref-659·ref-660, 이력 행 추가",
      "patches": [
        {
          "section": "3. 조사 결과",
          "action": "append",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-53/pages/tracks/manual-capability-ontology/stage-1-existing-models-and-standards.md 의 해당 절을 본다)"
        },
        {
          "section": "4. 결론과 남은 불확실성",
          "action": "append",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "IDTA 02047 행 종류 칸에 제품 이미지(AHY911)·SpecificDescriptions(AHY912) 복합 식별자 [사실] 추가, 상태 칸에 실행 2026-09-25-53 재열람 절단 추가, 이력 행 추가",
      "patches": [
        {
          "section": "4. 비교표",
          "action": "replace",
          "content": "(절 본문 생략 — runs/2026-09-25-53/pages/tracks/manual-capability-ontology/model-standard-comparison.md 의 해당 절을 본다)"
        },
        {
          "section": "8. 이력",
          "action": "replace",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "4절에 실행 2026-09-25-53 발견(게시 템플릿 목록·Digital Battery Passport 후보·제품 분류 항목 식별자·제품 클래스 인스턴스 값) 문단과 각주 추가",
      "patches": [
        {
          "section": "4. 필요한 데이터와 표준",
          "action": "append",
          "content": "(절 본문 생략 — runs/2026-09-25-53/pages/ideas/robot-capability-ontology.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
  "changelog_entry": "2026-09-25 | 매뉴얼 기반 로봇 기능 온톨로지 단계 1 | q1-09 부분 답 보강(AHY911·AHY912 복합 식별자, 게시 템플릿 목록, IDTA 02003 2.0.1, 제품 분류 항목 식별자), 새 질문 q4-16, 온톨로지 변경 없음(v0.3), 다섯 실행 막힘으로 사용자 결정 필요 | run 2026-09-25-53",
  "index_updates": {
    "home_recent": "2026-09-25 — 매뉴얼 기반 로봇 기능 온톨로지 단계 1: q1-09(ECLASS·IEC CDD 이동로봇 항목) 다섯 번째 부분 답 보강, 새 질문 1건, 데이터베이스 조회 결과 제공 또는 q1-09 보류에 대한 사용자 결정 필요",
    "category_recent": "2026-09-25 — 5. 로봇 능력·작업 온톨로지(트랙 단계 1): IDTA 02047 템플릿의 ECLASS 분류 클래스 코드가 일반 블록에만 쓰임을 추가 확인, IDTA 게시 템플릿 목록과 제품 분류 항목 식별자 보강",
    "area_recent": "2026-09-25 — 5. 로봇 능력·작업 온톨로지: 트랙 단계 1 실행에서 로봇 제품 클래스가 인스턴스 값이라 ROP 자체 분류가 필요하다는 추정을 7. 관련 표준·프레임워크·오픈소스 절 반영 제안으로 냄"
  },
  "glossary_updates": [],
  "reference_updates": [
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "IDTA 02003 기술 데이터 일반 틀 2.0.1 버그 수정판의 변경 요약 README. 제품 분류 항목·ECLASS·IEC CDD 변경은 적지 않는다.",
      "source_unopened": false,
      "cited_by": [
    ...
    },
    {
      "id": "ref-660",
      "org": "ZVEI / Plattform Industrie 4.0",
      "title": "Submodel Templates of the Asset Administration Shell — Generic Frame for Technical Data for Industrial Equipment in Manufacturing (Version 1.1)",
      "published": "2020-11",
      "url": "https://www.zvei.org/fileadmin/user_upload/Presse_und_Medien/Publikationen/2020/Dezember/Submodel_Templates_of_the_Asset_Administration_Shell/201117_I40_ZVEI_SG2_Submodel_Spec_ZVEI_Technical_Data_Version_1_1.pdf",
      "type": "표준",
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. ZVEI 기술 데이터 서브모델 1.1 명세(IDTA 02003 의 전신)로, 제품 분류 항목의 의미 식별자를 정의한다(검색 요약 기준).",
      "source_unopened": true,
      "cited_by": [
        "docs/tracks/manual-capability-ontology/stage-1-existing-models-and-standards.md",
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "IDTA 공식 서브모델 템플릿 저장소 README 의 게시 템플릿 목록(검증자가 raw 경로로 열어 확인).",
      "source_unopened": false,
      "cited_by": [
        "docs/tracks/manual-capability-ontology/stage-1-existing-models-and-standards.md",
        "docs/ideas/robot-capability-ontology.md"
  ...
  "additional_research_requests": [
    "단계 1 q1-09 핵심(ECLASS 콘텐츠 데이터베이스 15.0·16.0 과 IEC CDD 트리에 무인운반차·자율이동로봇 분류 클래스와 범위 능력 이동·계단·적재·도어 조작·충전 항목이 있는가): 다섯 실행이 네트워크 정책으로 조회하지 못했으므로, 사용자가 eclass.eu 콘텐츠 검색과 cdd.iec.ch 의 'AGV·FTF·autonomous mobile robot' 조회 결과를 inbox/sources 로 넣어 주거나 q1-09 를 사유·재개 조건과 함께 보류할지 결정이 필요하다.",
    "oq-060 해소용: IDTA 02047 템플릿 JSON 을 절단 없이 읽을 수 있는 경로(AASX 파일, 분할 열람 등)나 명세 PDF 원문으로 EnergyAndCommunication/Battery 충전 요소 유무를 확인해 달라. 단계 페이지 3절 q1-09 와 비교표 IDTA 02047 행에 필요하다.",
    "q4-16 준비: Digital Battery Passport Part 4(기술 데이터) 템플릿 본문의 배터리 요소와 의미 식별자를 원문으로 확인해 달라. 16. 공용 자원·충전·에너지 최적화 반영 제안의 근거가 추정에 머물러 있다.",
    "ZVEI 1.1·IDTA 02003 2.0.1 의 ProductClassificationSystem 요소 의미 식별자와 2.0.1 템플릿의 ProductClassificationItem 식별자를 원문으로 확인해 달라(단계 페이지 3절 제품 분류 항목 단락에서 미확인으로 둠).",
    "IDTA 02047 템플릿 복합 식별자의 ECLASS 분류 클래스 AHX838·AHY911·AHY912 의 명칭을 확인해 달라."
  ],
  "fixes_applied": [
    "f1 새 사실 범위 — 3절 '실행 2026-09-25-53 보강'에서 제품 이미지(AHY911)·SpecificDescriptions(AHY912) 복합 식별자만 새 [사실]로 적고 GeneralInformation(ABK161/AHX838)은 실행 2026-09-25-35 부분 답을 가리키는 데 그쳤다.",
    "f2 VDA5050 삭제 — 절단 문장을 'Charg·Battery·Energy 문자열이 보이지 않았다'로 쓰고 VDA5050 을 뺐으며, [추정] 태그로 ref-245·ref-198 을 한쪽을 고르지 않고 병기하고 oq-060 을 열림으로 두었다.",
    "f6 식별자 범위 — ProductClassificationItem 식별자(…/ProductClassificationItem/1/1)만 [사실]로 쓰고 ProductClassificationSystem 식별자는 '미확인'으로 두었다.",
    "ref-660 각주 — 제목을 'Submodel Templates of the Asset Administration Shell — Generic Frame for Technical Data for Industrial Equipment in Manufacturing (Version 1.1)', 발행일 2020-11, 접근일 뒤 ' (원문 미열람)'으로 단계 페이지 8절·아이디어 페이지에 정의하고 reference_updates 에서 source_unopened true 로 두었다.",
    "ref-659 각주 — 발행일 자리에 '미확인'을 쓰고 '(원문 미열람)'을 붙이지 않았다.",
    "ref-439 각주 — 단계 페이지의 기존 각주('(원문 미열람)' 없음)를 그대로 두었고 아이디어 페이지에도 같은 형식으로 정의했으며 reference_updates 의 source_unopened 를 false 로 두었다.",
    "ref-198·ref-183·ref-184·ref-185·ref-438 각주 — 단계 페이지 8절의 기존 ' (원문 미열람)' 표기를 바꾸지 않았다.",
    "f7·f8 — f7 은 '다섯 번째 실행에서도 같은 관찰(부재 확정 아님)' 단락으로, f8 은 실행 2026-09-25-47 세 층 추정의 보강으로 [추정] 태그와 함께 짧게 썼다.",
    "f3 재서술 — evidence_excerpt 의 영어 문장을 인용하지 않고 'README 게시 목록 이름 기준의 부재 관찰'로 재서술했다.",
    "q1-09 상태 — 답함으로 바꾸지 않고 backlog_updates 에 조사 중·answer_link null 로 냈으며, 2절 표는 열림 그대로 두고, 새 소절 제목에 명시 id 를 붙이지 않았고, 4절에 다섯 실행이 같은 벽에 막혀 사용자 결정(조회 결과 제공 또는 사유·재개 조건을 적은 보류)이 필요하다고 적었다.",
    "새 질문 등록 — Digital Battery Passport 배터리 요소 재사용 질문을 q4-16(단계 4, origin f4)으로 backlog_updates 에 등록하고 5절 표에 행을 추가했다.",
    "단계 페이지 6절 — 두 완료 조건 모두 '미충족 · 미승인'을 유지하고 전환 줄을 '다음 단계로 전환: 아니오(모델·표준 비교표 미조사 칸 잔존, 요구 목록 일부 미반영, 막힌 질문 q1-09)'로 두었으며, 9절 이력에 실행 2026-09-25-53 행(온톨로지 변경 없음, v0.3 유지)을 추가했다.",
    "비교표 IDTA 02047 행 — 종류 칸에 제품 이미지(AHY911)·SpecificDescriptions(AHY912) 복합 식별자를 [사실]로 더하고, 상태 칸에 실행 2026-09-25-53 재열람도 DecelerationMax 에서 절단됐다고 적었으며, 8절 이력에 행을 추가했다."
  ],
  "track_updates": {
    ...
    "log_entry": "답한 질문: 없음(q1-09 부분 답 보강 — ECLASS·IEC CDD 데이터베이스를 네트워크 정책으로 조회하지 못함, f1~f8) / 새 질문: q4-16(f4, 단계 4. 온톨로지를 실행에 연결하는 방법 조사) / 온톨로지 변경: 없음(v0.3 유지 — 능력 단위 의미 식별자 근거 없음, 충전 요소 출처 충돌 oq-060) / 완료 조건 평가: 미충족(부족: 모델·표준 비교표 PDDL·OPC UA Robotics·MassRobotics·AAS·Open-RMF 행 미조사 칸, 요구 목록 가운데 구성 버전·운용 구역·환경 조건·충전 조건 미반영, 막힌 질문 q1-09) / 세부영역 반영 제안: 3건(28. 표준·상호운용성·다사업자 거버넌스, 16. 공용 자원·충전·에너지 최적화, 5. 로봇 능력·작업 온톨로지의 7. 관련 표준·프레임워크·오픈소스 절) / 다음 실행 제안: q1-09 는 다섯 실행(2026-09-25-35·41·45·47·53)이 같은 벽에 막혔으므로 사용자가 ECLASS·IEC CDD 조회 결과를 inbox/sources 로 넣거나 사유·재개 조건을 적어 보류할지 결정한 뒤 진행한다. 보류하면 단계 1 은 비교표 미조사 칸(PDDL·OPC UA Robotics 등)과 요구 목록 미반영 항목을 다룬다.",
    "overview_progress": "단계 1 진행 중 — 열린 질문 1, 답함 8, 완료 조건 미충족 · 답한 질문 없음(q1-09 부분 답 보강, ECLASS·IEC CDD 데이터베이스 미조회 — 사용자 결정 필요)"
  },
  "area_reflection_proposals": [
    {
      "area_no": 28,
      "section": "7. 관련 표준·프레임워크·오픈소스",
      "summary": "IDTA 공식 저장소 README 게시 목록 이름 기준으로 로봇·스킬·충전·모바일 전용 게시 템플릿은 없고 배터리 관련은 Digital Battery Passport Part 1~7 이다 [사실][^ref-439]. ZVEI 기술 데이터 1.1 의 제품 분류 항목은 …/ProductClassificationItem/1/1 의미 식별자로 제품을 분류 체계·속성 사전의 제품 클래스와 연결한다(원문 미열람) [사실][^ref-660]."
    },
    {
      "area_no": 16,
      "section": "7. 관련 표준·프레임워크·오픈소스",
    ...
    },
    {
      "area_no": 5,
      "section": "7. 관련 표준·프레임워크·오픈소스",
      "summary": "IDTA 02047 템플릿의 ECLASS 분류 클래스 코드는 일반 블록 복합 식별자에만 쓰이고 [사실][^ref-245], 로봇 제품 클래스는 제조사가 인스턴스 값으로 채우는 것이어서 ROP 는 자체 분류가 필요할 것으로 보인다 [추정][^ref-245][^ref-660]."
    }
  ]
}
```

### runs/2026-09-25-53/format_check.md
...
- 차등 갱신 패치 적용:
    ...
    - docs/tracks/manual-capability-ontology/model-standard-comparison.md (2개 절)
    - docs/ideas/robot-capability-ontology.md (1개 절)
```

### runs/2026-09-25-53/pages/tracks/manual-capability-ontology/stage-1-existing-models-and-standards.md
...
실행 2026-09-25-53도 ECLASS 콘텐츠 데이터베이스와 IEC CDD 트리를 네트워크 정책으로 열지 못해, 다섯 번째 실행에서도 질문의 핵심(범위 능력 항목의 존재 여부)은 미확인이고 이 질문은 열림으로 둔다. 이번 실행에서 원문을 연 출처는 공식 저장소의 IDTA 02047 템플릿 JSON(열람 응답이 다시 잘림), 서브모델 템플릿 저장소 README, IDTA 02003 2.0.1 README 이며, ZVEI 기술 데이터 1.1 명세를 포함한 나머지는 검색 결과로 기관·제목·URL 을 확인한 원문 미열람 자료다. 교차 확인은 없고, 모든 사실이 발행 기관 한 곳의 자료에 기댄다.

**IDTA 02047 템플릿의 분류 클래스 코드(추가 확인).** GeneralInformation 의 복합 식별자는 위 실행 2026-09-25-35 부분 답에 적은 것과 같다. 이번에 새로 확인한 것은 제품 이미지(0173-1#02-ABM220#001/0173-1#01-AHY911#001)와 SpecificDescriptions(0173-1#02-ABM221#001/0173-1#01-AHY912#001)의 복합 의미 식별자이며, 이 역시 일반 블록에 붙은 것으로 무인운반차·이동로봇 자체를 가리키는 클래스 코드로 쓰인 곳은 열람 범위에서 확인되지 않았다(확인일 2026-09-25). [사실][^ref-245] AHX838·AHY911·AHY912 클래스의 ECLASS 명칭은 미확인이다.

**템플릿 열람 절단(다섯 번째).** 이번에도 템플릿 JSON 열람 응답은 TechnicalParameters 의 DecelerationMax 에서 잘려 Charg·Battery·Energy 문자열이 보이지 않았으므로 템플릿 원문으로는 충전 요소 유무를 판정할 수 없고, 명세 PDF 검색 요약(원문 미열람)은 EnergyAndCommunication/Battery 묶음을 전하므로 [열린 질문](../../open-questions.md) oq-060 출처 충돌은 이번에도 해소되지 않은 것으로 보인다. [추정][^ref-245][^ref-198] 두 출처 가운데 한쪽을 고르지 않으며, oq-060 은 열림으로 둔다.

**게시 템플릿 목록.** IDTA 공식 서브모델 템플릿 저장소 README 의 게시 목록에서 기술 데이터·능력·AGV·배터리 관련 게시 템플릿은 Technical Data 1.1·2.0.1, Capability Description 1.0, Technical Data for Automated Guided Vehicles 1.0 과 Digital Battery Passport Part 1~7 이며, 로봇·스킬·충전·모바일을 이름에 둔 게시 템플릿은 목록에서 확인되지 않았다(README 게시 목록 이름 기준의 부재 관찰, 확인일 2026-09-25). [사실][^ref-439] Digital Battery Passport 계열이 이동로봇의 범위 능력 '충전'(충전 장치 요구·충전 조건)을 기술하는지는 템플릿 본문을 열지 않아 확인하지 않았으므로, 충전 속성의 의미 식별자 원천 후보일 뿐인 것으로 보인다. [추정][^ref-439] 이 재사용 가능성은 후속 질문 q4-16 으로 보냈다.

**IDTA 02003 2.0.1.** IDTA 02003 기술 데이터 일반 틀 2.0.1 README 는 2.0 의 GitHub 이슈 6건을 고친 버그 수정판으로 예시값 한정자, ProductImages→ProductImage 이름 변경, TechnicalPropertyAreas 카디널리티, 의미 식별자 구분을 다루며, 제품 분류 항목·ECLASS·IEC CDD 에 관한 변경은 적지 않는다(발행일 미확인, 확인일 2026-09-25). [사실][^ref-659]

**제품 분류 항목의 의미 식별자.** ZVEI 기술 데이터 서브모델 1.1 명세(2020-11)에서 제품 분류 항목(ProductClassificationItem)은 https://admin-shell.io/ZVEI/TechnicalData/ProductClassificationItem/1/1 의미 식별자를 가진 요소 모음으로, 제품을 특정 분류 체계·속성 사전의 제품 클래스와 연결한다(원문 미열람, 검색 요약 기준). [사실][^ref-660] 같은 식별자가 IDTA 02003 1.2 판에도 나오지만 두 문서는 승계 관계라 독립 교차 확인이 아니다. 분류 체계 이름(ProductClassificationSystem) 요소의 의미 식별자는 미확인이고, 2.0.1 템플릿의 해당 식별자도 미확인이다.

**ECLASS·IEC CDD 의 이동로봇 항목(다섯 번째 같은 관찰).** 다섯 번째 실행의 영·독·한 검색에서도 ECLASS 에 무인운반차(FTF)·자율이동로봇을 가리키는 분류 클래스 코드나 IEC CDD 에 로봇 도메인·ISO 22166 계열 속성이 등록됐다는 공개 자료는 나오지 않아, 웹 검색만으로는 q1-09 의 항목 존재 여부를 판정할 수 없는 것으로 보인다(데이터베이스 미조회, 부재 확정 아님). [추정][^ref-184][^ref-185][^ref-183]

**제품 클래스는 인스턴스 값.** 위 실행 2026-09-25-47 보강의 세 층 의미 식별자 추정을 보강하면, IDTA 02047 템플릿의 ECLASS 분류 클래스 코드가 일반 블록에만 붙고 제품 분류 항목이 분류 체계·클래스를 값으로 지정하게 하는 구조로 보아, 분류 원문 질문(누가 이 화물을 취급할 수 있는가)에 쓰일 로봇 제품 클래스는 템플릿이 고정하지 않고 제조사가 인스턴스 값으로 채우는 것이어서, ROP 는 제품 클래스 값이 없거나 제조사마다 다를 때를 대비한 자체 분류를 가져야 할 것으로 보인다(이 위키의 추론). [추정][^ref-245][^ref-660]
...
**실행 2026-09-25-53 결론과 남은 불확실성**

- 결론: IDTA 02047 템플릿의 ECLASS 분류 클래스 코드는 GeneralInformation·제품 이미지·SpecificDescriptions 같은 일반 블록의 복합 식별자에만 나타나며, 이번에 제품 이미지(AHY911)·SpecificDescriptions(AHY912) 복합 식별자를 더 확인했다. [사실][^ref-245]
- 결론: IDTA 공식 저장소 README 게시 목록 이름 기준으로 로봇·스킬·충전·모바일을 이름에 둔 게시 템플릿은 없고, 배터리 관련은 Digital Battery Passport Part 1~7 이다. [사실][^ref-439]
- 결론: ZVEI 기술 데이터 1.1 의 제품 분류 항목은 …/ProductClassificationItem/1/1 의미 식별자로 제품을 분류 체계·속성 사전의 제품 클래스와 연결한다(검색 요약 기준). [사실][^ref-660]
- 온톨로지 변경 없음(v0.3 유지): 능력 단위 의미 식별자를 뒷받침할 사전 항목이 여전히 없고 충전 요소는 출처 충돌(oq-060) 상태라, 초안 6절의 '기능의 의미 식별자 속성'과 충전 조건 질문을 그대로 두었다.
- 불확실성(사용자 결정 필요): 다섯 실행(2026-09-25-35·41·45·47·53)이 같은 벽 — ECLASS 콘텐츠 데이터베이스와 IEC CDD 트리를 네트워크 정책으로 조회하지 못함 — 에 막혔다. 추가 트랙 실행으로 풀리지 않을 가능성이 있어, 사용자가 eclass.eu 콘텐츠 검색과 cdd.iec.ch 의 조회 결과(AGV·FTF·자율이동로봇)를 inbox/sources 로 제공하거나, 사유와 재개 조건(원문 조회 가능 시)을 적어 q1-09 를 보류할지 결정해야 한다. q1-09 가 열려 있는 한 단계 1 전환은 막힌다.
- 불확실성(출처 충돌): 템플릿 JSON 은 다섯 번째 열람에서도 DecelerationMax 에서 잘려 충전 요소 유무를 원문으로 판정할 수 없다. oq-060 은 열림이다.
- 불확실성: Digital Battery Passport 템플릿 본문은 열지 않아 충전 능력과의 관련성은 미확인이다. ZVEI 1.1 명세는 원문 미열람이고, ProductClassificationSystem 의 의미 식별자와 IDTA 02003 2.0.1 템플릿의 해당 식별자는 미확인이다. AHX838·AHY911·AHY912 클래스의 ECLASS 명칭과 ref-659 발행일도 미확인이다. 교차 확인은 없다.
...
| q4-16 | IDTA Digital Battery Passport 계열 템플릿(특히 Part 4 기술 데이터)의 배터리 요소를 IDTA 02047 배터리 정보·VDA 5050 batteryCharging 과 대응시켜 범위 능력 '충전'의 배터리 속성 의미 식별자로 재사용할 수 있는가? (q1-09 에서 파생) | 단계 4. 온톨로지를 실행에 연결하는 방법 조사 | f4 (실행 2026-09-25-53) | 열림 |

같은 질문은 [질문 백로그](question-backlog.md)에 등록된다(백로그 반영은 퍼블리셔가 한다). 실행 2026-09-25-16에서 함께 제안된 "VDA 5050 팩트시트의 action 파라미터 범위를 IDTA 02020 범위 속성으로 보완할 수 있는가" 질문은 q4-06 과 중복이라 등록하지 않았다. 실행 2026-09-25-23에서 제안된 "작업 요구를 요구 능력 속성으로 표현해 로봇 적재 세트와 비교하는 규칙의 질의·규칙 형식" 질문은 q4-07 과 중복이라 등록하지 않았다. 백로그에 중복 등록된 q1-10(q1-09 와 같은 질문), q4-11(q4-09 와 같은 질문), q5-08(q5-07 과 같은 질문)은 실행 2026-09-25-23에서 폐기했다. 실행 2026-09-25-35의 새 질문 2건(q4-13, q2-06)은 1차 검증에서 백로그 중복이 없다고 판정됐다. 실행 2026-09-25-41의 새 질문 q6-06 은 1차 검증에서 q6-02·q6-03 과 초점이 달라 중복이 아니라고 판정됐다. 실행 2026-09-25-45의 새 질문 q4-14 는 1차 검증에서 q4-06(IDTA 02020 대 팩트시트)·q4-13(MassRobotics 대 팩트시트)과 대상이 달라 중복이 아니라고 판정됐다. 실행 2026-09-25-47의 새 질문 q4-15 는 1차 검증에서 q4-02(문서 대 실제 API)·q4-06(IDTA 02020 대 팩트시트)·q4-14(충전 요소 정규화)와 초점이 달라 중복이 아니라고 판정됐다. 실행 2026-09-25-53의 새 질문 q4-16 은 1차 검증에서 q4-14(IDTA 02047 충전 요소 ↔ VDA 5050 batteryCharging)와 대상 출처가 달라 중복이 아니라고 판정됐다.
...
|---|---|---|---|
| 모델·표준 비교표([model-standard-comparison.md](model-standard-comparison.md)) 작성 | 미충족 | [모델·표준 비교표](model-standard-comparison.md)의 후보 10행과 후보 밖 5행 모두에 조사 결과가 있으나, PDDL·OPC UA Robotics·MassRobotics·AAS·Open-RMF 행과 후보 밖 RCO·이종 자율 로봇 능력·스킬 모델 행에는 "미조사" 칸이 남아 있다(실행 2026-09-25-53 리서치 자체 평가와 1차 검증 기준). 학술 온톨로지 행은 실행 2026-09-25-23에서, MassRobotics 행의 일부 칸은 실행 2026-09-25-35에서 채웠고, 실행 2026-09-25-47·2026-09-25-53에서는 IDTA 02047 행의 종류·출처·상태 칸만 보강해 미조사 칸은 그대로다 | 미충족 · 미승인 |
| ROP용 능력 개념 요구 목록 초안이 온톨로지 초안에 반영됨 | 미충족 | 초안은 실었으나 일부만 개념에 반영: 아홉 후보 가운데 요구·제공 한정자, 실행 상태, 부착 인터페이스·적재 취급 장치 위치만 [능력 온톨로지 초안](ontology-draft.md) v0.3에 반영됐고 구성 버전·운용 구역·환경 조건·충전 조건은 6절 질문으로 남았다. 실행 2026-09-25-35·2026-09-25-41·2026-09-25-45·2026-09-25-47·2026-09-25-53에서는 온톨로지 변경이 없다 | 미충족 · 미승인 |
...
[^ref-659]: IDTA (admin-shell-io/submodel-templates), Generic Frame for Technical Data for Industrial Equipment in Manufacturing 2.0.1 — README (published/Technical_Data/2/0/1), 미확인, https://github.com/admin-shell-io/submodel-templates/blob/main/published/Technical_Data/2/0/1/README.md, 접근일 2026-09-25
...
|---|---|---|---|---|---|
| 2026-09-25 | 2026-09-25-53 | 없음(q1-09 부분 답 보강) | q4-16 | 없음(v0.3 유지) | 9 |
...
### runs/2026-09-25-53/pages/tracks/manual-capability-ontology/model-standard-comparison.md
...
| 날짜 | 실행 id | 변경 | 버전 |
|---|---|---|---|
| 2026-09-25 | 2026-09-25-53 | IDTA 02047 행 종류 칸에 제품 이미지(AHY911)·SpecificDescriptions(AHY912) 복합 식별자 [사실] 추가, 상태 칸에 실행 2026-09-25-53 재열람도 DecelerationMax 에서 절단 추가 | 7 |
...
### runs/2026-09-25-53/pages/ideas/robot-capability-ontology.md
...
> 페이지 상태: published · 신뢰도: 미부여 · 페이지 버전: 7 · 마지막 갱신: 2026-09-25 · 마지막 실행: 없음
...
원천: [질문 백로그](../tracks/manual-capability-ontology/question-backlog.md)([매뉴얼 기반 로봇 기능 온톨로지](../tracks/manual-capability-ontology/index.md) 트랙) · 열림 43건 · 조사 중 1건 · 답함 8건 · 폐기 3건
...
### runs/2026-09-25-53/docs_tree.txt
...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 70건 / 전체 468건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/open-questions.md (요약: 대상 영역 [5, 8, 9, 10, 12, 13, 16, 21, 23, 24, 25, 27, 28] 에 걸린 51건 / 전체 72건)
...
| [단계 4. 온톨로지를 실행에 연결하는 방법 조사](stage-4-execution-grounding.md) | 대기 | 14 | 미충족 |
