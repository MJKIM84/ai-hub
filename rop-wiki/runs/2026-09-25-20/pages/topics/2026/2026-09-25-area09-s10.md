...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-004, ref-031, ref-105, ref-148, ref-254, ref-259, ref-263]
last_run: 2026-09-25
version: 1
...
- [10. 설비·건물 시스템 연동](../../categories/c-connectivity-and-execution-foundation/10-facility-and-building-system-integration.md) — VDA 5050은 주변 설비 인터페이스를 다루지 않는다. [사실][^ref-259] Open-RMF 커뮤니티 목록은 승강기·문 어댑터를 플릿 어댑터와 함께 모은다. [사실][^ref-254]
...
- [13. 작업 배정 — MRTA](../../categories/d-planning-and-optimization/13-task-allocation-mrta.md) — 장애 시 작업을 다른 로봇에 넘기는 재배정은 배정 문제와 이어진다. [추정] 벤더 주장[^ref-263]
