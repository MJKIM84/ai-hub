...
### data/area_reflection_proposals.json (대상 영역 9. 로봇·제조사 관제 연동 에 대한 트랙 반영 제안 3건, status 제안 — 반영은 이 실행에서: 사양서 6.3 절차 9·공통 규칙 11)
...
```json
{
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 9. 로봇·제조사 관제 연동 의 \"10. 다른 연구영역과의 연결 (번호와 이름을 함께 표기)\" 절(815자)을 옮겼다. 세부영역 링크를 주제 페이지 위치 기준 경로(../../categories/…)로 고쳤다"
    }
  ],
  ...
  "additional_research_requests": [
    ...
    "pipeline 담당: 자동 분리 코드가 세부영역 절을 주제 페이지로 옮길 때 상대 링크를 주제 페이지 위치 기준으로 다시 써야 한다(이번 형식 검증 실패 원인)."
  ],
  "fixes_applied": [
...
created: 2026-09-24
updated: 2026-09-25
sources: [ref-004, ref-031, ref-105, ref-148, ref-258, ref-259, ref-260, ref-262, ref-265, ref-266, ref-267]
last_run: 2026-09-25
version: 2
---
...
이종 제조사를 잇는 ROP의 어댑터는 명령·상태·오류 변환, 지도 좌표 변환, 완료 확인, 교통·설비 조정 인터페이스를 맡는 것으로 보인다. [추정][^ref-031][^ref-258][^ref-105][^ref-260] 교통 조정은 VDA 5050 명세 범위 밖이어서 관제 구현의 몫으로 남는다. [사실][^ref-031]
...
```json
{
  ...
  "corrections_rejected": [],
  "required_fixes": [
    "세부영역 페이지 9절 표 '시설·설비 제어' 행 'ROP가 직접 맡는 것' 칸: '로봇 작업과 설비를 잇는 별도 인터페이스'는 f35의 추론이므로 [추정][^ref-031][^ref-258][^ref-105][^ref-260]을 붙인다. 괄호 안 'VDA 5050은 AGV·관제와 주변 설비 사이 인터페이스를 다루지 않는다'는 별도 문장으로 떼어 [사실][^ref-267]을 단다. 이유: 추론이 [사실]로 올라갔고, ref-267은 ROP의 담당 범위를 말하지 않는다.",
