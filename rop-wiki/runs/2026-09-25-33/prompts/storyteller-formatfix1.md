...
```json
{
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 13. 작업 배정 — MRTA 의 \"6. 대표 접근법과 기술\" 절(1,913자)을 옮겼다"
    },
    {
...
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area13-s6.md: 깨진 링크 ../g-safety-security-intelligence-and-governance/27-ai-learning-adaptation-and-model-operations.md
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area13-s6.md: 깨진 링크 16-shared-resource-charging-and-energy-optimization.md
