...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과(OASIS 명세 URL 포함)로 네 단계 교환, 같은 패킷 식별자 사용, PUBREL 전 같은 식별자의 PUBLISH 는 PUBREC 으로 응답하고 중복 전달을 하지 않는다는 규정을 확인했다. 출처 ref-593 은 기존 ref-306(OASIS, MQTT Version 5.0, 같은 URL)과 중복이다."
    },
    {
      "finding_id": "f17",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "추정 유지: f16·f1·f5 를 대응시킨 추론이다. 로봇 분야 출처는 없다. ref-593 은 ref-306 으로 바꾼다."
    },
    {
      "finding_id": "f18",
      "source_exists": true,
  ...
  "duplication": {
    "ok": false,
    "overlaps": [
      "ref-593(OASIS, MQTT Version 5.0, https://docs.oasis-open.org/mqtt/mqtt/v5.0/mqtt-v5.0.html)은 기존 참고문헌 ref-306 과 같은 문서·같은 URL이다. 새 id 를 만들지 말고 ref-306 을 재사용해야 한다.",
  ...
  "required_fixes": [
    ...
    "ref-593: 새 참고문헌으로 등록하지 않는다. f16·f17 각주는 기존 ref-306(OASIS, MQTT Version 5.0)을 쓰고 reference_updates 에서 ref-593 을 뺀다. 이유: 같은 문서·같은 URL 이 이미 등록돼 있다.",
