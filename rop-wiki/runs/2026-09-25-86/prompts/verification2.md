...
### runs/2026-09-25-86/target.json
...
### runs/2026-09-25-86/research.json
...
```json
{
  ...
  "research_questions": [
    ...
    "여러 출처의 근거로 결론의 확실성을 매기는 체계(GRADE)와 기술 성숙도(TRL)는 가설 판정의 규칙·보조 축으로 어떻게 쓸 수 있는가? (단계 5 페이지 3절, 23. 시험·형식 검증·벤치마크 겨냥)",
    "가설 1(작업 모델로 먼저 구조화하면 LLM 직접 명령 생성보다 잘못된 배정이 줄어든다)을 지지·반박하는 비교 연구(LLM 직접 배정 대 해법기 배정, 모듈형 구조 대 직접 코드 생성)는 무엇인가? (13. 작업 배정 — MRTA, 27. AI·학습·적응과 모델 운영 겨냥)",
    "가설 2(온톨로지 질의로 로봇을 고르면 배정 근거를 설명·재현할 수 있다)의 근거와 반대 근거(선언 능력과 운용 능력의 차이, LLM 비결정성)는 무엇인가? (5. 로봇 능력·작업 온톨로지 연결)",
    "가설 3(스케줄링은 최적화 엔진, 해석·설명은 LLM)의 근거와 반례(LLM 이 설계한 규칙이 롤링 MILP 를 앞선 보고)는 무엇인가? (14. 작업 순서·스케줄링 연결)",
    "물류 현장 조건에서 세 가설을 직접 시험한 연구나 국내 자료가 있는가? (한국 자료 우선 규칙)"
  ],
  "findings": [
    {
      "id": "f1",
      "claim": "GRADE 접근법은 근거 묶음의 확실성을 결과(outcome)별로 높음·중간·낮음·매우 낮음 네 수준으로 매기고, 비뚤림 위험·비일관성·비직접성·비정밀성·출판 비뚤림 다섯 영역에서 심각한 우려가 있으면 한 단계, 매우 심각하면 두 단계 낮춘다.",
      "tag": "사실",
      "source_ids": [
        "ref-807"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "Cochrane Handbook 14장 검색 요약: 확실성을 'high', 'moderate', 'low', 'very low'로 결과별 분류, 다섯 영역 우려 시 한 단계(심각)·두 단계(매우 심각) 하향. (발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
    ...
    {
      "id": "f2",
      "claim": "NASA 의 기술 준비 수준(TRL) 정의는 TRL 4 를 실험실 환경에서의 구성품·하위 시스템 검증으로, TRL 5 를 실제 조건을 가깝게 모사한 관련 환경에서의 검증으로 두어 통제된 실험실 검증과 관련 환경 검증을 구분한다.",
      "tag": "사실",
      "source_ids": [
        "ref-809"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: TRL 4 'Component/subsystem validation in laboratory environment', TRL 5 'validation in relevant environment'. (발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f3",
      "claim": "LiP-LLM 저자들은 LLM 이 기술 목록·의존 그래프를 만들고 배정은 선형계획이 맡는 구조에서, LLM 기반 배정은 추적 한계로 어려움을 겪었지만 선형계획 배정은 배정 실패가 거의 없었다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-166"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "저자 보고, 독립 재현과 실험 조건 미확인(시뮬레이션 과제). (재인용: 2026-09-25-21)",
      "as_of": "2024-10",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f4",
      "claim": "Garrabé 외(arXiv 2411.05474)는 LLM 출력을 기대 결과 모듈과 피드백으로 접지하는 모듈형 구조가 GPT-4o 기반 code-as-policies(직접 코드 생성) 기준선보다 픽앤플레이스·조작 과제 성공률이 높았다고 보고하고, 기준선 실패 원인으로 환경 접지 부족과 개루프 실행을 들었다.",
      "tag": "사실",
      "source_ids": [
        "ref-815"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: 'code-as-policy approach obtains a lower success rate'; 원인은 접지 부족과 개루프 실행(시뮬레이션·실기, 조작 과제 조건, 저자 보고).",
      "as_of": "2024-11",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f5",
      "claim": "Wang 외(EMNLP 2025)는 LLM 에이전트가 불명확한 지시에서 빠진 도구 호출 인자를 임의로 지어내는 경향을 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-359"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "도구 호출 API 조건, 저자 보고. 필수 슬롯을 둔 작업 모델 구조화의 근거로 쓰일 수 있으나 배정 오류를 직접 잰 것은 아님. (재인용: 2026-09-25-30)",
      "as_of": "2024-09",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f6",
      "claim": "CoMuRoS 는 작업 관리자 LLM 이 해석·배정·재계획을 맡는 구조로 22개 시나리오·약 20대 로봇 벤치마크에서 정답률 최대 0.91 을 보고했고, LTAA 는 LLM 배정의 우위를 두고 2차 요약끼리 충돌한다.",
      "tag": "사실",
      "source_ids": [
        "ref-677",
        "ref-168"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "실험실 텍스트 벤치마크 조건, 저자 보고. 결정적 배정기와 같은 조건의 비교는 미확인(LTAA 출처 충돌은 oq-030). (재인용: 2026-09-25-71)",
      "as_of": "2025-11",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f7",
      "claim": "Liu 외(KTH)는 기호 검증기를 같은 방식으로 프롬프트한 LLM 으로 바꾸면 전체 성공률이 98.1% 에서 3.8% 로 떨어졌다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-674"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "52개 명령 부분집합, 산업용 로봇 셀 조건, 저자 보고. (재인용: 2026-09-25-71)",
      "as_of": "2026-06",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f8",
      "claim": "Electronics(2026) 논문은 온톨로지 기반 실행 가능성 판정 결과(ReasonerOutput)를 특정 배정기에 묶이지 않게 정형화해 세 가지 플릿 구성과 네 가지 배정기에서 공통 실행 가능성 제약으로 쓰였다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-236"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "원문 미열람, 필드 구성·설명 가능성 측정 여부 미확인. (재인용: 2026-09-25-74)",
      "as_of": "2026-08-11",
      "flow_step": null,
      "flow_item": "수행 자원",
      "source_unopened": true
    ...
    {
      "id": "f9",
      "claim": "로봇 능력 온톨로지(RCO) 연구는 제조사가 광고한 능력과 측정한 운용 능력을 함께 표현하고 비교해, 선언 능력과 실제 성능이 다를 수 있음을 온톨로지 안에서 다룬다.",
      "tag": "사실",
      "source_ids": [
        "ref-041"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "Scientific Reports 2025, 원문 미열람. 선언 능력만으로 질의하면 배정 근거가 재현되어도 틀릴 수 있다는 반대 방향 근거(oq-024). (재인용: 2026-09-25-74)",
      "as_of": "2025-10-02",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f10",
      "claim": "Atil 외는 결정적으로 설정한 LLM 5종을 8개 과제에서 10회 반복했을 때 정확도가 최대 15% 달라졌고 어느 모델도 모든 과제에서 반복 가능한 정확도를 내지 못했다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-746"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "arXiv 판 기준, 일반 NLP 과제 조건, 저자 보고. LLM 이 로봇을 직접 고를 때 재현성의 반대 근거. (재인용: 2026-09-25-99)",
      "as_of": "2024-08",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    },
    {
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "LLM 이 제약 최적화를 직접 푼 조건, 저자 보고, 원문 미열람. (재인용: 2026-09-25-66)",
      "as_of": "2026-02",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f12",
      "claim": "SCHEDBench 저자들은 같은 스케줄링 문제를 의미가 같은 다른 문장으로 주면 LLM 의 실행 가능 비율이 떨어지고 제약 위반이 달라진다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-594"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "자연어 조합 스케줄링 조건, 저자 보고, 원문 미열람. (재인용: 2026-09-25-66)",
      "as_of": "2026-08",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f13",
      "claim": "Li·Li(arXiv 2608.09343)는 LLM 이 시뮬레이션 추적을 진단해 설계한 동적 생산·AGV 스케줄링 정책 가운데 최선 정책이 대응 시드 100개 모두에서 롤링 MILP·규칙·메타휴리스틱 정책보다 높은 점수를 냈고 무작위 고장에서도 재최적화 없이 우위를 유지했다고 보고했다.",
      "tag": "사실",
      "source_ids": [
        "ref-612"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: 최선 평균 점수 62.49→78.61, 'outscored representative rolling-MILP, rule-based, and metaheuristic policies on every seed'. 제조·AGV 시뮬레이션 조건, 저자 보고.",
      "as_of": "2026-08",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f14",
      "claim": "RACE-Sched 는 LLM 추론 지연이 산업 제어의 밀리초 단위 결정 주기와 맞지 않는다고 보고 실시간 디스패치를 저지연 기호 휴리스틱에 맡기는 구조를 제안했다.",
      "tag": "사실",
      "source_ids": [
        "ref-611"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "원문 미열람, 동적 스케줄링 조건. (재인용: 2026-09-25-77)",
      "as_of": "2026-05",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f15",
      "claim": "RobotFleet 은 LLM 기반 추론과 혼합 정수 계획(MILP) 두 작업 배정기를 바꿔 끼울 수 있는 오픈소스 다중 로봇 계획 틀로, 논문은 MILP 배정기를 능력 제약 아래 로봇별 최대 작업 부하를 최소화하는 모델로 설명하며 공식 README 에는 두 배정기의 비교 결과가 없다.",
      "tag": "사실",
      "source_ids": [
        "ref-813",
        "ref-814"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "README(raw 열람): Task Allocator 가 'LLM-based reasoning' 과 'Mixed-Integer Linear Programming (MILP)' 을 제공, 평가 결과 없음. 논문 비교 수치는 미확인. 두 출처는 같은 저자.",
      "as_of": "2025-10",
      "flow_step": null,
      "flow_item": null,
    ...
    {
      "id": "f16",
      "claim": "q5-03 에 대해 이 위키가 확인한 근거 평가 체계를 묶으면, 각 가설을 하위 주장으로 나누고 하위 주장마다 근거의 확실성을 GRADE 식 영역(비직접성: 가정·건설·제조 대 물류 창고, 비정밀성: 단일 출처, 비뚤림: 저자·벤더 보고)으로 낮춰 매긴 뒤 판정 값으로 모으고 TRL 을 보조 축으로 병기하는 절차가 선택지로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-807",
        "ref-809"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 종합. 같은 날 건축 도면 자동 인식 트랙 단계 5(실행 2026-09-25-84)가 쓴 판정 절차와 같은 틀.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f17",
      "claim": "판정 값은 지지(핵심 하위 주장 모두에 물류 조건의 직접 근거가 있고 확실성 중간 이상), 부분 지지(일부 하위 주장만 근거가 있거나 빠지는 조건이 확인됨), 기각(핵심 하위 주장에 직접 반대 근거), 미판정(핵심 하위 주장에 직접 근거 없음)으로 가르는 규칙이 가능해 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-807",
        "ref-809"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 종합. 판정 값 네 가지는 트랙 개요 3절의 값(지지/부분 지지/기각/미판정)을 따름.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f18",
      "claim": "위 규칙을 적용하면 가설 1 은 LLM 직접 배정·직접 코드 생성보다 구조화·분해 뒤 결정적 해법·검사를 거친 방식이 실패가 적었다는 비교가 있으나, 비교 형태가 이 트랙의 작업 모델 구조화와 같지 않고 LLM 직접 배정이 높은 정답률을 보인 반례가 있으며 물류 조건 근거가 없어 잠정 '부분 지지'(확실성 낮음)로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-166",
        "ref-815",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 잠정 판정. 비직접성(가정·조작·산업 셀 조건)과 비정밀성(단일 출처·저자 보고)으로 두 단계 하향.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f19",
      "claim": "가설 2 는 온톨로지 판정을 배정기 독립 제약으로 쓰는 구조와 LLM 출력의 반복 불일치 보고가 있어 재현성 쪽 근거는 있으나, 온톨로지 질의와 LLM 선택의 설명 가능성·재현성을 같은 조건으로 잰 연구가 없고 선언 능력과 운용 능력이 다를 수 있어, 잠정 '부분 지지'(표현 수단과 재현성의 간접 근거만, 확실성 매우 낮음~낮음)로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-236",
        "ref-746",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 잠정 판정. 설명 가능성 하위 주장은 직접 근거가 없어 미판정 상태로 남음.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": "수행 자원",
      "source_unopened": true
    ...
    {
      "id": "f20",
      "claim": "가설 3 은 LLM 직접 스케줄링의 실행 가능성·일관성 한계와 LLM 지연 때문에 실시간 결정을 결정적 구성 요소에 두는 근거가 있으나, LLM 이 루프 밖에서 설계한 규칙이 롤링 MILP 를 앞선 보고가 있어 '최적화 엔진'을 해법기로만 읽으면 반례가 되고, 운영 안정성은 물류 운영에서 잰 자료가 없어 잠정 '부분 지지'(확실성 낮음)로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-592",
        "ref-594",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 잠정 판정. 분담의 핵심을 '결정 루프 안은 결정적 실행기'로 읽으면 지지 방향, '해법기 전담'으로 읽으면 반례 존재.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f21",
      "claim": "판정을 부분 지지에서 옮기려면 같은 물류 지시 세트로 작업 모델 경유 대 LLM 직접 명령 생성의 오배정률(가설 1), 온톨로지 질의 대 LLM 선택의 반복 시행 일치율과 근거 추적 가능성(가설 2), 해법기·검증된 규칙 대 LLM 직접 스케줄의 실행 가능성·납기 지연·재스케줄 뒤 시작 시각 편차(가설 3)를 재는 사용자 실험이 필요할 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-746",
        "ref-592",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 종합. q5-01 의 네 층 지표와 q5-02 의 가상 현장 시험 네 층을 실험 설계에 그대로 쓰는 안.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f22",
      "claim": "분류 원문 질문과 관련해 피킹 운반 지시 시나리오에서 가설 3 을 판정할 때 최근접 배정 기준선을 함께 두면, 결정적 배정·일정이 최근접 규칙보다 대기·지연을 줄이는지와 LLM 직접 스케줄의 격차를 한 실험에서 볼 수 있어 보인다(설명용 가정 사례).",
      "tag": "추정",
      "source_ids": [
        "ref-400",
        "ref-592"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "작업장 사례 연구에서 조합 최적화 배차가 무작위·최근접 규칙보다 대기 시간을 잘 통제했다는 저자 보고(2019)를 기준선 설계 근거로 씀.",
      "as_of": "2026-09-25",
      "flow_step": "피킹",
      "flow_item": "예외·성과",
      "source_unopened": true
    ...
    {
      "id": "f23",
      "claim": "이번 검색 범위(한국어 2회 포함 9회)에서는 물류 창고 로봇 채팅 지시에서 세 가설을 직접 시험한 연구를 찾지 못했고, 국내 자료로는 제조 물류 로봇에 LLM 협업 인터페이스를 구축한 2023 학술대회 논문이 확인되나 내용을 확인하지 못해 판정 근거로 쓰지 못했다(부재 확인 아님).",
      "tag": "추정",
      "source_ids": [
        "ref-816"
      ],
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "DBpia 서지 정보만 확인(대한산업공학회 추계학술대회 논문집 2023-11). 초록·결과 미확인.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f24",
      "claim": "세 가설의 근거가 된 구성(구조화·결정적 검증·해법기 배정)은 확인한 범위에서 시뮬레이션·실험실 검증 수준에 머물러 TRL 로 보면 관련 환경(물류 현장 모사) 검증 전 단계로 보이며, 이 성숙도 축을 판정표에 병기할 수 있어 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-809",
        "ref-674",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "이 위키의 종합. TRL 매김은 공식 평가가 아니라 설명용 대응.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
  ...
  "sources": [
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. GRADE 로 결과별 근거 확실성을 네 수준으로 매기고 다섯 영역으로 낮추는 방법(실행 2026-09-25-84 의 ref-807 과 같은 URL).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. TRL 1~9 정의, TRL 4 실험실 검증과 TRL 5 관련 환경 검증 구분(실행 2026-09-25-84 의 ref-809 와 같은 URL).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. LLM 기반 계획과 LLM·MILP 배정기를 모듈로 둔 중앙 다중 로봇 계획 틀.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "README 원문 열람. 배정기로 LLM 기반 추론과 MILP 를 제공하고 선언적 세계 상태를 유지하며, 평가 결과는 README 에 없음.",
      "fetched": true,
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 기대 결과 모듈과 피드백을 둔 모듈형 구조가 GPT-4o code-as-policies 기준선보다 조작 과제 성공률이 높았다는 보고.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "low",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 제조 물류 로봇에 LLM 협업 인터페이스를 구축한 국내 학술대회 논문(서지만 확인).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. LLM 이 기술 목록·의존 그래프를 만들고 선형계획이 배정하는 다중 로봇 계획.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 언어 이해만 LLM 에 맡기고 검증·순서·실행을 결정적으로 둔 구조와 기호 검증기 절제 실험.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. LLM 이 제약 최적화를 직접 풀 때 실행 가능성·최적성을 평가한 벤치마크.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 문장 표현 변화에 따른 LLM 스케줄링 제약 충실도 평가.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 실시간 디스패치는 기호 휴리스틱, LLM 은 비동기 장기 추론을 맡는 구조.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. LLM 이 시뮬레이션 추적으로 AGV·생산 스케줄링 정책을 설계하고 롤링 MILP 등과 비교.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 온톨로지 기반 실행 가능성 판정을 배정기 독립 제약으로 쓰는 방법.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 광고 능력과 운용 능력을 함께 표현·비교하는 로봇 능력 온톨로지.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 결정적 설정 LLM 의 반복 실행 정확도 변동 보고.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 불명확한 지시에서 LLM 에이전트가 빠진 인자를 지어내는 경향과 되묻기 틀.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 작업 관리자 LLM 이 해석·배정·재계획을 맡는 이종 로봇 팀 구조.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 건설 로봇 LLM 배정과 전통 최적화 비교(2차 요약 충돌, oq-030).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 재스케줄링의 효율(makespan·지연)과 안정성(시작 시각 편차)을 함께 다룸.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 조합 최적화 배차와 무작위·최근접 규칙의 작업 대기 시간 비교.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 이번 실행에서 다시 열지 않음. 로봇별 작업 순서를 정하는 결정적 작업 계획기.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
  ...
  "page_proposals": [
    {
      ...
      "rationale": "q5-03 답: f1·f2·f3·f4·f5·f6·f7·f8·f9·f10·f11·f12·f13·f14·f15·f16·f17·f18·f19·f20·f21·f22·f23·f24 (신뢰도 low) — 2절 q5-03 상태 답함, 3절 q5-03 소제목 신설({#q5-03}): 판정 절차(GRADE f1·f16, TRL 보조 축 f2·f24), 판정 값 규칙(f17, 표 권장), 가설별 근거(가설 1 f3~f7, 가설 2 f8~f10, 가설 3 f11~f15), 잠정 판정표(가설 1 부분 지지 f18, 가설 2 부분 지지 f19, 가설 3 부분 지지 f20, 표 권장), 필요 실험(f21), SCM 질문 연결·피킹 시나리오(f22), 근거 공백(f23) / 4절 결론·불확실성 / 5절 후속 질문 / 6절 완료 조건 현황(가설 판정표·실험 계획 행) / 8절 출처 / 9절 이력"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 산출물(가설 판정표): 검증이 승인하면 3절 판정 칸에 가설 1 부분 지지(f18)·가설 2 부분 지지(f19)·가설 3 부분 지지(f20)와 근거 단계·실행 id 2026-09-25-86 을 적고 판정 규칙(f17) 한 단락을 둔다. 승인되지 않으면 미판정 유지."
    },
    {
      "action": "update",
      ...
      "rationale": "아이디어 페이지 6절(트랙 산출물): '가설 판정 절차' 소절 신설 — 근거 확실성 평가·TRL 보조 축(f1·f2·f16·f24), 판정 값 규칙(f17), 잠정 판정 요약(f18~f20), 필요 실험(f21). 모두 추정 중심"
    },
    {
      "action": "update",
      "path": "docs/tracks/nl-task-chatbot/experiments.md",
      "sections": [],
      "rationale": "트랙 산출물(단계 5 stage_artifacts): 제안 실험 후보 E5-01 작업 모델 경유 대 LLM 직접 명령 생성의 오배정률(가설 1), E5-02 온톨로지 질의 대 LLM 로봇 선택의 반복 일치율·근거 추적(가설 2), E5-03 해법기·검증된 규칙 대 LLM 직접 스케줄의 실행 가능성·납기 지연·시작 시각 편차, 최근접 기준선 포함(가설 3) — 근거 f21·f22, 시험 구성은 q5-02 가상 현장 네 층"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 nl-task-chatbot 단계 5 반영 제안 (f3, f13, f15, f20, f22): LLM 직접 배정 대 해법기 배정의 비교 근거와 LLM 설계 규칙이 롤링 MILP 를 앞선 반례, 최근접 기준선을 둔 판정 실험. 27. AI·학습·적응과 모델 운영과 양쪽 연결"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 nl-task-chatbot 단계 5 반영 제안 (f1, f2, f16, f17, f24): GRADE 식 확실성 평가와 TRL 보조 축으로 기술 가설을 판정하는 방법(추정)"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 nl-task-chatbot 단계 5 반영 제안 (f4, f7, f10, f13): 모듈형 구조 대 직접 코드 생성, 결정적 검증기 절제, LLM 비결정성, 루프 밖 규칙 설계. 적용 대상 13. 작업 배정 — MRTA 와 함께 연결"
    }
  ],
  "glossary_candidates": [
    {
...
### runs/2026-09-25-86/verification.json
...
```json
{
  ...
  "claim_checks": [
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과로 Cochrane 14장(제목·URL 일치)이 '심각'은 한 단계, '매우 심각'은 두 단계 낮춘다는 내용을 확인했다. 네 수준·다섯 영역은 스니펫 범위에서 부분 확인. 발행일 미확인. 같은 URL이 실행 2026-09-25-84 의 ref-807 로 이미 있어 퍼블리셔가 병합한다."
    },
    {
      "finding_id": "f2",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과로 NASA ESTO trl_definitions.pdf 의 TRL 4(실험실 환경 검증)·TRL 5(관련 환경 검증) 구분 확인. 발행일 미확인. ref-809 와 같은 URL."
    },
    {
      "finding_id": "f3",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-21 검증). 원문 미열람, 단일 출처 저자 보고. 시뮬레이션 과제 조건을 본문에 병기한다."
    },
    {
      "finding_id": "f4",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과로 arXiv 2411.05474(Garrabé 외, ICRA 2025 제출)가 GPT-4o code-as-policy 기준선의 성공률이 더 낮았고 원인이 접지 부족·개루프 실행이라고 적은 것을 확인. 성공률 수치 미확인. 조작 과제는 로봇 자체 지능·제어 경계의 연계 대상."
    },
    {
      "finding_id": "f5",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-30 검증). 도구 호출 조건이며 배정 오류를 직접 잰 것이 아님을 병기한다."
    },
    {
      "finding_id": "f6",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 강등. CoMuRoS 정답률 0.91(저자 보고)은 [사실] 유지. LTAA 의 LLM 배정 우위는 2차 요약끼리 충돌하므로 [추정]으로 분리하고 두 요약을 모두 제시하며 oq-030 에 연결한다."
    },
    {
      "finding_id": "f7",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-71). 52개 명령 부분집합·산업용 셀 조건 저자 보고, 원문 미열람."
    },
    {
      "finding_id": "f8",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-74). 원문 미열람, 설명 가능성 측정 여부 미확인."
    },
    {
      "finding_id": "f9",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-74). Scientific Reports 2025, 원문 미열람. oq-024 와 연결."
    },
    {
      "finding_id": "f10",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-99). arXiv 판 기준 일반 NLP 과제 조건 저자 보고, 원문 미열람."
    },
    {
      "finding_id": "f11",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-66). 운영과학 일반 조건 저자 보고, 원문 미열람."
    },
    {
      "finding_id": "f12",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-66). 원문 미열람, 저자 보고."
    },
    {
      "finding_id": "f13",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과로 arXiv 2608.09343 이 100개 대응 시드 모두에서 롤링 MILP·규칙·메타휴리스틱 정책을 앞섰고 무작위 고장에서도 재최적화 없이 우위를 유지했으며 최선 평균 점수가 62.49→78.61 로 올랐다고 적은 것을 확인. 제조·AGV 시뮬레이션 조건 저자 보고이며 롤링 MILP 는 AGV 운송 하위 문제의 추상화라는 점을 병기한다. 원문 직접 인용은 1회 짧은 구절로 한정."
    },
    {
      "finding_id": "f14",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-77). 원문 미열람."
    },
    {
      "finding_id": "f15",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "README 는 raw.githubusercontent.com 으로 재열람해 LLM 기반 추론·MILP 배정기와 평가 결과 부재를 확인. 논문의 MILP 가 능력 제약 아래 최대 작업 부하를 최소화한다는 점은 arXiv 2510.10379 검색 결과로 확인(원문 미열람). 두 출처는 같은 저자(USC)라 독립 교차가 아니다. 논문의 LLM 대 MILP 비교 수치는 미확인."
    },
    {
      "finding_id": "f16",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 종합, [추정] 유지. 판정 절차를 직접 정한 출처는 없다. 건축 도면 자동 인식 트랙 실행 2026-09-25-84 의 판정 틀과 같은 방향이다."
    },
    {
      "finding_id": "f17",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 종합, [추정] 유지. 판정 값 네 가지는 트랙 개요 3절 값과 일치."
    },
    {
      "finding_id": "f18",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 잠정 판정, [추정] 유지. 근거 출처는 모두 원문 미열람·비물류 조건이라 확실성 낮음 표기가 맞다."
    },
    {
      "finding_id": "f19",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 잠정 판정, [추정] 유지. f17 규칙상 '설명 가능성' 하위 주장은 직접 근거가 없어 미판정이므로, 부분 지지가 재현성 쪽 간접 근거에만 기댄다는 점을 판정표에 함께 적어야 한다."
    },
    {
      "finding_id": "f20",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 잠정 판정, [추정] 유지. f13 반례의 조건(제조·AGV 시뮬레이션, 루프 밖 규칙 설계)과 '최적화 엔진' 해석 두 갈래를 모두 제시한다."
    },
    {
      "finding_id": "f21",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 종합, [추정] 유지. 실험 계획 후보의 근거로 쓰며 결과가 아니라 제안임을 밝힌다."
    },
    {
      "finding_id": "f22",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "설명용 가정 사례, [추정] 유지. ref-400 은 작업장 사례 2019 저자 보고, 원문 미열람. 수치를 넣지 않는다."
    },
    {
      "finding_id": "f23",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "검색 결과로 DBpia 서지(강건, 대한산업공학회 추계학술대회 논문집 2023-11, NODE11609734) 일치를 확인. 초록·결과 미확인. 부재 확인이 아님을 유지한다."
    },
    {
      "finding_id": "f24",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 종합, [추정] 유지. TRL 대응은 공식 평가가 아닌 설명용임을 명시한다."
    }
  ],
  "category_fit": {
    "ok": true,
  ...
  "duplication": {
    "ok": true,
    "overlaps": [
      "ref-807·ref-809 는 실행 2026-09-25-84 의 ref-807·ref-809 와 같은 URL — 퍼블리셔가 URL 로 병합한다",
      "판정 절차(f16·f17·f24)는 건축 도면 자동 인식 트랙 단계 5(실행 2026-09-25-84)의 판정 틀과 같은 방향이며 모순은 없다",
      "f6 의 LTAA 부분은 기존 열린 질문 oq-030(출처 충돌)과 겹친다",
      "창고 조건 직접 비교 부재(f23)는 oq-052 와 겹친다"
    ]
  },
  "terminology": {
    "ok": true,
  ...
  "required_fixes": [
    "트랙 개요 3절: 가설 1~3 판정 칸에 '부분 지지(잠정)'을 적고, 근거 칸에 '단계 5 · 실행 2026-09-25-86 · 확실성 낮음(가설 2는 매우 낮음~낮음)'을 적는다. 가설 문장의 [가설] 태그는 유지하고 [사실]로 올리지 않는다. 판정은 이 위키의 판정 규칙(f17, 추정)을 적용한 잠정 결과이기 때문이다.",
    "f16·f17·f18·f19·f20·f21·f22·f24: 단계 페이지·아이디어 페이지·트랙 개요 어디서든 [추정]으로 두고 '이 위키의 종합'임을 밝힌다. 판정 규칙을 직접 정한 출처가 없기 때문이다.",
    "f19: 가설 2 판정 서술에 '설명 가능성 하위 주장은 직접 근거가 없어 미판정이고 부분 지지는 재현성 쪽 간접 근거에만 기댄다'를 함께 적는다. f17 규칙과 일관성을 맞추기 위해서다.",
    "f6: CoMuRoS 정답률 0.91(저자 보고)은 [사실]로, LTAA 의 LLM 배정 우위에 관한 두 2차 요약은 [추정]으로 분리한다. 한쪽을 고르지 말고 둘 다 제시한 뒤 oq-030 에 연결한다. 출처 충돌이기 때문이다.",
    "f13: 가설 3 반례 서술과 13. 작업 배정 — MRTA 반영 제안에 '제조·AGV 시뮬레이션 조건, 저자 보고, 롤링 MILP 는 AGV 운송 하위 문제의 추상화, 물류 창고 적용 미확인'을 병기한다.",
    "f4: 조작 과제의 접지·재시도는 '연계 대상(로봇 자체 지능·제어)'으로 짧게 밝히고, 구조 비교의 근거로만 쓴다.",
    "f15: RobotFleet 논문과 README 는 같은 저자라 독립 교차가 아님을 밝히고, LLM 대 MILP 비교 결과는 미확인으로 둔다.",
    "각주 정의: ref-814 를 뺀 이번 브리프의 모든 출처(ref-807·ref-809·ref-813·ref-815·ref-816 및 재사용 출처)의 접근일 뒤에 ' (원문 미열람)'을 붙이고, reference_updates 의 해당 항목에 source_unopened: true 를 넣는다. 이번 실행이 fetch_mode mirror_only 이고 원문을 연 출처는 ref-814 하나뿐이기 때문이다.",
    "experiments.md '제안된 실험 계획' 절: E5-01~E5-03 을 '제안(사용자 수행 대기)' 상태로 싣는다. 결과·수치는 쓰지 않고 [추정]으로 f21·f22 를 근거로 둔다. E5-03 에는 최근접 배정 기준선을 포함한다. 기존 H2 제목은 그대로 둔다.",
    "단계 5 페이지 6절: 세 완료 조건의 검증 판정 칸을 모두 '미승인'으로 두고, 아래 줄을 '다음 단계로 전환: 아니오(평가 지표·검증 절차 조건 미충족 유지, 막힌 질문 q5-04·q5-05·q5-07~q5-18 과 이번 새 질문, 앞 단계 3·4 완료 미승인)'로 쓴다. 상태 줄의 단계 상태는 '진행 중', 완료 조건은 '미충족'으로 둔다. 열린 질문·답한 질문 수는 2절 표와 맞춘다(2절 표에 백로그의 q5-16~q5-18 도 넣는다).",
    "트랙 개요 상태 줄: 현재 단계는 '단계 3. 구현 가설 설계', 마지막 트랙 실행은 2026-09-25 로 둔다. track_updates.stage_transition 은 넣지 않는다.",
    "업무 분해·배정 설계 초안은 온톨로지 변경이 없으므로 pages 에 넣지 않고, ontology_draft_version 은 '0.9' 를 유지한다."
  ],
  "confidence": "low",
  "verification_note": "판정: 조건부 승인. 이번 실행은 원문 열람이 차단된 환경(mirror_only)에서 검증했다. 확인 24건, 미확인 0건, 교차 확인 0건이다. 강등: f6 가운데 LTAA 부분(사실 → 추정, 출처 충돌 oq-030). 원문 미열람 출처: ref-807, ref-809, ref-813, ref-815, ref-816, ref-166, ref-674, ref-592, ref-594, ref-611, ref-612, ref-236, ref-041, ref-746, ref-359, ref-677, ref-168, ref-734, ref-400, ref-377(원문을 연 출처는 ref-814 README 하나). 주의: 가설 1~3의 판정은 모두 이 위키가 GRADE 식 영역으로 확실성을 낮춘 잠정 '부분 지지'다. 근거는 가정·조작·산업 셀·운영과학 일반·제조 AGV 시뮬레이션 조건의 단일 출처 저자 보고이고, 물류 창고 조건의 직접 근거는 없다. 가설 2의 설명 가능성 하위 주장은 미판정이다. 가설 3에는 LLM이 루프 밖에서 설계한 규칙이 롤링 MILP를 앞선 반례가 있다. 검증 검색은 8회로, 리서치 9회를 합쳐 17/40회다. 온톨로지 변경: 없음(초안 v0.9 유지). 단계 완료 조건: 미충족. 부족한 것은 평가 지표·검증 절차 조건의 미충족 유지이며, 가설 판정표와 실험 계획은 이번 실행에서 잠정으로 채워질 수 있다. 단계 전환: 미승인(막힌 질문 q5-04·q5-05·q5-07~q5-18과 이번 새 질문, 앞 단계 3·4 완료 미승인).",
  "retry_reason": null,
  "track_checks": {
...
```json
{
  ...
  "outline": [
    {
      ...
      "budget_chars": 6500,
      "summary": "확인한 근거 평가 체계를 이 위키가 묶으면 가설을 하위 주장으로 나눠 GRADE 식으로 확실성을 낮춰 매기고 TRL 을 보조 축으로 두는 절차가 선택지로 보이며, 이를 적용하면 가설 1~3은 모두 잠정 부분 지지다. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f1",
        "f2",
        "f3",
    ...
    },
    {
      ...
      "section": "3. 가설과 판정 상태",
      "budget_chars": 1800,
      "summary": "가설 1~3 판정 칸을 부분 지지(잠정)로 적고 판정 규칙(이 위키의 종합)을 한 단락으로 둔다. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f17",
        "f18",
        "f19",
    ...
    },
    {
      ...
      "section": "6. 검증 방법",
      "budget_chars": 2200,
      "summary": "가설 판정 절차 소절: 확실성 평가·TRL 보조 축·판정 값 규칙·잠정 판정 요약·필요 실험. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f1",
        "f2",
        "f16",
    ...
    },
    {
      ...
      "section": "제안된 실험 계획",
      "budget_chars": 1800,
      "summary": "E5-01~E5-03 을 제안(사용자 수행 대기)으로 싣는다. [추정][^ref-746][^ref-592][^ref-734]",
      "planned_findings": [
        "f21",
        "f22"
      ]
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q5-03 답함(판정 절차·판정 값 규칙·가설별 근거·잠정 판정표·필요 실험), 2절에 q5-16~q5-19 추가, 후속 질문 2건(q5-19, q3-16), 완료 조건 현황·상태 줄 갱신"
    },
    {
      "path": "docs/tracks/nl-task-chatbot/index.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "3절 가설 판정 칸을 부분 지지(잠정)로 갱신(단계 5 · 실행 2026-09-25-86), 판정 규칙 단락·변경 기록 추가, 6절에 실행 기록 추가, 8절에 판정 근거 각주",
      "patches": [
        {
          "section": "3. 가설과 판정 상태",
          "action": "replace",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-86/pages/tracks/nl-task-chatbot/index.md 의 해당 절을 본다)"
        },
        {
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "6절에 '가설 판정 절차' 소절 추가(확실성 평가·TRL 보조 축·판정 값 규칙·잠정 판정 요약·필요 실험, 추정 중심)",
      "patches": [
        {
          "section": "6. 검증 방법",
          "action": "append",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-86/pages/ideas/nl-task-chatbot.md 의 해당 절을 본다)"
        }
      ]
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "'제안된 실험 계획' 절에 E5-01~E5-03 을 제안(사용자 수행 대기)으로 추가",
      "patches": [
        {
          "section": "제안된 실험 계획",
          "action": "replace",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-86/pages/tracks/nl-task-chatbot/experiments.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
  "changelog_entry": "2026-09-25 | 자연어 업무 지시 챗봇 단계 5 | q5-03 답함: 가설 판정 절차·규칙과 잠정 판정(가설 1~3 부분 지지(잠정)), 실험 계획 E5-01~E5-03 제안 | run 2026-09-25-86",
  "index_updates": {
    "home_recent": "2026-09-25 — 자연어 업무 지시 챗봇 단계 5: q5-03 답함, 가설 1~3 잠정 부분 지지 판정표와 제안 실험 E5-01~E5-03(이 위키의 종합, 신뢰도 low)",
    "category_recent": "2026-09-25 — 자연어 업무 지시 챗봇 단계 5: 13. 작업 배정 — MRTA 관련 LLM 직접 배정 대 해법기 배정 근거로 가설 1~3 잠정 부분 지지 판정(반영 제안)",
    "area_recent": "2026-09-25 — 13. 작업 배정 — MRTA: 트랙 자연어 업무 지시 챗봇 단계 5 에서 LLM 직접 배정 대 해법기 배정 비교와 최근접 기준선 실험을 6. 대표 접근법과 기술 반영 제안으로 냄"
  },
  "glossary_updates": [
    {
      "action": "new",
      ...
      "term_en": "Ablation Study",
      "definition": "시스템의 한 구성 요소를 빼거나 다른 것으로 바꿔 성능 변화를 재어 그 구성 요소의 기여를 확인하는 실험이다.",
      "description": "LLM 기반 로봇 계획 연구에서 기호 검증기를 같은 방식으로 프롬프트한 LLM 으로 바꾸면 성공률이 크게 떨어졌다는 보고가 절제 실험의 예다(산업용 로봇 셀 조건, 저자 보고).",
      "related_areas": [
        23,
        27
      ],
  ...
  "standards_updates": [
    {
      "name": "RobotFleet (LLM·MILP 작업 배정기를 둔 중앙 다중 로봇 계획 틀)",
      "kind": "오픈소스",
      "org": "therohangupta (RobotFleet 공식 저장소)",
      "url": "https://github.com/therohangupta/robot-fleet",
      "related_areas": [
      ...
      "summary": "LLM 기반 추론과 MILP 두 작업 배정기를 바꿔 끼울 수 있는 오픈소스 다중 로봇 계획 틀이다. README 에는 두 배정기의 비교 결과가 없다.",
      "ref_id": "ref-814"
    }
  ],
  "track_updates": {
    ...
    "log_entry": "답한 질문: q5-03(판정 절차·판정 값 규칙·가설별 근거·잠정 판정표: 가설 1~3 모두 부분 지지(잠정), 이 위키의 종합, 신뢰도 low) / 새 질문: q5-19(단계 5, f17), q3-16(단계 3, f13) / 온톨로지 변경: 없음(업무 분해·배정 설계 초안 v0.9 유지, 가설 판정은 작업 모델의 개념·관계가 아니라 검증 방법) / 완료 조건 평가: 미충족(부족: 평가 지표·검증 절차 조건 미충족 유지, 가설 판정표·실험 계획은 잠정으로 실었으나 검증 판정 전, 앞 단계 3·4 완료 미승인) / 세부영역 반영 제안: 13. 작업 배정 — MRTA, 23. 시험·형식 검증·벤치마크, 27. AI·학습·적응과 모델 운영 3건(모두 6. 대표 접근법과 기술) / 다음 실행 제안: 현재 단계 3 의 q3-16·q3-05, 또는 단계 5 의 q5-19·q5-05",
    "overview_progress": "단계 3 진행 중(현재 단계 유지, 단계 전환 미승인) — 이번 실행은 지정 질문으로 단계 5 의 q5-03 답함; 단계 5 열린 질문 15, 답함 3, 완료 조건 미충족; 트랙 개요 3절에 가설 1~3 부분 지지(잠정) 기재, 실험 E5-01~E5-03 제안"
  },
  "area_reflection_proposals": [
    ...
    },
    {
      "area_no": 23,
      "section": "6. 대표 접근법과 기술",
      "summary": "GRADE 식 확실성 평가(결과별 네 수준, 다섯 영역 하향)와 TRL 4·5 구분을 보조 축으로 써서 기술 가설을 하위 주장별로 판정하는 방법과 판정 값 규칙(지지·부분 지지·기각·미판정) — 이 위키의 종합(추정), 판정 규칙을 직접 정한 출처 없음"
    },
    {
      "area_no": 27,
      "section": "6. 대표 접근법과 기술",
      "summary": "모듈형 접지 구조가 직접 코드 생성 기준선보다 조작 과제 성공률이 높았다는 보고(원인: 접지 부족·개루프 실행, 로봇 자체 지능·제어는 연계 대상), 기호 검증기를 LLM 으로 바꾼 절제 실험의 성공률 급락(98.1%→3.8%, 산업 셀·저자 보고), 결정적 설정 LLM 의 반복 정확도 변동(최대 15%), LLM 이 루프 밖에서 설계한 스케줄링 규칙(제조·AGV 시뮬레이션). 적용 대상 13. 작업 배정 — MRTA 와 함께 연결"
    }
  ]
}
```

### runs/2026-09-25-86/format_check.md
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/tracks/nl-task-chatbot/index.md (3개 절)
    - docs/ideas/nl-task-chatbot.md (1개 절)
    - docs/tracks/nl-task-chatbot/experiments.md (1개 절)
```

### runs/2026-09-25-86/pages/tracks/nl-task-chatbot/stage-5-verification-and-hypotheses.md
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-730, ref-731, ref-732, ref-733, ref-734, ref-623, ref-735, ref-736, ref-737, ref-540, ref-090, ref-545, ref-592, ref-400, ref-111, ref-031, ref-417, ref-406, ref-104, ref-528, ref-738, ref-739, ref-740, ref-741, ref-407, ref-742, ref-743, ref-744, ref-745, ref-746, ref-747, ref-807, ref-809, ref-813, ref-814, ref-815, ref-816, ref-166, ref-674, ref-594, ref-611, ref-612, ref-236, ref-041, ref-359, ref-677, ref-168, ref-377]
last_run: 2026-09-25
version: 4
---
...
- Garrabé 외(arXiv 2411.05474, 2024-11)는 LLM 출력을 기대 결과 모듈과 피드백으로 접지하는 모듈형 구조가 GPT-4o 기반 code-as-policies(직접 코드 생성) 기준선보다 픽앤플레이스·조작 과제 성공률이 높았다고 보고하고, 기준선 실패 원인으로 환경 접지 부족과 개루프 실행을 들었다(저자 보고, 성공률 수치 미확인, 원문 미열람). [사실][^ref-815] 연계 대상: 조작 과제의 접지·재시도는 분류 원문 9장의 로봇 자체 지능·제어 경계에 속하며, 여기서는 구조 비교의 근거로만 쓴다.
...
- RobotFleet 은 LLM 기반 추론과 혼합 정수 계획(MILP) 두 작업 배정기를 바꿔 끼울 수 있는 오픈소스 다중 로봇 계획 틀로, 논문은 MILP 배정기를 능력 제약 아래 로봇별 최대 작업 부하를 최소화하는 모델로 설명하며 공식 README 에는 두 배정기의 비교 결과가 없다(README 확인일 2026-09-25). [사실][^ref-813][^ref-814] 논문과 README 는 같은 저자라 독립 교차가 아니며, 논문의 LLM 대 MILP 비교 결과는 미확인이다.
...
위 표는 이 위키가 위 판정 값 규칙(추정)을 적용한 잠정 결과이며, 트랙 개요의 가설 문장은 [가설] 로 유지한다. [추정][^ref-166][^ref-815][^ref-677][^ref-236][^ref-746][^ref-041][^ref-592][^ref-612]

- **가설 1**: 구조화·분해 뒤 결정적 해법·검사를 거친 방식이 LLM 직접 배정·직접 코드 생성보다 실패가 적었다는 비교가 있으나, 비교 형태가 이 트랙의 작업 모델 구조화와 같지 않고 LLM 직접 배정이 높은 정답률을 보인 반례가 있으며 물류 조건 근거가 없어, 비직접성(가정·조작·산업 셀 조건)과 비정밀성(단일 출처·저자 보고)으로 두 단계 낮춘 잠정 '부분 지지'(확실성 낮음)로 보인다(이 위키의 종합). [추정][^ref-166][^ref-815][^ref-359][^ref-677][^ref-168][^ref-674]
...
이번 검색 범위(한국어 2회 포함 9회)에서는 물류 창고 로봇 채팅 지시에서 세 가설을 직접 시험한 연구를 찾지 못했다. 국내 자료로는 제조 물류 로봇에 LLM 협업 인터페이스를 구축한 2023 학술대회 논문이 서지 정보로 확인되나 초록·결과를 확인하지 못해 판정 근거로 쓰지 못했다. 부재의 확인은 아니다. [추정][^ref-816] 창고 조건 비교 실측이 없다는 점은 [열린 질문](../../open-questions.md) oq-052 와 겹친다.
...
[^ref-813]: Gupta, R. 외(RobotFleet 저자, arXiv 2510.10379), RobotFleet: An Open-Source Framework for Centralized Multi-Robot Task Planning, 2025-10, https://arxiv.org/abs/2510.10379, 접근일 2026-09-25 (원문 미열람)
[^ref-814]: therohangupta (RobotFleet 공식 저장소), robot-fleet — RobotFleet: An Open-Source Framework for Centralized Multi-Robot Task Planning (GitHub README), 미확인, https://github.com/therohangupta/robot-fleet, 접근일 2026-09-25
[^ref-815]: Garrabé, É., Teixeira, P., Khoramshahi, M., & Doncieux, S., Enhancing Robustness in Language-Driven Robotics: A Modular Approach to Failure Reduction, 2024-11, https://arxiv.org/abs/2411.05474, 접근일 2026-09-25 (원문 미열람)
[^ref-816]: 강건(대한산업공학회 추계학술대회 논문집), 제조 물류 로봇에서의 대규모 언어 모델(LLM)을 활용한 로봇 협업 인터페이스 구축, 2023-11, https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11609734, 접근일 2026-09-25 (원문 미열람)
...
### runs/2026-09-25-86/pages/tracks/nl-task-chatbot/index.md
...
version: 18
confidence: low
sources: [ref-807, ref-809, ref-166, ref-815, ref-674, ref-677, ref-168, ref-236, ref-746, ref-041, ref-592, ref-594, ref-611, ref-612]
---
...
- 가설 1: 구조화·분해 뒤 결정적 해법·검사를 거친 방식이 LLM 직접 배정·직접 코드 생성보다 실패가 적었다는 비교가 있으나, 비교 형태가 작업 모델 구조화와 같지 않고 LLM 직접 배정이 높은 정답률을 보인 반례가 있으며 물류 조건 근거가 없다(이 위키의 종합). [추정][^ref-166][^ref-815][^ref-674][^ref-677][^ref-168]
...
### runs/2026-09-25-86/pages/ideas/nl-task-chatbot.md
...
sources: [ref-054, ref-055, ref-057, ref-058, ref-059, ref-061, ref-089, ref-090, ref-091, ref-093, ref-094, ref-095, ref-087, ref-164, ref-166, ref-167, ref-168, ref-169, ref-170, ref-171, ref-172, ref-174, ref-175, ref-176, ref-177, ref-178, ref-179, ref-180, ref-181, ref-242, ref-272, ref-275, ref-276, ref-277, ref-278, ref-279, ref-280, ref-350, ref-351, ref-352, ref-353, ref-354, ref-355, ref-356, ref-357, ref-358, ref-359, ref-360, ref-362, ref-015, ref-031, ref-125, ref-130, ref-228, ref-411, ref-413, ref-418, ref-111, ref-495, ref-230, ref-496, ref-500, ref-501, ref-502, ref-116, ref-504, ref-539, ref-540, ref-541, ref-542, ref-543, ref-544, ref-545, ref-546, ref-547, ref-548, ref-056, ref-404, ref-377, ref-592, ref-593, ref-594, ref-595, ref-596, ref-598, ref-611, ref-612, ref-615, ref-616, ref-376, ref-236, ref-417, ref-586, ref-674, ref-675, ref-676, ref-711, ref-677, ref-712, ref-678, ref-656, ref-657, ref-039, ref-658, ref-659, ref-660, ref-661, ref-662, ref-663, ref-664, ref-041,
  ref-126, ref-127, ref-680, ref-537, ref-681, ref-682, ref-683, ref-684, ref-373, ref-685, ref-695, ref-696, ref-697, ref-698, ref-699, ref-700, ref-701, ref-702, ref-703, ref-713, ref-714, ref-715, ref-716, ref-717, ref-730, ref-731, ref-732, ref-733, ref-734, ref-623, ref-735, ref-736, ref-737, ref-406, ref-528, ref-738, ref-739, ref-740, ref-741, ref-407, ref-743, ref-744, ref-745, ref-746, ref-416, ref-459, ref-748, ref-752, ref-753, ref-756, ref-757, ref-759, ref-760, ref-761, ref-579, ref-762, ref-763, ref-764, ref-766, ref-767, ref-768, ref-769, ref-770, ref-771, ref-776, ref-807, ref-809, ref-815, ref-400]
confidence: low
last_run: 2026-09-25
---
...
위 표는 이 위키가 판정 규칙(추정)을 적용한 잠정 결과이며, 근거가 가정·조작·산업 셀·운영과학 일반·제조 AGV 시뮬레이션 조건의 단일 출처 저자 보고이고 물류 창고 조건의 직접 근거는 없다. [추정][^ref-166][^ref-815][^ref-677][^ref-168][^ref-236][^ref-746][^ref-041][^ref-592][^ref-612] 가설 3 의 반례는 제조·AGV 시뮬레이션 조건의 저자 보고이며 롤링 MILP 는 AGV 운송 하위 문제의 추상화이고 물류 창고 적용은 미확인이다. [사실][^ref-612]
...
원천: [질문 백로그](../tracks/nl-task-chatbot/question-backlog.md)([자연어 업무 지시 챗봇](../tracks/nl-task-chatbot/index.md) 트랙) · 열림 47건 · 답함 17건 · 폐기 1건
...
### runs/2026-09-25-86/pages/tracks/nl-task-chatbot/experiments.md
...
### docs/glossary/index.md (요약: 용어 204개, slug: 한국어 (영어). 정의는 docs/glossary/<slug>.md)
