  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q3-04 답함(3절 소제목 {#q3-04} 신설, 변경 유형별 조작 표·도식, 출하 시나리오), 2절 질문 목록 갱신과 q3-15 추가, 4절 결론 추가, 후속 질문 3건, 6절 완료 조건 미충족·전환 아니오, 7절 반영 제안, 8절 각주 12건 추가, 9절 이력 행 추가",
      "patches": [
        {
          "section": "2. 질문 목록",
          "action": "replace",
...
- 퍼블리셔 사전 검사: - tracks/nl-task-chatbot/stage-3-implementation-hypothesis.md: 깨진 링크 ../../glossary/event-driven-rescheduling.md
- 퍼블리셔 사전 검사: - tracks/nl-task-chatbot/stage-3-implementation-hypothesis.md: 깨진 링크 ../../glossary/frozen-horizon.md
