# 스토리텔러 산출 2026-09-25-29

## 페이지

| 동작 | 경로 | 상태 | 변경 요약 |
|---|---|---|---|
| update | docs/categories/a-business-supply-chain-design/index.md | draft | '다른 대분류와의 연결' 절 신규 작성(B~G 6개 대분류, 세부영역 연결 18쌍·근거 finding 22건, Mermaid 도식), '참고 자료' 절 끝에 각주 정의 23건 추가. 2차: 번호만 쓴 호칭 수정, 첫 문장 태그·각주 보강 |

## 변경 이력·색인

- 변경 이력: 2026-09-25 | A. 업무·공급망 설계 | 다른 대분류와의 연결 절 작성(B~G 여섯 대분류, 세부영역 연결 18쌍, 근거 finding 22건 중 추정 9건) | run 2026-09-25-29
- 홈 최근 업데이트: 2026-09-25 — A. 업무·공급망 설계: 다른 대분류와의 연결 절을 새로 썼다(B. 공통 정보·환경 모델 ~ G. 안전·보안·지능·거버넌스, 세부영역 연결 18쌍, 근거 finding 22건 중 추정 9건)
- 대분류 최근 업데이트: 2026-09-25 — A. 업무·공급망 설계: 다른 대분류와의 연결 절 작성. 1. 주문·업무 시스템 연계 ~ 4. 성과·경제성·프로세스 개선이 B. 공통 정보·환경 모델 ~ G. 안전·보안·지능·거버넌스의 세부영역과 이어지는 지점을 세부영역 연결 18쌍(근거 finding 22건, 그중 추정 9건)으로 근거 각주와 함께 정리
- 세부영역 최근 업데이트: —
