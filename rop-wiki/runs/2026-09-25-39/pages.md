...
| create | docs/topics/2026/2026-09-25-area15-s6.md | draft | 자동 분리: 15. 다중 로봇 경로·교통 관리 — MAPF 의 "6. 대표 접근법과 기술" 절(2,051자)을 옮겼다 |
| create | docs/topics/2026/2026-09-25-area15-s8.md | draft | 자동 분리: 15. 다중 로봇 경로·교통 관리 — MAPF 의 "8. 대표 연구와 자료" 절(1,679자)을 옮겼다 |
| create | docs/topics/2026/2026-09-25-area15-s7.md | draft | 자동 분리: 15. 다중 로봇 경로·교통 관리 — MAPF 의 "7. 관련 표준·프레임워크·오픈소스" 절(1,155자)을 옮겼다 |
