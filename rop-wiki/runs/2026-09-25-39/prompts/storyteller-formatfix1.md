...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 800,
      "summary": "MAPD 로 13. 작업 배정 — MRTA, 공유 자원으로 16. 공용 자원·충전·에너지 최적화, 경로망으로 6·21, 제어 수준으로 9, 경로망 평가 시뮬레이션으로 22, 학습 기반 MAPF 로 27 과 이어진다. [추정][^ref-006][^ref-079]",
      "planned_findings": [
        "f30",
        "f25"
      ]
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 15. 다중 로봇 경로·교통 관리 — MAPF 의 \"7. 관련 표준·프레임워크·오픈소스\" 절(1,155자)을 옮겼다"
    },
    {
  ...
  "fixes_applied": [
    ...
    "원문 미열람 표시 — ref-005·ref-006·ref-253·ref-267·ref-268·ref-828·ref-829·ref-830·ref-831·ref-832·ref-834·ref-835·ref-836·ref-837·ref-838·ref-841 의 13절 각주 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates 해당 항목에 source_unopened: true 를 넣었다(ref-253 summary 도 '원문 미열람'으로 시작하게 고침).",
    ...
    "f18·f26·f27·f28·f29·f30 — [추정] 태그를 유지하고 문장에 '이 위키는 추정한다/추론한다'를 밝혔다. f28 시나리오는 5절 첫 문장에 확인된 현장 사례가 아닌 설명용 가상 시나리오임을 적었고, f27 은 9절에서 '연계 대상'으로 짧게 다루며 로컬 회피 책임을 명시한 문구를 찾지 못했음을 적었다.",
...
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area15-s7.md: 깨진 링크 ../../references/ref-839.md
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area15-s7.md: 깨진 링크 ../../references/ref-833.md
