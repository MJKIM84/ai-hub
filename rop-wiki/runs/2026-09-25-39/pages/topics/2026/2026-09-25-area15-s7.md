...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-004, ref-031, ref-079, ref-253, ref-191, ref-197]
last_run: 2026-09-25
version: 1
...
| rmf_traffic | 오픈소스 | 여러 에이전트 사이 이동로봇 교통을 스케줄링·협상하는 알고리즘과 자료구조를 제공하는 Open-RMF 패키지다. [사실][^ref-197] | ref-197 |
...
| MAPF-LRR2023 | 오픈소스 | League of Robot Runners 2023 대회 참가 팀이 공개한 지속형 MAPF 해법(WPPL) 저장소다(우승은 팀 자기 보고). [사실][^ref-191] | ref-191 |
