...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: 같은 파일(task_state.json)이 이미 참고문헌 ref-182 로 게시돼 2. 공정·워크플로 모델링 페이지에서 같은 12개 상태 값으로 검증됐다. 새 id 대신 기존 ref-182 을 재사용한다(required_fixes)."
    },
    {
      "finding_id": "f10",
      "source_exists": true,
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "'연계 대상:' 표시가 있고 분류 원문 9장 '상위 업무 시스템' 경계와 맞다. 근거 ref-190·ref-189·ref-002 가 원문 미열람인데 finding 의 source_unopened 가 false 로 적혀 있다(verification_note 기록). [추정] low 유지."
    },
    {
      "finding_id": "f25",
      "source_exists": true,
  ...
  "duplication": {
    "ok": false,
    "overlaps": [
      "참고문헌 id 충돌: 브리프의 ref-138·ref-182·ref-183·ref-184·ref-111·ref-185·ref-186·ref-187·ref-188·ref-189·ref-190·ref-191·ref-192 가 이미 게시된 다른 출처(task_new, task_state.json, OMG BPMN, Camunda, Corradini 외, Filippone 외, B2MML-Common.xsd, B2MML-OperationsDefinition.xsd, IEC 62264-3, Blondin 외, OCEL 2.0, SCOR F1.3, 스마트물류센터 인증제 안내)의 id 와 같다",
      "브리프 ref-110(task_new)는 게시된 ref-138 과, 브리프 ref-111(task_state.json)는 게시된 ref-182 과 같은 문서다 — 기존 id 재사용 대상",
      "f9(Open-RMF 작업 상태 12개 값)·f10(task_new 작업 요청 방식)은 게시된 2. 공정·워크플로 모델링 페이지의 같은 주장과 겹친다 — 기존 각주 ref-182·ref-138 재사용",
      "f11(B2MML 판 0701·ISA-95 2018 기반)은 게시된 2. 공정·워크플로 모델링의 B2MML-Common.xsd(ref-186) 서술과 겹치며 용어집 B2MML 항목이 이미 있다",
  ...
  "required_fixes": [
    "참고문헌 id 재부여: 브리프의 출처 id 를 다음처럼 한 번에 바꿔 본문 각주·프런트매터 sources·reference_updates 에 일관되게 쓴다 — ref-138(task_request.json)→ref-125, ref-182(cancel_task_request.json)→ref-126, ref-183(interrupt_task_request.json)→ref-127, ref-184(rewind_task_request.json)→ref-128, ref-111(task_state.json)→기존 ref-182 재사용, ref-110(task_new)→기존 ref-138 재사용, ref-185(B2MML-TransactionProfile.xsd)→ref-129, ref-186(ISA95-JOBCONTROL 노드셋)→ref-130, ref-187(OPC 10031-4 6.2)→ref-131, ref-188(Yu·Srinivas)→ref-132, ref-120(Lorenz 외)→ref-133, ref-189(Gallien·Weber)→ref-134, ref-190(SCOR DS 소개 문서)→ref-135, ref-191(Applied Sciences 사례)→ref-136, ref-192(머니투데이)→ref-137. 재사용 ref-002·ref-031 은 그대로 쓴다 — 이유: 브리프 id 가 게시된 참고문헌 ref-138~ref-192 와 충돌하며, 기존 ref-138·ref-182 페이지를 덮어쓰지 않는다. 기존 ref-138·ref-182 은 reference_updates 로 새로 등록하지 않는다.",
    "각주 원문 미열람 표기: 원문을 열지 않은 출처 ref-002, ref-131, ref-132, ref-133, ref-134, ref-135, ref-136, ref-137(새 id 기준)의 각주 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates[].source_unopened: true 로 둔다. raw 원문을 연 ref-031, ref-138, ref-182, ref-125~ref-130 에는 붙이지 않는다.",
    ...
    "f9·f10: 2. 공정·워크플로 모델링 페이지에 이미 있는 같은 주장이므로 새 각주를 만들지 않고 ref-182·ref-138 을 달며, 10절에서 2. 공정·워크플로 모델링과 연결한다.",
...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 550,
      "summary": "이번 조사에서 확인한 관련 규격은 로봇 쪽 VDA 5050 3.0.0·Open-RMF 작업 API, 상위 쪽 B2MML·OPC UA for ISA-95 Job Control·ISA-95 Part 1, 업무 범위 쪽 SCOR DS 이다. [사실][^ref-031][^ref-129]",
      "planned_findings": [
        "f1",
        "f7",
        "f8",
    ...
    },
    {
      ...
      "section": "8. 대표 연구와 자료",
      "budget_chars": 700,
      "summary": "이번 조사에서 확인한 자료는 동적 주문 피킹 연구와 웨이브리스 출고 지시 연구, 다제조사 플릿 관리 사례, 국내 WMS–로봇 연동 발표이다. [사실][^ref-132][^ref-134]",
      "planned_findings": [
        "f16",
        "f17",
        "f18",
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "섹션 3~11 신규 작성(자동 분리 반영). 2차 수정: 각주 ref-138·ref-182 → ref-110·ref-111, 5절 시작 조건·9절 마지막 문장 사실/추정 분리, 9절 표 태그 추가, 7·8절 첫 문장 목록 서술로 변경, sources 에서 미인용 ref-131 제외"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s4.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"4. 핵심 개념과 용어\" 절. 2차 수정: 각주 ref-182 → ref-111"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s8.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"8. 대표 연구와 자료\" 절. 2차 수정: 첫 문장을 '이번 조사에서 확인한 자료는 … 이다'로 변경"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s6.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"6. 대표 접근법과 기술\" 절. 2차 수정: 각주 ref-138 → ref-110, 번역 절 마지막 문장 사실/추정 분리"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s11.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"11. 열린 질문\" 절(2차 수정 없음)"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s7.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"7. 관련 표준·프레임워크·오픈소스\" 절. 2차 수정: 각주 ref-138·ref-182 → ref-110·ref-111, 첫 문장 목록 서술로 변경"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area01-s3.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 1. 주문·업무 시스템 연계 의 \"3. 왜 중요한가\" 절(717자)을 옮겼다"
    }
  ],
  "changelog_entry": "2026-09-25 | 1. 주문·업무 시스템 연계 | 3~11절 신규 작성: 로봇 인터페이스의 주문 갱신·취소·일시정지·되감기, ISA-95 작업 지시·B2MML 거래 동사, 동적 주문 피킹 연구, 피킹 → 출하 시나리오, ROP 경계, 새 열린 질문 3건(2차 수정: 각주 ref-110·ref-111 정정, 사실·추정 분리) | run 2026-09-25-13",
  "index_updates": {
    ...
    "area_recent": "2026-09-25 — 1. 주문·업무 시스템 연계: 영역 심화로 3~11절 신규 작성(참고문헌 ref-125~ref-137 신규, ref-002·ref-031·ref-110·ref-111 재사용)"
  },
  "glossary_updates": [
    {
      "action": "new",
  ...
  "reference_updates": [
    {
      ...
      "cited_by": [
        ...
        "docs/topics/2026/2026-09-25-area01-s7.md"
      ]
    },
    {
      "id": "ref-031",
      ...
      "cited_by": [
        "docs/categories/a-business-supply-chain-design/01-order-and-business-system-integration.md",
        "docs/topics/2026/2026-09-25-area01-s4.md",
        "docs/topics/2026/2026-09-25-area01-s6.md",
        "docs/topics/2026/2026-09-25-area01-s7.md"
      ]
    },
    {
    ...
    },
    {
      ...
      "cited_by": [
        "docs/categories/a-business-supply-chain-design/01-order-and-business-system-integration.md",
        "docs/topics/2026/2026-09-25-area01-s6.md",
        "docs/topics/2026/2026-09-25-area01-s8.md"
      ]
    },
    {
      "id": "ref-133",
...
- 판정: 통과
- 분량 초과 자동 분리:
    - docs/categories/a-business-supply-chain-design/01-order-and-business-system-integration.md "3. 왜 중요한가" → docs/topics/2026/2026-09-25-area01-s3.md (717자)
```
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-111, ref-129, ref-130, ref-131, ref-134]
last_run: 2026-09-25
version: 1
...
- **작업 상태(task state, [Open-RMF](../../glossary/open-rmf.md))** — 작업 상태 스키마는 uninitialized·blocked·error·failed·queued·standby·underway·delayed·skipped·canceled·killed·completed 상태 값과 배정 로봇, 예상 소요 시간, 단계, 중단·취소·강제 종료 요청 정보를 담는다. [사실][^ref-111]
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-110, ref-125, ref-126, ref-127, ref-128, ref-129, ref-130, ref-131, ref-132, ref-133]
last_run: 2026-09-25
version: 1
...
Open-RMF 작업 요청 스키마는 category·description 을 필수로, 플릿이 지원하는 우선순위 스키마에 맞춰야 하는 priority, 가장 이른 시작 시각, 요청 시각, 요청자, 라벨, 입찰할 수 있는 플릿 이름을 선택 필드로 둔다. [사실][^ref-125] 이미 요청한 작업에는 task_id 로 지정하는 취소·중단 요청과 지정한 단계의 처음부터 다시 시작시키는 되감기 요청(phase_id 필수)을 별도 스키마로 둔다. [사실][^ref-126][^ref-127][^ref-128] 작업은 가장 적합한 플릿에 맡기는 dispatch_task_request 나 특정 로봇에 맡기는 robot_task_request 로 보낸다. [사실][^ref-110]

### 상위 지시를 로봇 동작으로 번역

상위 시스템의 변경·취소 지시(B2MML CHANGE·CANCEL, OPC UA Job Control Update·Pause·Abort)는 로봇 쪽 주문 갱신·일시정지·취소·재지시로 옮겨야 한다. 그러나 취소할 수 없는 동작은 끝까지 수행되고 base 는 바뀌지 않으므로 번역은 일대일이 아니며, 화물을 실은 뒤라면 되돌림 작업이 추가로 필요할 것으로 보인다. [추정][^ref-129][^ref-130][^ref-131][^ref-031] B2MML 거래 프로파일 스키마에는 동사별 의미 정의가 없다. [사실][^ref-129] 그래서 번역 규칙의 근거를 따로 정해야 할 것으로 보인다. [추정][^ref-129]
...
### runs/2026-09-25-13/pages/topics/2026/2026-09-25-area01-s3.md
...
### runs/2026-09-25-13/verification2.json
...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "이번 2차 검증에서 새로 찾은 문제다. 세부영역 페이지 9절 마지막 문장은 'VDA 5050 이 외부 IT 인터페이스를 범위 밖에 두므로 상위 시스템과의 번역 계층은 ROP 쪽 인터페이스 설계 과제가 된다'를 [사실][^ref-031] 하나로 묶었다. 앞 절은 f1(사실)이다. 뒤 절은 f21·f23·f24 의 추론([추정] low)이므로 태그가 올라갔다."
    }
  ],
  "category_fit": {
    "ok": true,
  ...
  "duplication": {
    "ok": false,
    "overlaps": [
      "1차 지시 오류: 입력 docs/references/index.md 에서 task_new 는 게시된 ref-110 이고 task_state.json 은 게시된 ref-111 이다. ref-138·ref-182 는 참고문헌 목록에 없다(목록은 ref-124 까지). 1차 판정의 '게시된 ref-138~ref-192' 목록은 실제 게시 id ref-110~ref-124 를 잘못 읽은 것이다. 그래서 스토리텔러가 각주로 단 ref-138(task_new)·ref-182(task_state.json)는 존재하지 않는 참고문헌 id 를 가리킨다.",
      "새 id ref-125~ref-137 은 입력 참고문헌 목록 기준으로 비어 있어 충돌이 없다."
    ]
  },
  "terminology": {
    "ok": true,
  ...
  "corrections_rejected": [],
  "required_fixes": [
    "참고문헌 id 정정(1차 지시 오류 바로잡기): 모든 페이지에서 각주 [^ref-138] 을 [^ref-110] 으로, [^ref-182] 를 [^ref-111] 로 바꾼다. 해당 페이지는 세부영역 페이지와 주제 페이지 2026-09-25-area01-s4·s6·s7 이다. 바꿀 곳은 본문 각주 참조, 각주 정의 줄, 프런트매터 sources 이다. 각주 정의 문자열은 게시된 ref-110·ref-111 과 같게 둔다. index_updates.area_recent 의 'ref-138·ref-182 재사용'도 'ref-110·ref-111 재사용'으로 고친다. ref-110·ref-111 은 이미 게시돼 있으므로 reference_updates 에 넣지 않는다. 이유: 입력 docs/references/index.md 에서 task_new 는 ref-110, task_state.json 은 ref-111 이고, ref-138·ref-182 는 없다. 그대로 게시하면 각주가 존재하지 않는 참고문헌을 가리킨다.",
