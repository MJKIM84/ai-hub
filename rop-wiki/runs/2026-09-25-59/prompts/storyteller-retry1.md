...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 800,
      "summary": "22. 시뮬레이션·예측용 디지털 트윈과는 목적으로 나뉘고(구축자 의견)[의견][^ref-406], 15. 다중 로봇 경로·교통 관리 — MAPF 등 여러 영역과 이어진다.",
      "planned_findings": [
        "f20",
        "f5",
        "f11",
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 23. 시험·형식 검증·벤치마크 의 \"10. 다른 연구영역과의 연결 (번호와 이름을 함께 표기)\" 절(824자)을 옮겼다. 형식 수정: 본문 세부영역 링크를 주제 페이지 위치 기준(../../categories/…) 경로로 고쳤다"
    }
  ],
