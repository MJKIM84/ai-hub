...
```json
{
  ...
  "required_fixes": [
    ...
    "각주·reference_updates: 이번 실행에서 원문을 열지 않은 신규 출처 ref-730·ref-731·ref-732·ref-733·ref-734·ref-735·ref-737 은 각주 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates[].source_unopened: true 로 둔다. ref-736·ref-738 은 github_raw 로 연 원문이므로 표시 없이 둔다. 재사용 출처 ref-540·ref-545·ref-090·ref-592·ref-400·ref-111 은 기존 페이지의 각주 줄을 그대로 재사용한다.",
...
### runs/2026-09-25-98/docs_tree.txt
