  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "영역 심화: 섹션 3~11 신규 작성, 각주 21건, 페이지 상태 자동 영역 추가"
    },
    {
...
- 판정: 통과
- 분량 초과 자동 분리:
    - docs/categories/d-planning-and-optimization/14-task-sequencing-and-scheduling.md "6. 대표 접근법과 기술" → docs/topics/2026/2026-09-25-area14-s6.md (1,504자)
    - docs/categories/d-planning-and-optimization/14-task-sequencing-and-scheduling.md "4. 핵심 개념과 용어" → docs/topics/2026/2026-09-25-area14-s4.md (985자)
    - docs/categories/d-planning-and-optimization/14-task-sequencing-and-scheduling.md "8. 대표 연구와 자료" → docs/topics/2026/2026-09-25-area14-s8.md (904자)
    - docs/categories/d-planning-and-optimization/14-task-sequencing-and-scheduling.md "11. 열린 질문" → docs/topics/2026/2026-09-25-area14-s11.md (865자)
```
