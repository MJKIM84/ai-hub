...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: IDTA 02020 README 원문에서 능력 정의, 속성 예, 속성 제약(전제·불변·사후조건), 전이 제약, 스킬에 의한 구현이 일치함. ref-126·ref-127 은 발행 주체가 같아 독립한 교차 확인이 아님."
    },
    {
      "finding_id": "f7",
      "source_exists": true,
  ...
  "duplication": {
    ...
    "overlaps": [
      ...
      "참고문헌 id 충돌 가능성: 실행 2026-09-25-15 브리프가 ref-125~ref-139 를 다른 출처에 배정했다(예: 그쪽 ref-127 = MassRobotics JSON, 이번 ref-127 = IDTA 02020 템플릿).",
