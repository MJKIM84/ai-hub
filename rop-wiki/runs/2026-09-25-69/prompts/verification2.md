...
```json
{
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "seed → draft: 3~11절 첫 작성(규격 구속력·데이터 권리, 변경 정책·적합성 시험, 입고·출하 시나리오, 경계·연결·열린 질문), 페이지 상태 자동 영역 추가, 13절 각주 21건"
    },
    {
  ...
  "changelog_entry": "2026-09-25 | 28. 표준·상호운용성·다사업자 거버넌스 | seed → draft: 3~11절 첫 작성(규격 구속력·데이터 권리, 판 번호·폐기 예고·적합성 시험, 입고·출하 시나리오, 책임 경계·연결·열린 질문), f12 추정 강등 반영 | run 2026-09-25-69",
  "index_updates": {
    "home_recent": "2026-09-25 — 28. 표준·상호운용성·다사업자 거버넌스: 3~11절 첫 작성(VDA 5050 판 정책·책임 분리, 적합성 시험, 데이터 권리 법제, 감사·서비스 수준)",
    "category_recent": "2026-09-25 — 28. 표준·상호운용성·다사업자 거버넌스: seed → draft, 3~11절 첫 작성과 13절 각주 21건",
...
- 판정: 통과
- 분량 초과 자동 분리:
    - docs/categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md "7. 관련 표준·프레임워크·오픈소스" → docs/topics/2026/2026-09-25-area28-s7.md (1,840자)
    - docs/categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md "6. 대표 접근법과 기술" → docs/topics/2026/2026-09-25-area28-s6.md (1,549자)
    - docs/categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md "11. 열린 질문" → docs/topics/2026/2026-09-25-area28-s11.md (1,233자)
    - docs/categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md "4. 핵심 개념과 용어" → docs/topics/2026/2026-09-25-area28-s4.md (1,053자)
    - docs/categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md "3. 왜 중요한가" → docs/topics/2026/2026-09-25-area28-s3.md (802자)
```
...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 0건 / 전체 631건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/open-questions.md (요약: 대상 영역 [28] 에 걸린 16건 / 전체 107건)
