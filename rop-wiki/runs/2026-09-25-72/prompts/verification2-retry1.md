...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 600,
      "summary": "보정 항목 목록 반영은 충족(2차 확인), 도면–현장 정합 절차 초안은 미충족이라 단계 완료 조건은 미충족이고 전환은 승인되지 않았다."
    },
    {
      "path": "docs/tracks/floorplan-recognition/space-graph-schema-draft.md",
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q4-01 답함(보정 여섯 묶음·용도별 지도·ROP 경계, 추정), 후속 질문 2건(q4-09·q4-10), 완료 조건 첫 행 충족(2차 확인)·둘째 행 미충족, 상태 줄 진행 중; 2차: 시나리오 제약 칸 비용 지도 필터 문장을 Nav2 로 한정"
    },
    {
      "path": "docs/tracks/floorplan-recognition/space-graph-schema-draft.md",
      "action": "update",
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-72/pages/ideas/floorplan-recognition.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
...
### runs/2026-09-25-72/format_check.md
...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 149건 / 전체 657건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/glossary/index.md (요약: 용어 169개, slug: 한국어 (영어). 정의는 docs/glossary/<slug>.md)
