...
|---|---|---|---|---|---|
| new | 작업 지시 | Job Order (ISA-95) | ISA-95 운영 관리 활동 모델에서 실행할 작업 단위의 요청으로, 작업 요청(work request)을 이루는 구성 요소이다. | 1, 2 | ref-102 |
| new | 작업 응답 | Job Response (ISA-95) | ISA-95 에서 작업 지시에 대해 수행된 작업을 보고하는 정보이다. | 1, 2 | ref-102 |
| new | B2MML | Business To Manufacturing Markup Language (B2MML) | MESA International 이 공개한 ISA-95(IEC/ISO 62264) 데이터 모델의 XML 스키마 구현이다. | 1, 28 | ref-100, ref-101 |
...
| ref-096 | Open Robotics (open-rmf) | rmf_api_msgs — rmf_api_msgs/schemas/task_request.json | 오픈소스 문서 | high | https://github.com/open-rmf/rmf_api_msgs/blob/main/rmf_api_msgs/schemas/task_request.json |
| ref-097 | Open Robotics (open-rmf) | rmf_api_msgs — rmf_api_msgs/schemas/cancel_task_request.json | 오픈소스 문서 | high | https://github.com/open-rmf/rmf_api_msgs/blob/main/rmf_api_msgs/schemas/cancel_task_request.json |
| ref-098 | Open Robotics (open-rmf) | rmf_api_msgs — rmf_api_msgs/schemas/task_state.json | 오픈소스 문서 | high | https://github.com/open-rmf/rmf_api_msgs/blob/main/rmf_api_msgs/schemas/task_state.json |
| ref-099 | Open Robotics | Tasks in RMF (task_new) - Programming Multiple Robots with ROS 2 | 오픈소스 문서 | high | https://osrf.github.io/ros2multirobotbook/task_new.html |
| ref-100 | MESA International | MESAInternational/B2MML-BatchML — README | 표준 | high | https://github.com/MESAInternational/B2MML-BatchML |
| ref-101 | MESA International | B2MML-BatchML/Schema/B2MML-TransactionProfile.xsd | 표준 | high | https://github.com/MESAInternational/B2MML-BatchML/blob/master/Schema/B2MML-TransactionProfile.xsd |
| ref-102 | OPC Foundation / ISA | OPC UA for ISA-95 - Part 4: Job Control (OPC 10031-4) | 표준 | medium | https://reference.opcfoundation.org/ISA95JOBCONTROL/v200/docs/ |
| ref-060 | Merschformann, M. 외 | Decision Rules for Robotic Mobile Fulfillment Systems | 논문 | medium | https://arxiv.org/abs/1801.06703 |
| ref-103 | 씨메스(CMES Robotics) | 물류 자동화 시스템을 이해하는 첫 걸음 : WES · WCS · WMS, 무엇이 다를까요? | 벤더 문서 | low | https://blog.cmesrobotics.ai/wes-wcs-wms |
...
|---|---|---|---|---|---|
| B2MML (Business To Manufacturing Markup Language, 거래 프로파일 Version 0701) | 표준 | MESA International | 1, 28 | ref-100 | https://github.com/MESAInternational/B2MML-BatchML |
| OPC UA for ISA-95 Part 4: Job Control (OPC 10031-4) | 표준 | OPC Foundation / ISA | 1, 2 | ref-102 | https://reference.opcfoundation.org/ISA95JOBCONTROL/v200/docs/ |
