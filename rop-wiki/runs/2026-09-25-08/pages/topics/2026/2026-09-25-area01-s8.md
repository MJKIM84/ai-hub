...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-116, ref-117]
last_run: 2026-09-25
version: 1
...
- Merschformann, M. 외, Decision Rules for Robotic Mobile Fulfillment Systems(2018, arXiv 프리프린트) — 로봇 이동식 풀필먼트 시스템(Robotic Mobile Fulfillment System, RMFS)의 운영 의사결정을 주문 배정, 작업 생성, 로봇 작업 배정, 경로 계획의 네 단계로 나눈다. [사실][^ref-117] 이 영역에서는 상위 쪽 주문 배정과 로봇 쪽 작업 배정을 구분하는 출발점으로 쓸 수 있다(구축자 의견). [의견]
- VDA 5050 공식 명세(3.0.0, GitHub 저장소 본문) — 주문 갱신·취소·거부 규칙의 1차 자료다. [사실][^ref-031]
- OPC UA for ISA-95 Part 4: Job Control — 상위 쪽 작업 지시의 저장·시작·갱신·중단 절차를 정의한 동반 규격이다. [사실][^ref-116]
