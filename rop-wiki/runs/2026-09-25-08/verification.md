...
| f15 | 예 | 예 | 아니오 | 유지 | 추론 finding. 근거 f1·f5·f7·f11 은 확인됐고, 매핑 부재는 검색 범위 기준이며 부재의 확인이 아님을 유지해야 한다. ref-102 는 원문 미열람인데 브리프가 source_unopened false 로 적었다(브리프 기록 누락). |
...
| f17 | 예 | 예 | 아니오 | 유지 | 추론 finding. 근거 f10·f12(원문 미열람)·f1·f2·f6 확인. cancelOrder 가 정지와 동작 상태만 규정하고 화물 원위치 복귀를 규정하지 않는다는 점은 원문 6.1.3절과 맞다. ref-102 원문 미열람 표기 누락(브리프). |
