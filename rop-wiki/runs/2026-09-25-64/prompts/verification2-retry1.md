...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 1100,
      "summary": "이 위키가 이번 실행의 출처 상태를 정리하면, 기술 근거는 대부분 단일 공식 문서이고 법규·표준은 검색 요약 기준(원문 미열람)이다. [의견]",
      "planned_findings": [
        "f6",
        "f11",
        "f12",
    ...
    },
    {
      ...
      "section": "8. 대표 연구와 자료",
      "budget_chars": 600,
      "summary": "이 위키가 정리한 판단 근거 자료는 설계 문서·정부 권고·지침이 중심이며, 확인한 학술 논문은 IEC 62443 구역·도관 논문 한 건이고 물류 로봇 보안을 직접 다룬 학술 연구는 확인하지 못했다. [의견][^ref-618]",
      "planned_findings": [
        "f5",
        "f14",
        "f18",
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "seed → draft: 3~11절 첫 작성(접근 제어 구조, 규제·한국 개인영상 규정, 출하·입고 시나리오, 경계·연결·열린 질문), 페이지 상태 자동 영역 추가, 13절 각주. 2차: 7절 첫 문장을 [의견]으로 바꾸고 ref-031 각주 제거, 8절 학술 자료 문장 수정"
    },
    {
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 26. 사이버보안·접근권한·개인정보 의 \"7. 관련 표준·프레임워크·오픈소스\" 절을 옮겼다. 2차: 첫 문장을 [의견]으로 바꾸고 ref-031 각주 제거, NIST 행에서 '산업용 IoT' 삭제"
    },
    {
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 26. 사이버보안·접근권한·개인정보 의 \"8. 대표 연구와 자료\" 절을 옮겼다. 2차: 첫 문장의 학술 논문 성격 서술을 바로잡았다"
    }
  ],
  ...
  "reference_updates": [
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. OT 보안 지침 3판. 범위를 건물 자동화·물리적 출입통제로 넓히고 SP 800-53 Rev. 5 OT 오버레이 제공.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/g-safety-security-intelligence-and-governance/26-cybersecurity-access-control-and-privacy.md"
      ]
...
이 위키가 정리한 이 영역의 판단 근거 자료는 설계 문서·정부 권고·지침이 중심이다. 이번 조사에서 확인한 학술 논문은 IEC 62443 구역·도관 논문(ref-618) 한 건이며, 물류 로봇 보안을 직접 다룬 학술 연구는 확인하지 못했다. [의견][^ref-618]
...
| NIST SP 800-82 Rev. 3 | 프레임워크 | 2023-09판에서 제목을 운영 기술(OT) 보안 지침으로 바꾸고 범위를 건물 자동화·물리적 출입통제로 넓혔으며 SP 800-53 Rev. 5 OT 오버레이를 제공 [사실][^ref-615] | NIST |
...
### docs/open-questions.md (요약: 대상 영역 [26] 에 걸린 3건 / 전체 98건)
...
### runs/2026-09-25-64/verification2.json
