...
```json
{
  ...
  "claim_checks": [
    ...
    },
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인. ref-612 원문(github_raw)에 TLS, OIDC(Keycloak 구현), 역할마다 보안 노드를 둔다는 인용 문장(원문과 같음), 배포 전 private 디렉터리 제거, generate_policy·generate_artifacts 가 있다. 발행일 미확인. 단일 출처."
    },
    {
      "finding_id": "f5",
      "source_exists": true,
    ...
    },
    {
      ...
      "cross_checked": true,
      "tag_decision": "유지",
      "note": "원문 미열람, 검색 결과 일치. A3 FAQ(ref-614)의 문장이 검색 요약에 그대로 나오고, The Robot Report·TÜV Rheinland 도 같은 취지다(브리프 밖 자료로 교차 확인). 조항 내용은 미확인이며 ISO 원문이 아니라 업계 협회 해설이라는 점을 병기한다."
    },
    {
      "finding_id": "f16",
      "source_exists": true,
  ...
  "required_fixes": [
    ...
    "원문 미열람 표기: ref-759, ref-614, ref-615, ref-616, ref-617, ref-618, ref-620, ref-621, ref-622, ref-623, ref-624 의 각주 정의에는 접근일 뒤에 ' (원문 미열람)'을 붙이고, reference_updates 에는 source_unopened: true 를 넣는다. ref-009, ref-010, ref-031, ref-610~ref-613 은 원문을 연 출처이므로 표기하지 않는다.",
