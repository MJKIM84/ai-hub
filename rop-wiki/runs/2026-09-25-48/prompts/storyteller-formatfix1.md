...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 700,
      "summary": "4·8·9·10·12·18·20·27번 영역과 이어지며, 27. AI·학습·적응과 모델 운영의 장애 분석 교차 규칙을 반영한다.",
      "planned_findings": [
        "f1",
        "f3",
        "f6",
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "영역 심화: 3~11절 신규 작성, 페이지 상태 자동 표식 추가, 13절 각주 17건 정의(1차 조건부 승인 수정 14건 반영)"
    },
    {
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 19. 모니터링·이상 탐지·원인 분석 의 \"8. 대표 연구와 자료\" 절(1,396자)을 옮겼다"
    },
    {
      "path": "docs/topics/2026/2026-09-25-area19-s6.md",
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 19. 모니터링·이상 탐지·원인 분석 의 \"6. 대표 접근법과 기술\" 절(861자)을 옮겼다"
    },
    {
...
REFLECT(2023)는 영상·소리·로봇 상태 같은 다중 감각 관측을 계층적 경험 요약으로 바꾼 뒤 대규모 언어 모델(LLM)에 실패 원인 설명과 수정 계획을 묻는다. [사실][^ref-512] 이는 [27. AI·학습·적응과 모델 운영](../g-safety-security-intelligence-and-governance/27-ai-learning-adaptation-and-model-operations.md)의 방법을 장애 분석에 적용한 예다.
...
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area19-s6.md: 깨진 링크 ../g-safety-security-intelligence-and-governance/27-ai-learning-adaptation-and-model-operations.md
- 퍼블리셔 사전 검사: - topics/2026/2026-09-25-area19-s8.md: 깨진 링크 ../b-common-information-and-environment-model/08-real-time-world-state-and-data-consistency.md
