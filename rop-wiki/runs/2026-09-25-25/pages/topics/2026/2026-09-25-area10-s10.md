...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-023, ref-031, ref-103, ref-163, ref-284, ref-286, ref-312, ref-313, ref-314, ref-316]
last_run: 2026-09-25
version: 1
...
- [12. 명령·작업 실행의 신뢰성](../../categories/c-connectivity-and-execution-foundation/12-command-and-task-execution-reliability.md) — 승강기 세션의 시작·종료와 어댑터를 거치지 않은 요청의 무효화는 제어권 관리 문제다. [사실][^ref-312][^ref-284]
- [3. 처리능력·거점·설비 계획](../../categories/a-business-supply-chain-design/03-capacity-site-and-facility-planning.md) — 승강기 대기가 층간 운반 처리량에 줄 영향을 설비 계획에서 봐야 한다(oq-010). [추정][^ref-312]
...
- [20. 예외 복구·재계획·업무 연속성](../../categories/e-collaboration-and-field-operations/20-exception-recovery-replanning-and-business-continuity.md) — 승강기 화재·비상 모드와 문 오프라인 상태는 복구 규칙의 입력이 될 것으로 보인다. [추정][^ref-286][^ref-313]
- [25. 안전·위험 관리](../../categories/g-safety-security-intelligence-and-governance/25-safety-and-risk-management.md) — 로봇 탑승 안전 요구사항(KS B 7317)은 안전 영역에서 다룬다. [사실][^ref-314]
...
- [28. 표준·상호운용성·다사업자 거버넌스](../../categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md) — 대한승강기협회의 승강기–로봇 연동 단체표준이 제정됐다고 보도됐다. [사실][^ref-316] 이 단체표준과 오픈소스 메시지의 대응은 열린 질문이다.
