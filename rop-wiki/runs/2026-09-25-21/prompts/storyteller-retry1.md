...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 4800,
      "summary": "LLM이 맡는 범위는 LLM 직접 배정, LLM 정식화와 결정적 해법, 도구·API 기반 명령 생성의 세 방식으로 정리된다는 것이 이 위키의 정리다. [추정][^ref-293][^ref-290][^ref-295] 로봇 운영 제품은 질의·설명에서 미션 실행으로 넓어지고 있다고 발표했다. [추정] 벤더 주장[^ref-301]",
      "planned_findings": [
        "f1",
        "f2",
        "f3",
    ...
    },
    {
      ...
      "budget_chars": 1400,
      "summary": "LLM 뒤에 선형계획·정수계획·MILP 해법을 붙인 연구가 여럿 있다. [사실][^ref-290][^ref-305] 제품의 미션 정의 방식과 실행 전 확인 장치는 미확인이다.",
      "planned_findings": [
        "f21",
        "f22",
        "f24"
    ...
    },
    {
      ...
      "budget_chars": 600,
      "summary": "단계 3으로 보내는 새 질문 q3-05(f10), q3-06(f8).",
      "planned_findings": [
        "f8",
        "f10"
      ]
    },
    {
      ...
      "budget_chars": 600,
      "summary": "두 완료 조건 모두 미충족·미승인, 다음 단계로 전환하지 않는다.",
      "planned_findings": []
    },
    {
      "path": "docs/tracks/nl-task-chatbot/stage-1-prior-work-and-products.md",
      "section": "7. 관련 세부영역",
      "budget_chars": 900,
      "summary": "13. 작업 배정 — MRTA, 27. AI·학습·적응과 모델 운영, 18. 사람–로봇 협업·운영 인터페이스에 반영 제안.",
      "planned_findings": []
    },
    {
      "path": "docs/tracks/nl-task-chatbot/task-model-draft.md",
      "section": "2. 개념 목록 표",
      "budget_chars": 600,
      "summary": "배정 개념에 속성 '배정 산출 방식'(LLM 직접 추론 / 최적화 해법)을 더하고 확정으로 바꾼다. [사실][^ref-293][^ref-290]",
      "planned_findings": [
        "f3",
        "f5",
        "f7",
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "초안 v0.1 → v0.2: 배정 개념에 속성 '배정 산출 방식' 추가·확정(f3·f5·f7·f8·f9), '규칙' 값은 6절 질문으로. H1 버전 표기를 바꿔야 해서 전체 content 로 보냄"
    },
    {
      "path": "docs/ideas/nl-task-chatbot.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "3절 갱신: LLM 담당 범위와 LLM·최적화 결합 선행 연구, 제품 사례 소절(공개 에이전트 프레임워크, 로봇 운영 제품 — 벤더 주장) 작성, q1-03 미조사 명시",
      "patches": [
        {
          "section": "3. 선행 연구·제품 사례",
          "action": "replace",
      ...
      "patches": [
        {
          ...
          "action": "replace",
          "content": "- [업무 분해·배정 설계 초안](task-model-draft.md) — 현재 버전 v0.2. 아이디어 정의에서 도출한 v0 개념 10개·관계 9개에 검증을 거친 개념 로봇 팀을 더했고(v0.1, 실행 2026-09-25-04), 배정 개념에 속성 '배정 산출 방식'을 더해 확정했다(v0.2, 실행 2026-09-25-21). 트랙 실행이 근거 finding과 함께 갱신한다.\n- [아이디어 2. 자연어 업무 지시 챗봇](../../ideas/nl-task-chatbot.md) — 확장 아이디어 페이지. 3~6절(선행 연구·제품 사례, 필요한 데이터와 표준, 구현 가설, 검증 방법)을 이 트랙의 단계 1·2·3·4·5 실행이 채운다. 3절은 선행 연구와 제품 사례(벤더 주장 수준)가 작성되었고, 채팅·음성 지시 제품의 확인·승인(q1-03)은 아직 조사되지 않았다.\n- [질문 백로그](question-backlog.md) — 최신 수치는 백로그 페이지의 자동 표를 따른다.\n- [트랙 로그](log.md) — 실행별 기록\n- [실험](experiments.md) — 제안된 실험 계획과 사용자 실험 결과 요약(선택). 현재 제안된 실험은 없다."
        }
      ]
    }
  ],
