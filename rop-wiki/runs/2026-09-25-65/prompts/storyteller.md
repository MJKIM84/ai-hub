...
```json
{
  ...
  "required_fixes": [
    ...
    "원문 미열람 표기: ref-079·ref-348·ref-413·ref-419·ref-461·ref-647·ref-648·ref-649·ref-650·ref-651·ref-652·ref-653·ref-654·ref-655·ref-656·ref-657·ref-658 의 각주 정의 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates 에 source_unopened: true 를 넣는다(ref-651 은 브리프 sources 기준 미열람으로 둔다).",
...
### docs/open-questions.md (요약: 대상 영역 [3, 5, 6, 8, 10, 15, 16, 21, 22, 23, 24, 27, 28] 에 걸린 59건 / 전체 93건)
