...
```json
{
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "update",
      "status": "needs_update",
      "diff_summary": "URL 을 퍼센트 인코딩 형태로 교정, 제명 변경 가능성을 [추정]·원문 미열람으로 병기, needs_update",
      "patches": [
        {
          "section": "각주 형식",
          "action": "replace",
    ...
    },
    {
      ...
      "action": "update",
      "status": "deprecated",
      "diff_summary": "ref-315 와 같은 보도자료를 가리키는 중복 항목으로 deprecated 처리, 대체 페이지 ref-315",
      "patches": [
        {
          "section": "각주 형식",
          "action": "replace",
  ...
  "changelog_entry": "2026-09-26 | 주간 정리 2026-W39 | 이번 주 실행 90회 정리, ref-637 URL 인코딩 교정·needs_update, ref-709 deprecated(대체 ref-315), 참고문헌 중복 후보 기록 | run 2026-09-26-01",
  "index_updates": {
  ...
  "reference_updates": [
    ...
    },
    {
      ...
      "title": "산업 디지털 전환 촉진법 (법률 제18692호)",
      "published": "2022-01-04",
      "url": "https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EC%82%B0%EC%97%85%EB%94%94%EC%A7%80%ED%84%B8%EC%A0%84%ED%99%98%EC%B4%89%EC%A7%84%EB%B2%95/(18692,20220104)",
      "type": "정부·연구기관",
      "reliability": "medium",
      "accessed": "2026-09-26",
      "summary": "원문 미열람. 2022-01-04 공포된 산업 디지털 전환 촉진법 제정 법률 본문(국가법령정보센터). URL 을 퍼센트 인코딩 형태로 교정했고, 제명 변경 여부는 미확인이다.",
      "source_unopened": true,
      "cited_by": [
        "docs/logs/weekly/2026-W39.md",
  ...
  "additional_research_requests": [
    ...
    "참고문헌 페이지(docs/references/ref-637.md, ref-709.md)의 현재 H2 구성이 입력에 없어 '각주 형식' 절에 패치했다. 절 이름이 다르면 퍼블리셔 담당이 패치 위치를 확인해야 한다."
  ],
  "fixes_applied": [
    "docs/references/ref-637.md(f3·f4) — 각주 형식 절에서 URL 만 지시한 퍼센트 인코딩 형태로 바꿨다. 제목·법률 번호·발행일 2022-01-04 는 유지했고 status 는 needs_update 로 두었다. 제명 변경은 [추정]·원문 미열람으로만 적었고, 현행 판 링크 병기와 제목 교체는 하지 않았다. reference_updates 의 url 도 같은 값으로 냈다.",
    "docs/references/ref-709.md(f5) — status 를 deprecated 로 바꾸고 '> 대체 페이지: [ref-315](ref-315.md)' 줄을 두었다. 페이지는 지우지 않았고 ref-709 를 인용한 다른 페이지의 각주는 고치지 않았다.",
...
- docs/references/ref-709.md: deprecated 페이지는 replaced_by(대체 페이지 링크)가 필요하다
