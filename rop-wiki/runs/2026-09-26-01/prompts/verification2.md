      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-26-01/pages/references/ref-637.md 의 해당 절을 본다)"
        }
      ]
    },
    {
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-26-01/pages/references/ref-709.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/references/ref-637.md (1개 절)
    - docs/references/ref-709.md (1개 절)
```
