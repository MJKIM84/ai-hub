...
### runs/2026-09-25-38/verification.json
...
```json
{
  ...
  "claim_checks": [
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: data/source_texts/ref-031 2절 범위 제외 목록(외부 IT 시스템 등)과 일치. 번역 계층은 추론이라 [추정]이 적절하다. ref-125 원문 미열람(검색·기존 검증 주장 재인용). A. 업무·공급망 설계 페이지와 같은 각주로 맞춘다."
    },
    {
      "finding_id": "f2",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): A. 업무·공급망 설계 페이지의 검증된 주장과 같다. ref-129·ref-130·ref-111은 이번 실행에서 원문 미열람. 세 출처는 서로 다른 계층의 사례이며 교차 확인이 아니다."
    },
    {
      "finding_id": "f3",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): 12. 명령·작업 실행의 신뢰성 5절의 검증된 주장과 추론을 따른다. ref-365·ref-125·ref-367 원문 미열람. [추정] 유지."
    },
    {
      "finding_id": "f4",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): A. 업무·공급망 설계 페이지와 같다. 병원·호텔 사례이고 물류센터 적용은 미확인(oq-010). ref-060·ref-103 원문 미열람이라 결과 수치는 쓰지 않는다."
    },
    {
      "finding_id": "f5",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "검색 결과 일치(원문 미열람): KCI·DBpia·KoreaScience 모두 제목이 같다. 지적과 국토정보 53(1), 83-105쪽, 2023. 총점 176점, 28개 항목, 분야 중요도 순서가 스니펫과 일치한다. 브리프의 발행일 null은 2023으로 고친다. 대상은 공동주택이며 물류센터 대상이 아니다. '로봇 운영 조건으로 평가되고 있다'가 3. 처리능력·거점·설비 계획과 이어진다는 해석은 추론이다."
    },
    {
      "finding_id": "f6",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): 11. 분산 시스템·통신·컴퓨팅 구조 5절의 검증된 [추정]과 같다. ref-300·ref-310 원문 미열람. 물류센터 기준은 미확인(oq-038)."
    },
    {
      "finding_id": "f7",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): B. 공통 정보·환경 모델 페이지와 같다. ref-228·ref-105 이번 실행 원문 미열람. 서로 다른 인터페이스의 사례이다."
    },
    {
      "finding_id": "f8",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): B. 공통 정보·환경 모델 페이지와 같다. ref-153·ref-105 발행 주체가 같아 독립 교차가 아니다. 용어집 '지도 정합'에 연결한다."
    },
    {
      "finding_id": "f9",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): B. 공통 정보·환경 모델 페이지와 같다. 대응 규칙 표준은 미확인(oq-045). [추정] 유지."
    },
    {
      "finding_id": "f10",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): B. 공통 정보·환경 모델 페이지와 같다. ref-051은 단일 공식 파일이며 이번 실행에서 원문 미열람."
    },
    {
      "finding_id": "f11",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): B. 공통 정보·환경 모델 페이지와 같다. ref-285·ref-286·ref-284 원문 미열람. 오래됨 판정 규칙은 미확인(oq-034). 현재 상태 표현이므로 8. 실시간 세계 상태·데이터 일관성에 둔 것이 맞다."
    },
    {
      "finding_id": "f12",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: VDA 5050 last will은 source_texts/ref-031 4.1절과 일치한다. ref-282·ref-287은 재인용이며 원문 미열람. 세 출처가 각각 한 장치만 다룬다."
    },
    {
      "finding_id": "f13",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: source_texts/ref-004의 Traffic Schedule·Negotiation·Fleet Adapters 절과 일치한다. ref-004 원문은 'No Interface'를 포함한 4범주를 두며 그중 호환되는 것은 3개다. ref-251은 이번 실행에서 원문 미열람이며 같은 책이라 독립 교차가 아니다."
    },
    {
      "finding_id": "f14",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): A. 업무·공급망 설계 페이지와 같다. 단일 출처 ref-105이며 이번 실행 원문 미열람. 예시값 0.10은 템플릿 예시임을 밝힌다."
    },
    {
      "finding_id": "f15",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: VDA 5050 zoneRequests와 responses(GRANTED·QUEUED·REVOKED·REJECTED), releaseLossBehavior는 source_texts/ref-031 6.4.3절과 일치한다. ref-312는 재인용(원문 미열람). 끝 구절 '공용 자원으로 예약·배분하는 입력을 준다'는 추론이므로 문장을 나눠야 한다(수정 지시)."
    },
    {
      "finding_id": "f16",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: source_texts/ref-031 6.1.2절 'the base cannot be changed ... assume that the base has already been executed'. 재정렬 적용 범위는 추론이다. [추정] 유지."
    },
    {
      "finding_id": "f17",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: source_texts/ref-023 'Requests a IngestorRequest till receives a IngestorResult'와 일치한다. ref-049는 재인용(원문 미열람)이며 같은 발행 주체다. 화물 식별자 필드가 없다는 점은 oq-001·oq-042."
    },
    {
      "finding_id": "f18",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: NO_ROUTE_TO_TARGET은 source_texts/ref-031 6.1.4.8절에 있다. ref-148은 재인용(원문 미열람). 공통 예외 매핑은 추론이다(oq-033). [추정] 유지."
    },
    {
      "finding_id": "f19",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): 12. 명령·작업 실행의 신뢰성 3절과 같다. ref-374 원문 미열람. 현재 배포판 반영 여부는 미확인(oq-048)."
    },
    {
      "finding_id": "f20",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: source_texts/ref-031 4.1절 'keeps all the order information and fulfills the order up to the last released node'와 일치한다. 단일 공식 명세."
    },
    {
      "finding_id": "f21",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): 12. 명령·작업 실행의 신뢰성 10절의 검증된 [추정]과 같다. ref-111 원문 미열람. 교차 규칙상 AI 기반 장애 분석이 아니므로 27. AI·학습·적응과 모델 운영과 연결하지 않아도 된다."
    },
    {
      "finding_id": "f22",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: config.yaml 필드와 튜토리얼 좌표 변환은 검증된 재인용이다(ref-105·ref-153 원문 미열람). 온보딩 소요는 측정 자료가 없어 [추정]이 적절하다. 용어집 '지도 정합'·'플릿 어댑터'가 이미 21. 온보딩·설정·현장 시운전을 관련 영역으로 둔다."
    },
    {
      "finding_id": "f23",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: raw.githubusercontent.com의 simulation.md 원문을 열었다. building_map_generator의 문·승강기 자동 생성, 'lift_supervisor node ... to manage requests from different robot fleets', TeleportDispenser·TeleportIngestor, 'time and resource saving'이 있다. 발행일 미확인. 단일 출처."
    },
    {
      "finding_id": "f24",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: 두 README를 열었다. vda5050-sim은 'verified by a conformance test suite'(주문 수명주기·사전 정의 동작·교통 제어)와 fault_profile 고장 주입, MQTT·NATS를 적는다. vda5050-lab은 다섯 실패 유형을 진단한다. 개인 프로젝트의 자기 기술이며 VDA 공식 적합성 시험이 아니다. 'README에 적는다'는 형식으로만 [사실]을 유지한다."
    },
    {
      "finding_id": "f25",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: node_lifecycle.md 원문을 열었다. 4개 주 상태와 전이가 있고 'allow roslaunch to ensure that all components have been instantiated correctly before it allows any component to begin'이 있다. 원문의 전이에는 create·destroy도 포함된다. 용어집 '관리형 노드'가 이미 12. 명령·작업 실행의 신뢰성·24. 자산·소프트웨어 수명주기 관리와 연결돼 있다."
    },
    {
      "finding_id": "f26",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인(재인용): 10. 설비·건물 시스템 연동 페이지의 검증된 주장과 같다(KS B 7317, 2021-11). ref-314·ref-315는 원문 미열람이며 같은 기관 계열이라 독립 교차가 아니다. 설비 안전 제어는 분류 원문 9장의 연계 대상이므로 ROP는 상태 확인 범위로만 서술해야 한다(수정 지시)."
    },
    {
      "finding_id": "f27",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: source_texts/ref-009에 Authentication·Access control(governance·permissions 파일)·Cryptographic 플러그인이 있다. security.md 원문을 열었다: 'An enclave is a process or group of processes that will share the same identity and access control rules', 대시보드 TLS와 OpenID Connect(Keycloak). 같은 ROS 계열 문서라 독립 교차가 아니다."
    },
    {
      "finding_id": "f28",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: f27과 문·승강기 어댑터 경로를 결합한 추론이다. ref-283·ref-284 원문 미열람. oq-043과 관련되나 새 질문(SROS 2 인클레이브 단위)과는 겹치지 않는다. [추정] 유지."
    },
    {
      "finding_id": "f29",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "검색 결과 일치(원문 미열람): ISO 21423은 iso.org 86749 항목이 있고 여러 검색 결과가 ISO/DIS에서 ISO/FDIS(2026-05) 단계로 적는다. 발행 완료 여부는 미확인이므로 '표준이 있다'를 개발 단계 표기와 함께 쓰게 한다(수정 지시). VDA 5050은 source_texts/ref-031로 확인했다. ref-253은 원문 미열람."
    },
    {
      "finding_id": "f30",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "확인: 두 README는 제3자 개인 프로젝트이다. VDA 공식 적합성 인증 절차가 없다는 점은 검색 1회 결과라 확정이 아니다. 거버넌스 과제로 넘어간다는 것은 추론이다. [추정] 유지."
    },
    {
      "finding_id": "f31",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "사실 → 추정: 근거가 기사 두 건(ref-316·ref-317, 발행일 미확인, 원문 미열람)뿐이고 1차 출처(단체표준 원문·협회 공지)를 확인하지 못했다. '전해진다'는 전언 서술이므로 [사실]로 둘 수 없다. 메시지 내용은 oq-041."
    }
  ],
  "category_fit": {
    "ok": true,
  ...
  "duplication": {
    "ok": true,
    "overlaps": [
      "f1·f2·f4·f14와 f17(인계 신호)은 A. 업무·공급망 설계 페이지 '다른 대분류와의 연결' 절에 같은 주장·같은 각주로 이미 있다. 반대 방향 서술로 재사용하고 새 각주를 만들지 않는다",
      "f7~f12는 B. 공통 정보·환경 모델 페이지 '다른 대분류와의 연결' 절의 C. 연결·실행 기반 항목과 같다. 같은 각주로 재사용한다",
      "f3·f16·f19·f21은 12. 명령·작업 실행의 신뢰성, f6·f20은 11. 분산 시스템·통신·컴퓨팅 구조, f13·f18은 9. 로봇·제조사 관제 연동, f15·f26은 10. 설비·건물 시스템 연동 게시 페이지의 검증된 주장을 재인용한 것이다"
    ]
  },
  "terminology": {
    "ok": true,
  ...
  "required_fixes": [
    "차등 갱신: 대분류 C. 연결·실행 기반 페이지는 '다른 대분류와의 연결' 절만 patches(action replace)로 바꾼다. 새 각주 정의는 '참고 자료' 절에 action append로 덧붙이고, 이미 있는 ref-004 정의는 다시 정의하지 않는다 — 대분류 연결 실행 규칙(부록 R-9)이며 각주 정의가 없으면 링크 검사가 실패한다.",
    "f31: [사실] → [추정]으로 강등하고 '기사 보도 기준, 단체표준 원문·발행일 미확인'을 병기한다 — 근거가 기사 두 건뿐이고 1차 출처를 확인하지 못했다.",
    "f5: 대상이 공동주택(아파트 단지)이며 물류센터 대상이 아님을 병기한다. 인증 모델의 구성(28개 항목, 총점 176점, 4개 분야)만 [사실]로 쓰고, 이것이 3. 처리능력·거점·설비 계획과 10. 설비·건물 시스템 연동·11. 분산 시스템·통신·컴퓨팅 구조를 잇는 근거가 된다는 해석은 별도 문장의 [추정]으로 둔다 — 원 finding의 연결 해석은 출처에 없는 추론이다.",
    "ref-802 각주와 reference_updates: 발행일을 2023으로, 기관·제목에 '지적과 국토정보 53(1), 83-105'를 반영하고 접근일 뒤에 ' (원문 미열람)'을 붙인다 — 검색 결과(KCI·DBpia·KoreaScience)로 서지를 확인했다.",
    "f15: VDA 5050 해제 구역의 허가·대기·철회·거절 응답과 Open-RMF 승강기 세션 점유는 [사실]로 쓴다. 끝 구절 '승강기·구역을 공용 자원으로 예약·배분하는 입력을 준다'는 별도 문장의 [추정]으로 나눈다 — 출처는 16. 공용 자원·충전·에너지 최적화와의 관계를 말하지 않는다.",
    "f24: 'README에 적는다'는 자기 기술 형식을 유지하고, 두 도구가 개인 프로젝트이며 VDA·VDMA 공식 적합성 시험이 아니라는 점을 같은 문장이나 바로 뒤 문장에 병기한다 — 출처가 자기 기술뿐이다.",
    "f29: ISO 21423은 '개발 중인 국제표준(검색 결과상 FDIS 단계, 발행 여부 미확인)'으로 표기하고 각주 ref-159에 ' (원문 미열람)'을 붙인다 — 발행 완료를 확인하지 못했다.",
    "f26: KS B 7317과 승강기 운영 모드 문장 뒤에 'ROP는 운영 모드 확인과 작업·경로 제약 반영만 맡고 승강기 탑승 안전·설비 안전 제어 자체는 분류 원문 9장 시설·설비 제어 경계의 연계 대상'임을 적는다 — 범위 경계 규칙 4.",
    "f4: 병원·호텔 사례이며 물류센터 적용은 미확인(oq-010)이라고 적고, 승강기 제어 자체는 연계 대상이며 3. 처리능력·거점·설비 계획은 이를 제약 입력으로만 받는다고 쓴다(A. 업무·공급망 설계 페이지와 같은 문구) — 범위 경계와 적용 한계.",
    "f23: 시뮬레이션 세계 생성과 여러 플릿 요청 조율의 재현은 22. 시뮬레이션·예측용 디지털 트윈(가정한 미래 실험)으로, 배치 전 시험은 23. 시험·형식 검증·벤치마크로 나눠 서술한다. f11·f12(현재 상태 표현)의 8. 실시간 세계 상태·데이터 일관성과 섞지 않는다 — 공통 규칙 6.",
    "각주 원문 미열람 표기: 이번 실행에서 fetched=false인 출처(ref-049, ref-051, ref-060, ref-079, ref-103, ref-105, ref-111, ref-125, ref-129, ref-130, ref-148, ref-153, ref-159, ref-228, ref-251, ref-253, ref-282, ref-283, ref-284, ref-285, ref-286, ref-287, ref-300, ref-310, ref-312, ref-314, ref-315, ref-316, ref-317, ref-365, ref-367, ref-374, ref-802)의 각주 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates에 source_unopened: true를 넣는다. 원문을 연 ref-004, ref-009, ref-023, ref-031, ref-364, ref-798, ref-799, ref-800, ref-801에는 붙이지 않는다 — web_fetch_available: false 환경 규칙.",
    "A. 업무·공급망 설계·B. 공통 정보·환경 모델 페이지에 이미 실린 연결(f1, f2, f4, f7~f12, f14, f17)은 그 페이지와 같은 태그·같은 각주 id로 쓰고, 해당 대분류 페이지의 연결 절을 링크한다 — 중복·모순 방지.",
    "27. AI·학습·적응과 모델 운영과의 연결은 finding이 없으므로 '아직 다루지 않은 연결' 소절에 번호와 이름을 함께 적고 근거 부재를 밝힌다. 다른 대분류·세부영역도 모두 문자·번호와 이름을 함께 쓴다('D. 계획·최적화', '13. 작업 배정 — MRTA') — 공통 규칙 1과 부록 R-9.",
    "용어 링크: 기존 용어집 항목 '관리형 노드', '지도 정합', '승강기 어댑터', '해제 구역', '디스펜서·인제스터', '플릿 어댑터', 'DDS 보안 규격'을 첫 등장 시 링크한다. glossary_updates에는 '인클레이브(Enclave, SROS 2)'와 '적합성 시험(Conformance Test)'만 신규(create)로 넣는다 — 기존 용어와 뜻이 겹치지 않는다.",
    "직접 인용은 출처당 1회 짧은 구절만 쓴다(f20 ref-031, f27 ref-798 등). 나머지는 재서술한다 — 5.3 인용 규칙."
  ],
  "confidence": "medium",
  "verification_note": "판정: 1차 조건부 승인. 이번 실행은 원문 열람이 차단된 환경(mirror_only)에서 검증됐다. 확인 30건, 미확인 1건, 교차 확인 0건. 신규 출처 ref-798·ref-799·ref-800·ref-801·ref-364는 raw.githubusercontent.com으로, ref-004·ref-009·ref-023·ref-031은 입력 원문 텍스트로 대조했다. ref-802는 검색 결과로 서지를 확인했다(지적과 국토정보 53(1), 2023). 검증 검색 2회. 강등: f31 사실 → 추정(기사 두 건만 있고 1차 출처 미확인). 원문 미열람 출처: ref-049, ref-051, ref-060, ref-079, ref-103, ref-105, ref-111, ref-125, ref-129, ref-130, ref-148, ref-153, ref-159, ref-228, ref-251, ref-253, ref-282, ref-283, ref-284, ref-285, ref-286, ref-287, ref-300, ref-310, ref-312, ref-314, ref-315, ref-316, ref-317, ref-365, ref-367, ref-374, ref-802. 브리프 기록 불일치: ref-004·ref-023·ref-031은 fetched: true인데 요약이 '원문 미열람'으로 시작하고 fetch_url이 null이다(입력 원문 텍스트가 있어 열람으로 인정). ref-802는 발행일이 null로 적혀 있었다. 주의: 연결은 대부분 게시된 9. 로봇·제조사 관제 연동 ~ 12. 명령·작업 실행의 신뢰성 페이지와 A. 업무·공급망 설계·B. 공통 정보·환경 모델 페이지의 검증된 주장을 재인용했다. 연결 상대 D~G 대분류의 세부영역은 대부분 seed라서 상대편 서술도 C. 연결·실행 기반 쪽 근거에 기댄다. ISO 21423은 발행 여부가 확인되지 않은 FDIS 단계다. 적합성 시험 도구는 제3자 개인 프로젝트다. 27. AI·학습·적응과 모델 운영과의 연결은 근거가 없다. 정정 요청 없음.",
  "retry_reason": null
}
```

### runs/2026-09-25-38/pages.json
...
```json
{
  ...
  "outline": [
    {
      ...
      "section": "다른 대분류와의 연결",
      "budget_chars": 6500,
      "summary": "C. 연결·실행 기반은 A. 업무·공급망 설계의 작업 요청과 B. 공통 정보·환경 모델의 능력·좌표·상태 모델을 받아 로봇·설비 명령으로 옮기고, D. 계획·최적화에는 교통·충전·구역 입력을, E. 협업·현장 운영에는 오류·인계 결과·작업 기록을 넘긴다. [의견] F. 도입·검증·유지관리의 설정·시뮬레이션·적합성 시험·수명주기와 G. 안전·보안·지능·거버넌스의 안전·보안·표준 제약이 이 연결에 걸리며, 27. AI·학습·적응과 모델 운영과의 연결은 아직 근거가 없다. [의견]",
      "planned_findings": [
        "f1",
        "f2",
        "f3",
    ...
    },
    {
      ...
      "section": "참고 자료",
      "budget_chars": 0,
      "summary": "'다른 대분류와의 연결' 절에서 새로 쓴 각주 정의 41건을 덧붙인다(ref-004 는 기존 정의 유지)."
    }
  ],
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "'다른 대분류와의 연결' 절 신규 작성(A·B·D·E·F·G 대분류 연결 31건, 아직 다루지 않은 연결), 참고 자료 절에 각주 정의 41건 덧붙임",
      "patches": [
        {
          "section": "다른 대분류와의 연결",
          "action": "replace",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-38/pages/categories/c-connectivity-and-execution-foundation/index.md 의 해당 절을 본다)"
        },
        {
          "section": "참고 자료",
          "action": "append",
  ...
  "changelog_entry": "2026-09-25 | C. 연결·실행 기반 | 다른 대분류와의 연결 절 신규 작성(A·B·D·E·F·G 대분류 연결 31건, 27. AI·학습·적응과 모델 운영은 근거 없음), 조건부 승인 수정 15건 이행 | run 2026-09-25-38",
  "index_updates": {
    "home_recent": "2026-09-25 — C. 연결·실행 기반: 다른 대분류와의 연결 절 작성(작업 요청 번역·변경·취소, 능력·좌표·적재물·상태 모델, 교통·충전·구역 점유, 예외·인계, 시뮬레이션·적합성 시험·수명주기, 안전·보안·표준 제약)",
    "category_recent": "2026-09-25 — C. 연결·실행 기반: 다른 대분류와의 연결 절 신규 작성(A. 업무·공급망 설계부터 G. 안전·보안·지능·거버넌스까지 여섯 대분류, 27. AI·학습·적응과 모델 운영은 아직 다루지 않은 연결로 표시)"
  },
  "glossary_updates": [
    {
      "action": "new",
      ...
      "term_en": "Enclave (SROS 2)",
      "definition": "SROS 2 에서 같은 신원과 접근통제 규칙을 공유하는 프로세스 또는 프로세스 묶음으로, 보안 인증서·권한 파일을 이 단위로 발급·적용한다.",
      "description": "Open-RMF 문서는 SROS 2 키스토어의 인클레이브로 RMF 구성요소의 권한을 나눈다고 설명한다. 로봇 관제가 문·승강기 어댑터에 요청을 보내는 구조에서 설비 명령 권한을 제한하는 단위로 논의된다.",
      "related_areas": [
        26,
        11,
        10
    ...
    },
    {
      ...
      "term_en": "Conformance Test",
      "definition": "구현이 표준·명세가 정한 메시지 형식과 동작 규칙을 지키는지 정해진 시나리오로 확인하는 시험이다.",
      "description": "VDA 5050 3.0.0 에 대해서는 제3자 오픈소스 시뮬레이터(vda5050-sim)가 적합성 시험 묶음을 둔다고 README 에 적고 있으나, VDA·VDMA 공식 적합성 시험은 아니다.",
      "related_areas": [
        23,
        9,
        28
  ...
  "reference_updates": [
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "작업·교통 조율, Fleet Adapter, 설비 연동 구조. 이번 실행에서는 입력 원문 텍스트로 대조했다.",
      "source_unopened": false,
      "cited_by": [
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "디스펜서·인제스터 워크셀과 배송 작업의 요청–결과 방식. 이번 실행에서는 입력 원문 텍스트로 대조했다.",
      "source_unopened": false,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "VDA 5050 최신판(3.0.0) 명세 원문. 이번 실행에서는 입력 원문 텍스트로 대조했다.",
      "source_unopened": false,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 인제스터 결과 메시지(시각·요청 id·워크셀 id·상태).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. VDA 5050 상태 메시지 JSON 스키마(loads, localizationScore 등).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 차선·경유점·충전기·승강기·문·층 주석 도구.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 플릿 어댑터 설정(충전 임계값, 작업 능력, 동작, 기준 좌표).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 작업 상태 스키마(상태 값, 시각, 취소·강제 종료 기록).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 작업 요청 JSON 스키마.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. OPC UA for ISA-95 작업 제어 노드셋(작업 지시 메서드·데이터형).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 로봇 상태 스키마.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 플릿 어댑터 구현 튜토리얼(좌표 변환, 완료 확인 함수).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 산업용 이동로봇의 통신·상호운용성 국제표준. 검색 결과상 FDIS 단계이며 발행 여부 미확인.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. VDA 5050 팩트시트 JSON 스키마(적재 명세, 지원 동작).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 플릿 연동의 제어 수준(전체 제어·신호등·읽기 전용).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. MassRobotics AMR 상호운용 표준 저장소 README.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 문 어댑터·문 노드 연동.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 승강기 어댑터·승강기 노드 연동.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 문 상태 메시지(door_time 등).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 승강기 상태 메시지(층 이름, 운영 모드, lift_time).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Sparkplug 운영 동작(NDEATH 뒤 STALE 표시).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 클라우드–엣지 단절 중 엣지 자율 동작 구조.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 승강기 요청 메시지(세션, 요청 유형, 문 상태).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 파견 요청 스키마.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 멱등성 키 HTTP 헤더 초안.",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 업무용 건축물 대상 로봇 친화형 건축물 인증제도를 아파트 단지로 확장한 인증 모델(4개 분야 28개 항목, 총점 176점)을 제시한 논문(검색 결과 KCI·DBpia·KoreaScience 기준).",
      "source_unopened": true,
      "cited_by": [
        "docs/categories/c-connectivity-and-execution-foundation/index.md"
      ]
  ...
  "open_question_updates": [
    {
      "action": "new",
      "question": "VDA 5050 에 공식 적합성 시험·인증 절차가 있는가, 없다면 제3자 오픈소스 적합성 시험 도구의 결과를 새 로봇 연동 승인 기준으로 쓸 수 있는가?",
      "areas": [
        9,
        23,
        28
    ...
    {
      "action": "new",
      "question": "로봇 관제·플릿 어댑터·승강기·문 어댑터에 SROS 2 인클레이브와 권한 파일을 어떤 단위로 나눠 설비 명령 권한을 제한하는지 공개한 구성이나 사례가 있는가?",
      "areas": [
        10,
        26
      ],
...
### runs/2026-09-25-38/format_check.md
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/categories/c-connectivity-and-execution-foundation/index.md (2개 절)
```

### runs/2026-09-25-38/pages/categories/c-connectivity-and-execution-foundation/index.md
...
updated: 2026-09-25
version: 2
sources: [ref-004, ref-009, ref-023, ref-031, ref-049, ref-051, ref-060, ref-079, ref-103, ref-105, ref-111, ref-125, ref-129, ref-130, ref-148, ref-153, ref-159, ref-228, ref-251, ref-253, ref-282, ref-283, ref-284, ref-285, ref-286, ref-287, ref-300, ref-310, ref-312, ref-314, ref-315, ref-316, ref-317, ref-364, ref-365, ref-367, ref-374, ref-798, ref-799, ref-800, ref-801, ref-802]
---
...
- **10. 설비·건물 시스템 연동·11. 분산 시스템·통신·컴퓨팅 구조 ↔ 3. 처리능력·거점·설비 계획**: 국내에서 업무용 건축물 대상 로봇 친화형 건축물 인증을 아파트 단지로 확장한 인증 모델은 건축·시설 설계, 네트워크·시스템, 건축 운영 관리, 로봇 지원 4개 분야의 28개 항목(총점 176점)으로 구성된다(2023년 발행). [사실][^ref-802] 이 모델의 대상은 공동주택(아파트 단지)이며 물류센터가 아니다. 건물 설비와 통신 기반을 로봇 운영 조건으로 평가하는 이런 틀이 거점·설비 계획과 설비·통신 연동을 잇는 근거가 될 수 있다. [추정][^ref-802]
...
- **10. 설비·건물 시스템 연동 ↔ [22. 시뮬레이션·예측용 디지털 트윈](../f-deployment-verification-and-maintenance/22-simulation-and-predictive-digital-twin.md)**: Open-RMF 문서는 traffic-editor 로 주석한 지도에서 문·승강기·워크셀(TeleportDispenser·TeleportIngestor)을 포함한 시뮬레이션 세계를 생성하고, 여러 플릿의 승강기 요청을 조율하는 lift_supervisor 까지 재현하는 흐름을 제시한다. [사실][^ref-799] 이는 가정한 운영 상황을 가상으로 실험하는 쪽이며, 현재 상태를 표현하는 8. 실시간 세계 상태·데이터 일관성의 문·승강기 상태 메시지와는 구분한다.
- **10. 설비·건물 시스템 연동 ↔ [23. 시험·형식 검증·벤치마크](../f-deployment-verification-and-maintenance/23-testing-formal-verification-and-benchmarking.md)**: 같은 문서는 이렇게 만든 시뮬레이션으로 배치 전에 설비 연동을 시험해 시간과 자원을 아낄 수 있다고 설명한다. [사실][^ref-799]
- **9. 로봇·제조사 관제 연동·12. 명령·작업 실행의 신뢰성 ↔ 23. 시험·형식 검증·벤치마크**: 공개 오픈소스 가운데 VDA 5050 3.0.0 로봇 플릿 시뮬레이터(vda5050-sim)는 주문 수명주기·사전 정의 동작·교통 제어 의미를 명세와 대조하는 적합성 시험 묶음과 고장 주입을 둔다고, MQTT 기록 진단 도구(vda5050-lab)는 반복된 주문·갱신 id, 기반·호라이즌 연결, 재연결 뒤 연결 상태, 취소·동작 수명주기 불일치를 진단한다고 각각 README 에 적는다. [사실][^ref-800][^ref-801] 두 도구는 개인 프로젝트의 자기 기술이며 VDA·VDMA 공식 적합성 시험이 아니다.
...
- **11. 분산 시스템·통신·컴퓨팅 구조·9. 로봇·제조사 관제 연동 ↔ [26. 사이버보안·접근권한·개인정보](../g-safety-security-intelligence-and-governance/26-cybersecurity-access-control-and-privacy.md)**: ROS 2 는 [DDS 보안 규격](../../glossary/dds-security.md)의 인증(PKI)·접근통제(거버넌스·권한 파일)·암호화 플러그인을 쓴다. Open-RMF 문서는 같은 신원과 접근통제 규칙을 공유하는 프로세스 묶음인 SROS 2 인클레이브로 RMF 구성요소의 권한을 나누고, 웹 대시보드에는 TLS·OIDC 인증을 더한다고 설명한다. [사실][^ref-009][^ref-798]
- **10. 설비·건물 시스템 연동 ↔ 26. 사이버보안·접근권한·개인정보**: 로봇 관제가 문·승강기 어댑터에 요청을 보내는 구조에서는 어느 관제 구성요소가 어떤 설비 명령을 낼 수 있는지를 인클레이브·권한 파일 같은 접근통제 단위로 정해야 할 것으로 보인다. [추정][^ref-798][^ref-283][^ref-284] 출입통제 시스템 연동 사례는 미확인이다(oq-043).
...
- **9. 로봇·제조사 관제 연동 ↔ 28. 표준·상호운용성·다사업자 거버넌스**: 이번에 확인한 VDA 5050 적합성 시험 도구가 제3자 오픈소스뿐이라, 어느 시험 결과를 연동 승인 기준으로 삼고 누가 연동 오류를 판정할지가 거버넌스 과제로 넘어갈 것으로 보인다. [추정][^ref-800][^ref-801][^ref-031] VDA 공식 적합성 인증 절차가 없다는 것은 확정된 사실이 아니다.
...
[^ref-798]: Open Robotics, Security - Programming Multiple Robots with ROS 2, 미확인, https://osrf.github.io/ros2multirobotbook/security.html, 접근일 2026-09-25
[^ref-799]: Open Robotics, Simulation - Programming Multiple Robots with ROS 2, 미확인, https://osrf.github.io/ros2multirobotbook/simulation.html, 접근일 2026-09-25
[^ref-800]: gpue (GitHub), vda5050-sim — README (Standards-compliant VDA5050 (v3.0.0) robot fleet simulator — MQTT or NATS), 미확인, https://github.com/gpue/vda5050-sim, 접근일 2026-09-25
[^ref-801]: ekusiadadus (GitHub), vda5050-lab — README (Diagnose VDA 5050 order, reconnect, and cancel failures from MQTT traces), 미확인, https://github.com/ekusiadadus/vda5050-lab, 접근일 2026-09-25
[^ref-802]: 한국 학술지 게재 논문(지적과 국토정보 53(1), 83-105, 저자 미확인), 아파트 단지의 로봇 친화형 환경 인증 모델 개발 (지적과 국토정보 53(1), 83-105), 2023, https://www.kci.go.kr/kciportal/landing/article.kci?arti_id=ART002978381, 접근일 2026-09-25 (원문 미열람)
````
...
### runs/2026-09-25-38/docs_tree.txt
