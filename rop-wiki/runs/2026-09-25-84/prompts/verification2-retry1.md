...
```json
{
  ...
  "outline": [
    ...
    {
      "path": "docs/ideas/floorplan-recognition.md",
      "section": "6. 검증 방법 (절 전체 교체: 가설 판정 절차 소절 추가, q5-03 미조사 구절 정정)",
      "budget_chars": 1500,
      "summary": "근거 확실성 평가와 판정 값 규칙, TRL 보조 축, 잠정 판정, 필요 실험을 요약하고 기존 소절의 q5-03 미조사 구절을 새 소절 안내로 고친다. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f1",
        "f3",
        "f4",
  ...
  "pages": [
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-84/pages/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md 의 해당 절을 본다)"
        },
        {
          "section": "3. 조사 결과",
          "action": "append",
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-84/pages/tracks/floorplan-recognition/index.md 의 해당 절을 본다)"
        },
        {
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "6절 전체 교체: '가설 판정 절차 (q5-03)' 소절 추가(근거 확실성 평가, 판정 값 규칙과 TRL 보조 축, 잠정 판정, 필요 실험), 절 안내 문장에 q5-03 소절 안내 추가, 기존 두 소절의 'q5-03 아직 조사하지 않았다' 구절을 새 소절 안내로 정정(2차 수정), 각주 4건 추가",
      "patches": [
        {
          "section": "6. 검증 방법",
          "action": "replace",
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-84/pages/ideas/floorplan-recognition.md 의 해당 절을 본다)"
        }
      ]
    },
    {
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-84/pages/tracks/floorplan-recognition/experiments.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
  ...
  "track_updates": {
    ...
    "overview_progress": "단계 5 진행 중 — 열린 질문 11, 답함 3, 완료 조건 충족, 단계 전환·트랙 done 전환 미승인"
  },
...
### runs/2026-09-25-84/format_check.md
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md (8개 절)
    - docs/tracks/floorplan-recognition/index.md (3개 절)
    - docs/ideas/floorplan-recognition.md (1개 절)
    - docs/tracks/floorplan-recognition/experiments.md (1개 절)
```
