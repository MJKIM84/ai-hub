...
- run_id: 2026-09-25-84
- date: 2026-09-25
- run_type: track (트랙 실행)
- 대상: 트랙 floorplan-recognition (건축 도면 자동 인식) · 현재 단계: 단계 5. 검증 방법과 가설 판정 · 이번에 다룰 백로그 질문 id: q5-03 · 중심 세부영역: 6. 지도·공간·위치 모델 (B. 공통 정보·환경 모델)
- 예산:
...
### runs/2026-09-25-84/target.json
...
```json
{
  ...
  "selection_rationale": "CLI 지정 run_type=track, area=6; 트랙 실행일(Fri, track_days 앞 3개) → 트랙 floorplan-recognition 단계 5, 질문 q5-03 (CLI 지정 질문 id)"
}
```

### runs/2026-09-25-84/research.json
...
```json
{
  ...
  "research_questions": [
    ...
    "여러 출처의 근거를 모아 결론의 확실성을 등급으로 매기는 체계(GRADE, 소프트웨어 공학의 근거 강도 평가)는 어떤 요소로 확실성을 낮추거나 올리는가? (단계 5 페이지 3절, 23. 시험·형식 검증·벤치마크 겨냥)",
    "기술 성숙도(TRL, 국내 기술성숙도평가 업무지침)는 실험실 검증과 관련 환경 시연을 어떻게 구분하며, 가설 판정의 보조 축으로 쓸 수 있는가? (한국 자료 우선 규칙)",
    "단계 1~4 에서 확인한 근거는 가설 1(인식으로 초안 생성)·가설 2(능력 대조)·가설 3(시간 단축·시뮬레이션 초기값)의 하위 주장별로 무엇을 뒷받침하고 무엇이 비는가? (트랙 개요 3절 겨냥)",
    "물류센터 조건에서 도면 기반 지도 생성의 시간 단축이나 인식 성능을 직접 잰 새 연구·국내 사례가 있는가? (가설 판정의 직접 근거 여부)"
  ],
  "findings": [
    {
      "id": "f1",
      "claim": "GRADE 접근법은 근거 묶음의 확실성을 결과(outcome)별로 높음·중간·낮음·매우 낮음 네 수준으로 매기고, 비뚤림 위험·비일관성·비직접성·비정밀성·출판 비뚤림 다섯 영역으로 확실성을 낮춘다.",
      "tag": "사실",
      "source_ids": [
        "ref-807"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "Cochrane Handbook 14장 검색 요약: 확실성은 다섯 영역(risk of bias, inconsistency, indirectness, imprecision, publication bias)을 고려해 결정되고 high/moderate/low/very low 로 분류된다. (발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
    ...
    {
      "id": "f2",
      "claim": "Dybå·Dingsøyr(ESEM 2008)는 소프트웨어 공학 체계적 문헌고찰에 근거 강도 평가를 처음 적용한 연구로, GRADE(2004판)를 풀어 설명하고 질적·관찰 연구를 함께 다루는 근거 강도 등급 체계를 검토했다.",
      "tag": "사실",
      "source_ids": [
        "ref-808"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: ESEM 2008, 178–187쪽. 체계적 문헌고찰은 근거한 증거만큼만 좋다는 원칙 아래 1차 연구 질 평가와 근거 묶음 강도 등급 체계를 개관했다.",
      "as_of": "2008",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f3",
      "claim": "NASA 의 기술 준비 수준(TRL) 정의는 TRL 5 를 관련 환경에서의 구성품·하위 시스템 검증, TRL 6 을 관련 환경의 종단간 시제품 시연으로 두어 실험실 규모와 공학 규모 검증을 구분한다.",
      "tag": "사실",
      "source_ids": [
        "ref-809"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: TRL 5 는 대표 환경에서 시제품을 철저히 시험, TRL 6 은 관련 종단간 환경에서 시스템·하위 시스템 모델 또는 시제품 시연. (발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f4",
      "claim": "방위사업청 '기술성숙도평가(TRA) 업무지침'은 기술성숙도(TRL)를 기술이 실제 적용에 얼마나 준비되었는지를 확인하는 정량 수준으로, 기술성숙도평가를 핵심기술요소의 성숙도를 정량 평가하는 공식 절차로 정의하며 TRL 6 이면 체계개발 진입이 가능하다고 본다.",
      "tag": "사실",
      "source_ids": [
        "ref-810"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "검색 요약: 핵심기술요소(CTE)의 성숙도를 정량 평가하는 공식 절차; TRL 6 평가 시 체계개발 진입 가능. 2021-07-23 방위사업청 훈령 제725호 제정 기준(스니펫). (발행일 미확인, 확인일 기준)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f5",
      "claim": "CubiCasa5K 는 래스터 평면도 5,000장에 방·창문·문 등 아이콘과 벽·난간·계단을 주석한 데이터셋이며, 엘리베이터 범주는 확인되지 않았다.",
      "tag": "사실",
      "source_ids": [
        "ref-063"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "5,000장, 80여 범주, 계단 있음·엘리베이터 미확인(주거 평면도). 가설 1 의 벽·문·계단 인식 하위 주장 근거. (재인용: 2026-09-25-05)",
      "as_of": "2019-04",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f6",
      "claim": "공개 평면도 데이터셋 가운데 엘리베이터 범주는 FloorPlanCAD 의 제3자 데이터셋 카드에서만 확인되어, 래스터·벡터 인식으로 엘리베이터를 추출할 수 있다는 근거는 약한 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-068",
        "ref-063"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "FloorPlanCAD 엘리베이터·에스컬레이터 범주는 Voxel51 카드(제3자) 검색 요약 기준. (재인용: 2026-09-25-05)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f7",
      "claim": "IFC 4.3(개발 브랜치 기준)은 엘리베이터를 운송 요소 유형 값 ELEVATOR 로, 문·계단을 IfcDoor·IfcStair 로 담아 BIM 입력에서는 이 요소들이 인식 없이 유형 객체로 주어질 수 있다.",
      "tag": "사실",
      "source_ids": [
        "ref-421",
        "ref-213"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "IfcTransportElementTypeEnum 에 ELEVATOR, IfcTransportElement 는 엘리베이터·에스컬레이터·무빙워크를 예로 듦(같은 발행 주체). (재인용: 2026-09-25-36)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f8",
      "claim": "IFC 4.3 의 콘센트 유형 열거와 전기기기 유형 열거에는 로봇·차량 충전 설비 값이 없어, 충전 위치는 BIM 표준 유형으로 도면에 담기지 않는 것으로 확인된다.",
      "tag": "사실",
      "source_ids": [
        "ref-214",
        "ref-215"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "IfcOutletTypeEnum·IfcElectricApplianceTypeEnum 에 충전 설비 값 없음, USERDEFINED·NOTDEFINED 만(같은 발행 주체라 독립 교차 확인 아님). (재인용: 2026-09-25-19)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f9",
      "claim": "Open-RMF traffic-editor 에서는 충전소·주차 위치·도킹 이름·작업셀 이름 같은 운영 요소를 사람이 경유점 속성으로 입력한다.",
      "tag": "사실",
      "source_ids": [
        "ref-079"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "경유점 속성 is_charger, is_parking_spot, dock_name, 디스펜서·인제스터 이름을 편집기에서 사람이 입력. (재인용: 2026-09-25-19)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f10",
      "claim": "이전 실행들의 검색 범위에서 물류센터·창고 평면도나 충전 위치를 라벨로 담은 공개 인식 데이터셋은 찾지 못해, 가설 1 의 근거는 주거·상업 평면도에 대한 간접 근거에 머무는 것으로 보인다(부재 확인 아님).",
      "tag": "추정",
      "source_ids": [
        "ref-063",
        "ref-073",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "CubiCasa5K·ArchCAD-400K·AI Hub 건축 도면 데이터 모두 물류 시설·충전 위치 라벨 미확인. (재인용: 2026-09-25-05)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f11",
      "claim": "능력 기술 서브모델 IDTA 02020(1.0)은 요구 능력과 제공 능력을 모델링해 비교하게 하고 속성 제약을 전제조건으로 쓸 수 있게 하여, 공간 통과 조건과 로봇 능력을 같은 틀로 대조할 표현 수단이 존재한다.",
      "tag": "사실",
      "source_ids": [
        "ref-229"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "요구·제공 능력 모델링과 속성 제약 비교. 가설 2 의 표현 가능성 하위 주장 근거. (재인용: 2026-09-25-65)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f12",
      "claim": "VDA 5050 팩트시트 스키마와 Open-RMF 플릿 어댑터 템플릿 설정은 속도·크기·배터리 같은 파라미터는 두지만 계단·문·승강기 이용 능력 필드는 두지 않아, 가설 2 의 대조에 쓸 로봇 쪽 능력 값이 관제 인터페이스에서 오지 않는다.",
      "tag": "사실",
      "source_ids": [
        "ref-228",
        "ref-105"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "팩트시트 physicalParameters·typeSpecification, 템플릿 속도·차체 반경·배터리 — 계단·문·승강기 능력 필드 없음. (재인용: 2026-09-25-65)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": "수행 자원",
      "source_unopened": true
    ...
    {
      "id": "f13",
      "claim": "IFC 4.3.2 의 문 공통 속성 세트는 자동 구동 여부·장애인 접근 가능을, 계단 공통 속성 세트는 단 높이·디딤판 길이·단 수를 두어 공간 쪽 통과 조건 값은 BIM 에서 얻을 수 있다.",
      "tag": "사실",
      "source_ids": [
        "ref-573",
        "ref-574"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "Pset_DoorCommon.HasDrive·HandicapAccessible, Pset_StairCommon.RiserHeight·TreadLength·NumberOfRiser(공식 문서 검색 요약 기준). (재인용: 2026-09-25-65)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f14",
      "claim": "연계 대상: Open-RMF 에서 문 여닫기는 로봇이 아니라 문 어댑터가 처리하므로, 문 통과 가능 여부는 로봇 능력만이 아니라 설비 연동 여부에도 달려 가설 2 의 대조 규칙이 선택 조건을 가져야 한다.",
      "tag": "사실",
      "source_ids": [
        "ref-283"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "문 어댑터가 DoorRequest 를 받아 진행 중인 로봇 작업을 방해하지 않을 때만 문 노드에 지시. (재인용: 2026-09-25-65)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f15",
      "claim": "Opiela·Hrehová(IPIN-WiP 2023)는 평면도 지도 모델 주석에서 숙련자 수작업 40분 대비 자동 주석 뒤 수정 5분을 보고했으나, 지도 1건의 저자 보고이고 물류 로봇 설정 작업이 아니다.",
      "tag": "추정",
      "source_ids": [
        "ref-794"
      ],
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "IPIN 2019 대회 지도 1건, 자동 처리 시간 포함 여부 미확인, 이전 검증 재검색에서 수치 미재확인. (재인용: 2026-09-25-82)",
      "as_of": "2023",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f16",
      "claim": "EU CORDIS 기사는 PAN-Robots 시스템이 AGV 설치 기간을 6개월에서 2개월로 줄일 수 있다고 전하나, 과제 측 보고값이며 비교 조건은 확인되지 않았다.",
      "tag": "추정",
      "source_ids": [
        "ref-265"
      ],
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "과제 측 보고값, 비교 조건·측정 방법 미확인(q5-04 열림). (발행일 미확인, 확인일 기준) (재인용: 2026-09-25-22)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f17",
      "claim": "OTTO Motors 는 소프트웨어 2.28 판에서 시설 지도·작업 흐름 설정 시간이 내부 시험으로 50% 줄었다고 밝힌다.",
      "tag": "추정",
      "source_ids": [
        "ref-271"
      ],
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "벤더 주장: 내부 시험, 측정 조건 미공개. 가설 3 판정 근거로 쓰지 않는 사례. (재인용: 2026-09-25-22)",
      "as_of": "2023",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true,
    ...
    {
      "id": "f18",
      "claim": "Open-RMF building_map_generator 는 사람이 주석한 건물 파일에서 주행 그래프와 함께 바닥·벽·문·승강기를 담은 시뮬레이션 월드를 만들어, 도면 기반 결과를 시뮬레이션 초기값으로 옮기는 경로가 존재한다.",
      "tag": "사실",
      "source_ids": [
        "ref-441",
        "ref-406"
      ...
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": ".building.yaml → 주행 그래프 파일과 Gazebo 월드 생성(같은 Open Robotics 자료라 독립 교차 확인 아님). (재인용: 2026-09-25-70)",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f19",
      "claim": "IFAC 2024 논문은 운영 결정용 시뮬레이션 기반 디지털 트윈을 실제 부하 상태로 초기화하면 빈 상태 기준 모델보다 과도 구간이 크게 줄어든다고 보고해, 도면 기반 정적 초기값만으로는 운영 예측용 초기값이 되지 않음을 시사한다.",
      "tag": "사실",
      "source_ids": [
        "ref-632"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "SAP EWM 배송 센터 예, 저자 미확인. (재인용: 2026-09-25-70)",
      "as_of": "2024",
      "flow_step": null,
      "flow_item": "시작 조건",
      "source_unopened": true
    ...
    {
      "id": "f20",
      "claim": "연계 대상: BIM 에서 만든 점유 격자 지도는 구조 요소만 담아 가구·설계–시공 편차가 위치추정 정확도를 떨어뜨린다고 보고되어, 도면 기반 지도가 현장 운영 지도로 바로 쓰이지 않는다는 반대 방향 근거가 된다.",
      "tag": "사실",
      "source_ids": [
        "ref-081"
      ],
      "cross_checked": false,
      "confidence": "medium",
      "evidence_excerpt": "BIM 이 현실을 정확히 나타낸다는 가정이 가구·설계–시공 편차로 성립하지 않음. (재인용: 2026-09-25-70)",
      "as_of": "2023-08",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f21",
      "claim": "q5-03 에 대해 확인한 근거 평가 체계를 이 위키가 묶으면, 가설 판정은 각 가설을 하위 주장으로 나누고 하위 주장마다 근거의 확실성을 GRADE 식 영역(비직접성: 주거·사무 건물 대 물류센터, 비정밀성: 단일 출처·표본 1건, 비뚤림: 저자·과제·벤더 보고)으로 낮춰 매긴 뒤 판정 값으로 모으는 절차가 근거가 가장 많은 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-807",
        "ref-808"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "GRADE 다섯 영역과 네 수준(f1), 소프트웨어 공학의 근거 강도 평가 적용(f2)을 가설 판정에 옮긴 이 위키의 종합이다. 가설 판정 규칙을 직접 정한 출처는 없다.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f22",
      "claim": "판정 값 규칙은 지지(핵심 하위 주장 모두 물류 조건의 직접 근거가 있고 확실성 중간 이상), 부분 지지(일부 하위 주장만 근거가 있거나 빠지는 부분이 확인됨), 기각(핵심 하위 주장에 직접 반대 근거), 미판정(핵심 하위 주장에 직접 근거 없음)으로 두고, 기술 성숙도 수준(실험실 대 관련 환경 시연)을 보조 축으로 병기하는 방식이 가능해 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-807",
        "ref-809",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "판정 값 네 가지는 트랙 개요 3절 정의, 확실성 수준은 GRADE(f1), 실험실·관련 환경 구분은 TRL(f3·f4)에서 가져온 이 위키의 설계 제안.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f23",
      "claim": "위 규칙을 단계 1~4 결과에 적용하면 가설 1 은 벽·문·계단 인식 근거와 BIM 의 엘리베이터 유형은 있으나 충전 위치·운영 요소는 도면에 담기지 않고 근거가 주거 평면도 중심이어서 잠정 '부분 지지'(확실성 낮음)로 보이며, 빠지는 것은 충전 위치·작업 스테이션·주행 차선·도면–현장 편차로 정리된다.",
      "tag": "추정",
      "source_ids": [
        "ref-063",
        "ref-068",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "f5~f10·f20 을 종합한 잠정 판정. 최종 판정은 검증 에이전트 몫이며 물류 도면에 대한 q5-01 지표 측정 전이다.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f24",
      "claim": "가설 2 는 요구–제공 능력 비교의 표현 수단과 BIM 쪽 통과 조건 값은 확인되지만 로봇 쪽 능력 값이 관제 인터페이스에 없고 대조 판정의 정확도를 잰 근거가 없어, 잠정 '부분 지지'(표현 가능성만 확인, 확실성 낮음)로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-229",
        "ref-228",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "f11~f14 를 종합한 잠정 판정. 통행 가능 판정의 오판 측정(q5-05)과 능력 값 획득(q3-10)이 열려 있다.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f25",
      "claim": "가설 3 은 시간 단축 근거가 물류 로봇 설정이 아닌 주석 1건의 저자 보고·과제 보고·벤더 주장뿐이고, 시뮬레이션 초기값은 월드 생성 경로만 있고 예측 정확도를 비교한 근거가 없어 '미판정'으로 두고 사용자 실험이 필요한 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-794",
        "ref-265",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "f15~f19 를 종합한 잠정 판정. 벤더 수치(f17)는 판정 근거로 쓰지 않는다. 비교 실험(q5-12)·시뮬레이션 예측 비교(q5-06) 열림.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f26",
      "claim": "판정을 미판정·부분 지지에서 옮기려면 물류센터 도면으로 q5-01 의 세 층 지표를 재는 인식 실험(가설 1), 능력 대조 판정과 실제 주행 결과를 비교하는 통행 실험(가설 2), 수작업 대 자동 생성+보정의 두 조건 모델링 시간 실험과 시뮬레이션 예측 대 현장 측정 비교(가설 3)가 사용자 실험 계획으로 필요할 것으로 보인다.",
      "tag": "추정",
      "source_ids": [
        "ref-809",
        "ref-807"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "관련 환경 시연(TRL 5·6, f3)과 비직접성 해소(f1) 논리로 도출한 실험 후보. 실험 계획 작성은 스토리텔러 몫이다.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
    ...
    {
      "id": "f27",
      "claim": "‘3층 출하 대기장’ 사례로 보면 가설 1 은 대기장 구역·승강기를 도면에서 얻는지, 가설 2 는 승강기 엣지를 포함한 경로가 각 제조사 로봇의 통행 가능 부분 그래프 안에 있는지, 가설 3 은 도면 수신부터 첫 도착 인정까지의 설정 시간이 줄었는지로 각각 판정 항목이 나뉠 수 있어 보인다(설명용 가정 사례).",
      "tag": "추정",
      "source_ids": [
        "ref-079",
        "ref-229",
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "분류 원문 질문의 장소를 가설별 판정 항목으로 옮긴 이 위키의 예시. 실제 측정값 없음.",
      "as_of": "2026-09-25",
      "flow_step": "출하",
      "flow_item": "예외·성과",
      "source_unopened": true
    ...
    {
      "id": "f28",
      "claim": "이번 검색 범위(한국어 2회 포함 8회)에서는 물류센터에서 도면 기반 지도 생성의 인식 성능이나 시운전 시간 단축을 직접 잰 새 연구·국내 사례를 찾지 못해, 세 가설 모두 물류 조건의 직접 근거가 비어 있는 것으로 보인다(부재 확인 아님).",
      "tag": "추정",
      "source_ids": [
        "ref-217",
        "ref-794"
      ...
      "cross_checked": false,
      "confidence": "low",
      "evidence_excerpt": "검색 결과는 CAD→osmAG 연구(기존 ref-083 계열)·일반 물류 자동화 기사·벤더 소개뿐. 기존 근거 Beinschob 외는 설치 병목을 반자동화했으나 시간 비교 수치 미확인.",
      "as_of": "2026-09-25",
      "flow_step": null,
      "flow_item": null,
      "source_unopened": true
  ...
  "sources": [
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Cochrane 핸드북의 GRADE 확실성 평가 장. 다섯 영역으로 근거 확실성을 낮추고 네 수준으로 매긴다(검색 요약 기준).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    ...
    {
      "id": "ref-808",
      "org": "Dybå, T., & Dingsøyr, T. (ESEM 2008)",
      "title": "Strength of evidence in systematic reviews in software engineering",
      "published": "2008",
      "url": "https://dl.acm.org/doi/10.1145/1414004.1414034",
      "type": "논문",
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 소프트웨어 공학 체계적 문헌고찰의 근거 강도 평가 체계(GRADE 2004 포함)를 개관한 ESEM 2008 논문.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. NASA 기술 준비 수준 1~9 정의. TRL 5 관련 환경 검증, TRL 6 관련 종단간 환경 시연(검색 요약 기준).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      "id": "ref-810",
      "org": "방위사업청(국가법령정보센터)",
      "title": "기술성숙도평가(TRA) 업무지침",
      "published": null,
      "url": "https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulSeq=2000000018891",
      "type": "정부·연구기관",
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 핵심기술요소의 기술성숙도(TRL)를 정량 평가하는 국내 행정규칙. TRL 6 이면 체계개발 진입 가능(검색 요약 기준, 판·조문 미확인).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 래스터 평면도 5,000장 주석 데이터셋과 다중 과제 모델.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "low",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. FloorPlanCAD 의 제3자 데이터셋 카드(범주 목록 포함).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 벡터 CAD 조각 413,062개·27개 범주 데이터셋.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 평면도·입면도 등 건축 도면 객체·분할 데이터셋.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 운송 요소 유형 열거(ELEVATOR 등).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 엘리베이터 등 운송 요소 엔터티 정의.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 콘센트 유형 열거(충전 설비 값 없음).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 전기기기 유형 열거(충전 설비 값 없음).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 평면도 배경 위 주석으로 건물 지도·경유점 속성을 만드는 편집기 문서.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. BIM 기반 격자 지도의 한계와 포즈 그래프 지도 변환.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 요구·제공 능력을 기술하는 AAS 서브모델 템플릿.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. VDA 5050 팩트시트 JSON 스키마.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 플릿 어댑터 템플릿 설정 파일.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 문 어댑터 연동 문서.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 평면도 이미지에서 지도 모델을 반자동 추출하는 진행 중 연구.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "low",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. FP7 PAN-Robots 과제 소개 기사(설치 기간 단축 보고).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "low",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. OTTO 소프트웨어 2.28 판 소개(벤더 주장).",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. traffic-editor 와 building_map_generator 저장소 README.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. Open-RMF 시뮬레이션 월드·플러그인 문서.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 내부 운송 시스템 시뮬레이션 디지털 트윈의 실제 상태 초기화.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. AGV 플릿 설치를 위한 반자동 지도·경로망 생성.",
      "source_unopened": true,
      "fetched": false,
      "fetched_via": null,
      "fetch_url": null
  ...
  "page_proposals": [
    ...
    },
    {
      ...
      "rationale": "트랙 산출물(가설 판정표): 검증이 승인하면 3절 판정 칸에 가설 1 부분 지지(f23)·가설 2 부분 지지(f24)·가설 3 미판정(f25)과 근거 단계·실행 id 를 적고, 판정 규칙(f22) 한 단락을 둔다. 승인되지 않으면 미판정 유지."
    },
    {
      "action": "update",
      ...
      "rationale": "아이디어 페이지 6절(트랙 산출물): '가설 판정 절차' 소절 신설 — 근거 확실성 평가(f1·f2·f21), 판정 값 규칙과 TRL 보조 축(f3·f4·f22), 잠정 판정 요약(f23~f25), 필요 실험(f26). 모두 추정 중심"
    },
    {
      "action": "update",
      "path": "docs/tracks/floorplan-recognition/experiments.md",
      "sections": [],
      "rationale": "트랙 산출물(단계 5 stage_artifacts): 제안된 실험 계획 후보 E5-01 물류 도면 인식 지표 실험(가설 1), E5-02 능력 대조 판정 대 실제 주행 비교(가설 2, q5-05), E5-03 두 조건 모델링 시간 비교(가설 3, q5-12), E5-04 시뮬레이션 예측 대 현장 측정(가설 3, q5-06) — 근거 f26·f22"
    },
    {
      "action": "update",
      ...
      "rationale": "트랙 floorplan-recognition 단계 5 반영 제안 (f1, f2, f3, f4, f21, f22): 여러 출처의 근거를 GRADE 식 영역으로 확실성을 매기고 TRL 로 성숙도를 병기해 기술 가설을 판정하는 방법(추정)"
    }
  ],
  "glossary_candidates": [
    {
      ...
      "definition": "기술이 실제 적용에 얼마나 준비되었는지를 기초 원리 이해부터 실제 운용까지 1~9단계로 나타내는 지표로, 실험실 검증과 관련 환경 시연을 구분한다."
    },
    {
      "term_ko": "근거 확실성 등급",
...
### runs/2026-09-25-84/verification.json
...
```json
{
  ...
  "claim_checks": [
    {
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과에서 Cochrane 핸드북 14장의 기관·제목·URL이 일치하고, 스니펫에 다섯 영역(비뚤림 위험·비일관성·비직접성·비정밀성·출판 비뚤림)과 결과(outcome)별 행 구성이 나타난다. 네 수준 표기는 브리프 스니펫 기준. 발행일 미확인. 단일 출처라 교차 확인 없음."
    },
    {
      "finding_id": "f2",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "원문 미열람. ACM DL 서지(ESEM 2008, 178–187쪽, DOI 10.1145/1414004.1414034)는 일치한다. 스니펫이 뒷받침하는 범위는 '1차 연구 질 평가 체계와 근거 묶음 강도 등급 체계를 개관하고 애자일 개발 체계적 문헌고찰로 예시'까지다. '처음 적용한 연구'(순위 표현), 'GRADE(2004판)를 풀어 설명', '질적·관찰 연구를 함께 다루는'은 확인되지 않아 해당 구절은 삭제 지시."
    },
    {
      "finding_id": "f3",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 검색 결과에서 NASA ESTO의 'Definition Of Technology Readiness Levels'(esto.nasa.gov/files/trl_definitions.pdf)가 확인되고, 스니펫은 TRL 5를 관련 환경 검증, TRL 6을 관련 환경의 시스템·하위 시스템 모델 또는 시제품 시연으로 설명한다. '실험실 규모와 공학 규모 검증을 구분'은 스니펫에 없으므로 문구 조정 지시. 발행일 미확인."
    },
    {
      "finding_id": "f4",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "원문 미열람. 국가법령정보센터에서 방위사업청 '기술성숙도평가(TRA) 업무지침'이 검색되고 스니펫에 'TRL 6으로 평가되면 체계개발 진입이 가능하다'는 내용이 있다. 다만 검색 결과의 admRulSeq 값(2000000021317, 2100000048410)이 브리프 URL(2000000018891)과 달라 브리프 URL이 가리키는 판은 확인하지 못했다. 규칙 번호도 검색 결과에서 '예규 제725호'로 나와 브리프의 '훈령 제725호'와 다르므로 번호·종류·제정일은 미확인으로 둔다."
    },
    {
      "finding_id": "f5",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-05). 게시된 아이디어 3 페이지 3절 데이터셋 표의 검증된 문장과 일치(5,000장, 80여 범주, 계단 있음·엘리베이터 미확인). 원문 미열람, 기존 각주 ref-063 재사용."
    },
    {
      "finding_id": "f6",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용. 기존 페이지에서 FloorPlanCAD 엘리베이터 범주를 제3자 카드 근거 추정으로 둔 것과 일치. 추정 태그 적절."
    },
    {
      "finding_id": "f7",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-36). ref-421·ref-213은 엘리베이터(ELEVATOR 유형 값) 부분을 뒷받침한다. IfcDoor·IfcStair 부분의 근거인 ref-419·ref-420이 source_ids에 빠져 있어 각주 추가 지시. 개발 브랜치 기준 명시와 실무 IFC 프록시 오분류 가능성(기존 검증 문장, ref-432) 병기 지시."
    },
    {
      "finding_id": "f8",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "사실 → 추정(결론 구절). 두 열거에 충전 설비 값이 없다는 것은 출처가 뒷받침한다(사실). 그러나 '충전 위치는 BIM 표준 유형으로 도면에 담기지 않는 것으로 확인된다'는 일반화이며, 기존 게시 페이지는 이를 '담기지 않을 가능성이 클 것으로 보인다 [추정]'으로 두었다. 두 출처는 발행 주체가 같다."
    },
    {
      "finding_id": "f9",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-19). traffic-editor 경유점 속성을 사람이 입력한다는 기존 검증 문장과 일치. 충전소 지정 속성 이름에 관한 출처 충돌(열린 질문 oq-069)을 함께 표시하도록 지시."
    },
    {
      "finding_id": "f10",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용. '부재 확인 아님'을 명시한 추정으로, 기존 페이지 한계 서술과 일치."
    },
    {
      "finding_id": "f11",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. IDTA 02020의 요구·제공 능력 비교와 속성 제약은 기존 검증 사실. '공간 통과 조건과 로봇 능력을 같은 틀로 대조할 표현 수단이 존재한다'는 로봇 공간 통과로 옮긴 해석이며, 기존 페이지는 이를 추정으로 두었다. 해석 구절을 [추정]으로 분리하라는 지시. 원문 미열람."
    },
    {
      "finding_id": "f12",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. 팩트시트 스키마와 플릿 어댑터 템플릿에 계단·문·승강기 능력 필드가 없다는 것은 기존 검증 사실. '가설 2 의 대조에 쓸 로봇 쪽 능력 값이 관제 인터페이스에서 오지 않는다'는 해석으로 [추정] 분리."
    },
    {
      "finding_id": "f13",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. Pset_DoorCommon·Pset_StairCommon 속성은 기존 검증 사실(공식 문서 검색 요약, 원문 미열람). '공간 쪽 통과 조건 값은 BIM 에서 얻을 수 있다'는 해석(실무 모델에 속성이 채워지는지는 미확인)으로 [추정] 분리."
    },
    {
      "finding_id": "f14",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. 문 어댑터가 문 여닫기를 처리한다는 것은 기존 검증 사실. '대조 규칙이 선택 조건을 가져야 한다'는 기존 페이지에서도 추정으로 둔 해석이다. 연계 대상 표시는 적절함. 해석 구절은 [추정]으로 분리."
    },
    {
      "finding_id": "f15",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용(실행 2026-09-25-82). 단계 5 페이지에서 저자 보고, 지도 1건, 재확인 안 됨으로 [추정] 처리한 것과 일치. 원문 미열람."
    },
    {
      "finding_id": "f16",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "재인용. 과제 측 보고값 추정으로 적절. 다만 as_of를 2026-09-25로 적었는데, 기존 게시 문장은 기준일을 2015-04(재게재 기사 기준, CORDIS 원 게재일 미확인)로 두었으므로 그에 맞추도록 지시."
    },
    {
      "finding_id": "f17",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "벤더 주장. vendor_claim: true이고 태그가 추정이다. 판정 근거로 쓰지 않는다는 처리가 기존 페이지와 일치."
    },
    {
      "finding_id": "f18",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. building_map_generator가 사람이 주석한 파일로 월드와 주행 그래프를 만든다는 것은 기존 검증 사실(같은 Open Robotics 자료라 독립 교차 확인 아님). '도면 기반 결과를 시뮬레이션 초기값으로 옮기는 경로가 존재한다'는 입력이 사람 주석인 도구를 도면 인식 결과로 넓힌 해석이므로 [추정]으로 분리."
    },
    {
      "finding_id": "f19",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. 실제 부하 상태로 초기화하면 과도 구간이 준다는 보고는 기존 검증 사실(저자 미확인, 원문 미열람). '도면 기반 정적 초기값만으로는 운영 예측용 초기값이 되지 않음을 시사'는 기존 페이지에서 추정으로 둔 해석이므로 [추정]으로 분리. 8. 실시간 세계 상태·데이터 일관성과 22. 시뮬레이션·예측용 디지털 트윈의 구분 서술 유지."
    },
    {
      "finding_id": "f20",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "강등",
      "note": "부분 뒷받침. BIM 격자 지도가 구조 요소만 담아 가구·설계–시공 편차가 위치추정 정확도에 영향을 준다는 것은 기존 검증 사실. '반대 방향 근거가 된다'는 가설 판정용 해석으로 [추정] 분리. 연계 대상 표시 유지."
    },
    {
      "finding_id": "f21",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "이 위키의 종합(추정, low). 근거 f1·f2는 판정 절차를 직접 정하지 않으며 finding도 그렇게 밝힌다. f2 강등 뒤에도 GRADE 영역(f1)이 핵심 근거로 남는다."
    },
    {
      "finding_id": "f22",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "설계 제안(추정). 판정 값 네 가지는 트랙 개요 3절 정의와 일치. 다만 '부분 지지'(빠지는 부분 확인)와 '미판정'(핵심 하위 주장에 직접 근거 없음)의 조건이 겹칠 수 있고 우선순위가 정해지지 않았으므로, 남은 불확실성에 명시하라는 지시."
    },
    {
      "finding_id": "f23",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "잠정 판정(추정, low). 근거 f5~f10·f20과 맞는다. 물류 도면의 직접 근거가 없어 f22 규칙의 미판정 조건과도 겹친다는 점을 병기하도록 지시. 트랙 개요 3절에는 '부분 지지(잠정)'로만 싣는다."
    },
    {
      "finding_id": "f24",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "잠정 판정(추정, low). 표현 가능성만 확인되고 대조 정확도 근거가 없다는 서술이 f11~f14와 맞는다."
    },
    {
      "finding_id": "f25",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "잠정 판정(추정). 벤더 수치를 판정 근거에서 뺀 처리가 적절하다. 미판정은 f22 규칙과 맞는다."
    },
    {
      "finding_id": "f26",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "실험 후보 도출(추정). 실험 페이지의 '제안' 상태 계획의 근거로 쓸 수 있다. 수치 목표나 합격 임계값은 근거가 없어 넣지 않는다."
    },
    {
      "finding_id": "f27",
      "source_exists": true,
      ...
      "cross_checked": false,
      "tag_decision": "유지",
      "note": "설명용 가정 사례(추정). 측정값이 없음을 밝혔다. 흐름 단계 출하 / 예외·성과."
    },
    {
      "finding_id": "f28",
      "source_exists": true,
  ...
  "duplication": {
    "ok": false,
    "overlaps": [
      "f8: 게시된 아이디어 3 페이지 4절·스키마 초안 6절에서는 '로봇 충전소는 … 담기지 않을 가능성이 클 것으로 보인다 [추정]'인데, f8은 같은 결론을 '확인된다 [사실]'로 올려 기존 검증 문장과 충돌한다",
      "f9: 충전소 지정 속성 이름(is_charger 대 is_parking_spot)은 열린 질문 oq-069의 출처 충돌 대상이다",
      "f16: 기존 게시 문장의 기준일은 2015-04(재게재 기사 기준)인데 f16의 as_of는 2026-09-25이다",
      "f5~f20: 이전 실행의 검증된 finding을 재인용한 것이므로 새 각주를 만들지 말고 기존 ref id 각주를 재사용해야 한다"
    ]
  },
  "terminology": {
    "ok": true,
  ...
  "required_fixes": [
    "f2: '소프트웨어 공학 체계적 문헌고찰에 근거 강도 평가를 처음 적용한 연구로', 'GRADE(2004판)를 풀어 설명하고', '질적·관찰 연구를 함께 다루는' 구절을 삭제한다. 남는 문장('ESEM 2008, 178–187쪽에서 1차 연구의 질 평가 체계와 근거 묶음 강도 등급 체계를 개관하고 애자일 개발 체계적 문헌고찰로 예시했다')만 [사실][^ref-808]로 둔다 — 검색 요약이 순위 표현과 세부 내용을 뒷받침하지 않는다.",
    "f3: '실험실 규모와 공학 규모 검증을 구분한다'를 'TRL 5(관련 환경 검증)와 TRL 6(관련 환경 시연)을 구분한다'로 고친다. 각주 발행일은 '미확인'으로 둔다 — 검색 요약에 규모 구분 문구가 없다.",
    "f4: 규칙의 종류·번호·제정일('훈령 제725호', 2021-07-23)을 본문에 쓰지 않는다. '판·규칙 번호 미확인'으로 두고 각주 발행일은 '미확인'으로 둔다 — 검색 결과는 '예규 제725호'로 적어 브리프와 다르고, 브리프 URL의 admRulSeq 값도 검색 결과와 다르다.",
    "f7: IfcDoor·IfcStair 부분에 기존 각주 [^ref-419][^ref-420]을 더하고 '개발 브랜치 기준'을 명시한다. 실무 IFC 모델에서 프록시로 내보내질 수 있다는 기존 검증 문장(ref-432)을 병기한다 — 현재 source_ids(ref-421·ref-213)는 엘리베이터 부분만 뒷받침한다.",
    "f8: 문장을 둘로 나눈다. '콘센트·전기기기 유형 열거에 충전 설비 값이 없다'는 [사실][^ref-214][^ref-215](같은 발행 주체, 독립 교차 확인 아님)로 두고, '충전 위치는 BIM 표준 유형으로 담기지 않을 가능성이 클 것으로 보인다'는 [추정]으로 강등한다 — '확인된다'는 일반화이며 기존 게시 문장과 충돌한다.",
    "f11·f12·f13·f14·f18·f19·f20: 각 문장에서 출처가 직접 말하는 부분은 기존 게시 문장대로 [사실]로 두고, 가설 판정용 해석 구절은 별도 문장으로 나누어 [추정]으로 강등한다. 해석 구절은 f11 '같은 틀로 대조할 표현 수단이 존재한다', f12 '로봇 쪽 능력 값이 관제 인터페이스에서 오지 않는다', f13 '통과 조건 값은 BIM 에서 얻을 수 있다', f14 '대조 규칙이 선택 조건을 가져야 한다', f18 '도면 기반 결과를 시뮬레이션 초기값으로 옮기는 경로가 존재한다', f19 '도면 기반 정적 초기값만으로는 운영 예측용 초기값이 되지 않음을 시사', f20 '반대 방향 근거가 된다'이다 — 이 해석들은 출처 서술을 넘어서며 기존 페이지에서도 추정으로 두었다.",
    "f9: 충전소 속성(is_charger)을 인용할 때 충전소 지정 속성 이름의 출처 충돌이 열린 질문 oq-069로 남아 있음을 한 구절로 병기한다.",
    "f16: 기준일을 기존 게시 문장과 같게 '2015-04, 재게재 기사 기준, CORDIS 원 게재일 미확인'으로 적는다.",
    "트랙 개요(docs/tracks/floorplan-recognition/index.md) 3절: 판정 칸에 가설 1 '부분 지지(잠정, 확실성 낮음)', 가설 2 '부분 지지(잠정, 확실성 낮음 — 표현 가능성만 확인)', 가설 3 '미판정'을 적는다. 근거 칸에는 '단계 5·실행 2026-09-25-84'를 적는다. 가설 문장의 [가설] 태그는 그대로 두고 [사실]로 올리지 않는다. 판정 규칙 단락(f22)은 이 위키의 설계 제안([추정])으로 쓰고, GRADE·TRL이 가설 판정 규칙을 정한 것처럼 서술하지 않는다.",
    "단계 5 페이지 4절 남은 불확실성: 판정 값 규칙(f22)에서 '부분 지지'(빠지는 부분 확인)와 '미판정'(핵심 하위 주장에 물류 조건 직접 근거 없음)의 조건이 겹칠 수 있고 우선순위가 정해지지 않았다는 점을 명시한다. 가설 1의 잠정 판정이 이 겹침에 해당한다는 점도 명시한다(f22·f23).",
    "실험 페이지(experiments.md) '제안된 실험 계획': E5-01~E5-04를 상태 '제안'으로 싣는다. 측정 지표는 q5-01·q5-02 답 소제목으로 링크하고, 근거 f26·f22를 [추정]으로 표기한다. 수치 목표·합격 임계값·참가자 수는 근거가 없으므로 넣지 않는다(q5-09·q5-12로 남김).",
    "용어 후보 '기술 성숙도(TRL)': 정의는 f3·f4 범위(1~9단계 가운데 관련 환경 검증·시연의 구분, 국내 방위사업 평가 절차에서의 쓰임)로 쓰고, 근거 없는 '기초 원리 이해부터 실제 운용까지' 구절은 빼거나 출처 각주 없이 쓰지 않는다.",
    "모든 각주 정의의 접근일 뒤에 ' (원문 미열람)'을 붙이고, reference_updates의 모든 항목에 source_unopened: true를 넣는다(이번 실행은 원문 열람이 차단된 환경이며 어떤 출처도 원문을 열지 않았다).",
    "f27: 설명용 가상 시나리오임을 표 머리에 밝히고 수치를 넣지 않는다. 물류 흐름 단계는 '출하', 항목은 '예외·성과'로 둔다.",
    "단계 5 페이지 6절: 완료 조건 세 행의 검증 판정 칸을 '충족 · 미승인'으로 적는다(1차 예비 판정이며 2차에서 확정). 표 아래 줄은 '다음 단계로 전환: 아니오(막힌 질문 q5-04~q5-10, q5-12, q5-13 열림; 단계 5는 마지막 단계이므로 트랙 done 전환 미승인)'로 적는다. 상태 줄의 단계 상태는 '진행 중'을 유지한다.",
    "23. 시험·형식 검증·벤치마크 반영 제안은 세부영역 페이지를 직접 고치지 않고 트랙 로그의 '세부영역 반영 제안'으로만 남긴다."
  ],
  "confidence": "low",
  "verification_note": "판정: 조건부 승인. 이번 실행은 원문 열람이 차단된 환경에서 검증됐다(검증 검색 4회, 리서치 8회와 합쳐 12/40). 확인 19건, 미확인 9건, 교차 확인 0건. 강등: f2 사실 → 추정(과장 구절 삭제 후 남는 부분은 사실), f8 사실 → 추정(결론 구절), f11·f12·f13·f14·f18·f19·f20 해석 구절 사실 → 추정(출처 서술 부분은 사실 유지). 원문 미열람 출처: ref-807, ref-808, ref-809, ref-810, ref-063, ref-068, ref-073, ref-074, ref-421, ref-213, ref-214, ref-215, ref-079, ref-081, ref-229, ref-228, ref-105, ref-573, ref-574, ref-283, ref-794, ref-265, ref-271, ref-441, ref-406, ref-632, ref-217(이번 실행 전체). 주의: 가설 판정 절차와 판정 값 규칙은 GRADE·TRL을 옮긴 이 위키의 설계 제안(추정)이다. 가설 1·2의 '부분 지지'와 가설 3의 '미판정'은 물류센터 조건의 직접 근거가 없는 잠정 판정이며, 가설 문장은 [가설] 태그를 유지한다. 판정 규칙의 '부분 지지'와 '미판정' 조건이 겹칠 수 있고 우선순위는 정해지지 않았다. 방위사업청 업무지침은 판과 규칙 번호를 확인하지 못했다. 온톨로지 변경 승인: 없음(제안 없음) / 거부: 없음. 단계 완료 조건: 충족(1차 예비 — 평가 지표·검증 절차는 아이디어 6절에 있고, 가설 판정표와 실험 계획은 이번 실행의 스토리텔러 반영을 조건으로 함, 2차에서 확정). 단계 전환: 미승인(막힌 질문 q5-04~q5-10, q5-12, q5-13 열림; 단계 5는 마지막 단계이며 트랙 done 전환도 미승인).",
  "retry_reason": null,
  "track_checks": {
...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 207건 / 전체 776건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/open-questions.md (요약: 대상 영역 [3, 5, 6, 8, 10, 15, 16, 21, 22, 23, 24, 27, 28] 에 걸린 78건 / 전체 119건)
...
- oq-119 [열림] 국내에서 실내공간정보 구축이나 로봇 도입 시 지도·공용 자원 설정 공수(인·일)를 산정하는 품셈이나 공공 기준이 있는가? (영역 21, 4)
```
...
### runs/2026-09-25-84/docs_tree.txt
...
|---|---|---|---|---|---|
| 2026-09-25-82 | 2026-09-25 | 단계 5. 검증 방법과 가설 판정 | 조건부 승인 / 통과 | 0 / 3 | [로그](../../logs/daily/2026-09-25.md) |
...
````json
{
  ...
  "outline": [
    {
      "path": "docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md",
      "section": "3. 조사 결과 (q5-03 소제목 추가)",
      "budget_chars": 5200,
      "summary": "가설 판정은 가설을 하위 주장으로 나누고 GRADE 식 영역으로 확실성을 낮춰 매긴 뒤 판정 값으로 모으는 절차가 근거가 가장 많은 것으로 보인다. [추정][^ref-807][^ref-808]",
      "planned_findings": [
        "f1",
        "f2",
        "f3",
    ...
    },
    {
      ...
      "budget_chars": 2400,
      "summary": "잠정 판정은 가설 1·2 부분 지지, 가설 3 미판정이며, 판정 규칙의 부분 지지·미판정 조건이 겹칠 수 있다. [추정][^ref-807]",
      "planned_findings": [
        "f22",
        "f23",
        "f24",
    ...
    },
    {
      ...
      "section": "3. 가설과 판정 상태",
      "budget_chars": 1400,
      "summary": "가설 1·2 부분 지지(잠정), 가설 3 미판정. 판정 규칙은 이 위키의 설계 제안이다. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f22",
        "f23",
        "f24",
    ...
    {
      "path": "docs/ideas/floorplan-recognition.md",
      "section": "6. 검증 방법 (가설 판정 절차 소절 추가)",
      "budget_chars": 1500,
      "summary": "근거 확실성 평가와 판정 값 규칙, TRL 보조 축, 잠정 판정, 필요 실험을 요약한다. [추정][^ref-807][^ref-809]",
      "planned_findings": [
        "f1",
        "f3",
        "f4",
    ...
    },
    {
      ...
      "section": "제안된 실험 계획",
      "budget_chars": 1800,
      "summary": "E5-01~E5-04 실험 계획을 상태 '제안'으로 싣는다. [추정][^ref-809][^ref-807]",
      "planned_findings": [
        "f26",
        "f22"
      ]
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q5-03 답함(판정 절차·판정 값 규칙·잠정 판정표·필요 실험), 후속 질문 q5-14·q5-15, 완료 조건 표 갱신(충족 · 미승인), 출처 26건 추가, 이력 행 추가",
      "patches": [
        {
          "section": "2. 질문 목록",
          "action": "replace",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "3절 가설 판정 칸 갱신(가설 1·2 부분 지지(잠정), 가설 3 미판정)과 판정 규칙 단락(추정), 6절 이번 실행 요약 추가, 8절 각주 정의 추가",
      "patches": [
        {
          "section": "3. 가설과 판정 상태",
          "action": "replace",
        ...
        },
        {
          "section": "8. 참고 자료",
          "action": "replace",
          "content": "[^ref-807]: Cochrane, Chapter 14: Completing ‘Summary of findings’ tables and grading the certainty of the evidence, 미확인, https://www.cochrane.org/authors/handbooks-and-manuals/handbook/current/chapter-14, 접근일 2026-09-25 (원문 미열람)\n[^ref-809]: NASA ESTO, Definition Of Technology Readiness Levels, 미확인, https://esto.nasa.gov/files/trl_definitions.pdf, 접근일 2026-09-25 (원문 미열람)\n[^ref-810]: 방위사업청(국가법령정보센터), 기술성숙도평가(TRA) 업무지침, 미확인, https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulSeq=2000000018891, 접근일 2026-09-25 (원문 미열람)"
        }
      ]
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "6절에 '가설 판정 절차 (q5-03)' 소절 추가(근거 확실성 평가, 판정 값 규칙과 TRL 보조 축, 잠정 판정, 필요 실험), 각주 4건 추가",
      "patches": [
        {
          "section": "6. 검증 방법",
          "action": "append",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "제안된 실험 계획 E5-01~E5-04(상태: 제안) 추가",
      "patches": [
        {
          "section": "제안된 실험 계획",
          "action": "replace",
  ...
  "glossary_updates": [
    {
      ...
      "description": "국내에서는 방위사업청 기술성숙도평가(TRA) 업무지침이 핵심기술요소의 성숙도를 정량 평가하는 공식 절차로 쓰며 TRL 6 이면 체계개발 진입이 가능하다고 본다(판·규칙 번호 미확인). 이 위키에서는 가설 판정의 보조 축으로 검토했다.",
      "related_areas": [
        23,
        21
      ],
    ...
    {
      "action": "new",
      "slug": "grade-certainty-of-evidence",
      "term_ko": "근거 확실성 등급",
      "term_en": "GRADE (Grading of Recommendations, Assessment, Development and Evaluation)",
      "definition": "근거 묶음의 확실성을 비뚤림 위험·비일관성·비직접성·비정밀성·출판 비뚤림으로 낮춰 높음·중간·낮음·매우 낮음으로 매기는 평가 체계다.",
      "description": "Cochrane 핸드북 14장 기준(원문 미열람). 이 위키는 트랙 가설 판정에서 하위 주장별 근거 확실성을 매기는 틀로 옮겨 썼으며, 이는 설계 제안이다.",
      "related_areas": [
        23
      ],
      "sources": [
  ...
  "reference_updates": [
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 소프트웨어 공학 체계적 문헌고찰에서 1차 연구 질 평가 체계와 근거 묶음 강도 등급 체계를 개관하고 애자일 개발 문헌고찰로 예시한 ESEM 2008 논문(178–187쪽).",
      "source_unopened": true,
      "cited_by": [
        "docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md",
        "docs/ideas/floorplan-recognition.md"
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. NASA 기술 준비 수준 1~9 정의. TRL 5 관련 환경 검증, TRL 6 관련 환경 시연(검색 요약 기준).",
      "source_unopened": true,
      "cited_by": [
        "docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md",
        "docs/tracks/floorplan-recognition/index.md",
    ...
    },
    {
      ...
      "reliability": "medium",
      "accessed": "2026-09-25",
      "summary": "원문 미열람. 핵심기술요소의 기술성숙도(TRL)를 정량 평가하는 국내 행정규칙. TRL 6 이면 체계개발 진입 가능(검색 요약 기준, 판·규칙 번호·종류 미확인, URL 이 가리키는 판 미확인).",
      "source_unopened": true,
      "cited_by": [
        "docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md",
        "docs/tracks/floorplan-recognition/index.md",
  ...
  "open_question_updates": [
    {
      "action": "new",
      "question": "국내 로봇·물류 R&D 과제에서 도면 기반 지도 생성이나 로봇 관제 설정 자동화 기술의 성숙도를 기술성숙도(TRL) 기준으로 평가한 사례나 평가 기준이 있는가?",
      "areas": [
        21,
        23
      ],
  ...
  "flow_matrix_updates": [
    {
      "step": "출하",
      "item": "예외·성과",
      "link": "docs/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md#q5-03",
      "title": "단계 5. 검증 방법과 가설 판정"
    }
  ],
  ...
  "track_updates": {
    ...
    "log_entry": "답한 질문: q5-03(f1~f28, 판정 절차·판정 값 규칙·잠정 판정표; 가설 1 부분 지지(잠정, 확실성 낮음), 가설 2 부분 지지(잠정, 표현 가능성만 확인), 가설 3 미판정) / 새 질문: q5-14(f22), q5-15(f21) / 온톨로지 변경: 없음(공간 그래프 스키마 초안 v1.2 유지 — 가설 판정은 검증 방법이며 개념·관계 변경 제안 없음) / 완료 조건 평가: 충족(1차 예비 판정 — 아이디어 6절 평가 지표·검증 절차·가설 판정 절차, 트랙 개요 3절 잠정 판정표, 실험 페이지 E5-01~E5-04; 2차에서 확정), 단계 전환·트랙 done 전환 미승인(막힌 질문 q5-04~q5-10, q5-12, q5-13 열림) / 세부영역 반영 제안: 23. 시험·형식 검증·벤치마크(6. 대표 접근법과 기술), 6. 지도·공간·위치 모델(11. 열린 질문) 2건 / 다음 실행 제안: q5-04(PAN-Robots 비교 조건), q5-06·q5-05(시뮬레이션·통행 판정 측정), q5-14 / 참고: 단계 5 페이지·트랙 개요 H1 아래 상태 줄은 H2 절 밖이라 patches 로 갱신하지 못했다(트랙 개요의 '현재 단계: 단계 4' 표기 포함) — 퍼블리셔 또는 트랙 페이지 담당의 갱신 필요",
    "overview_progress": "단계 5 진행 중 — 열린 질문 11, 답함 3, 완료 조건 충족(1차 예비 판정, 2차에서 확정), 단계 전환·트랙 done 전환 미승인"
  },
  "area_reflection_proposals": [
    {
      "area_no": 23,
      "section": "6. 대표 접근법과 기술",
      "summary": "여러 출처의 근거를 GRADE 식 영역(비뚤림 위험·비일관성·비직접성·비정밀성·출판 비뚤림)으로 확실성을 매기고 기술 성숙도(TRL 5 관련 환경 검증·TRL 6 관련 환경 시연)를 보조 축으로 병기해 기술 가설을 판정하는 방법(이 위키의 설계 제안, 추정). 근거 ref-807·ref-808·ref-809·ref-810, 트랙 건축 도면 자동 인식 단계 5 q5-03(실행 2026-09-25-84)."
    },
    {
      "area_no": 6,
      "section": "11. 열린 질문",
      "summary": "물류센터 도면 기반 지도 생성의 인식 성능·시운전 시간 단축을 직접 잰 연구·국내 사례를 이번 검색 범위에서 찾지 못해 도면 기반 지도 가설(인식 초안·능력 대조·시간 단축)이 잠정 판정에 머문다는 공백(추정, 부재 확인 아님). 근거 ref-217·ref-794, 실행 2026-09-25-84."
    }
  ]
}
````

### runs/2026-09-25-84/pages/tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md
...
### runs/2026-09-25-84/pages/tracks/floorplan-recognition/index.md
...
### runs/2026-09-25-84/pages/ideas/floorplan-recognition.md
...
### runs/2026-09-25-84/pages/tracks/floorplan-recognition/experiments.md
...
### runs/2026-09-25-84/verification2.json
...
```json
{
  ...
  "corrections_rejected": [],
  "required_fixes": [
    "아이디어 페이지(docs/ideas/floorplan-recognition.md) 6. 검증 방법: 이번 실행에서 '가설 판정 절차 (q5-03)' 소절을 덧붙였는데, 같은 절의 '평가 지표 (q5-01)' 소절 마지막 단락의 '가설 판정(q5-03)은 아직 조사하지 않았고'와 '검증 절차: 현장 모델링 시간 단축 측정 (q5-02)' 소절 마지막 단락의 '가설 판정(q5-03)은 아직 조사하지 않았다'가 그대로 남아 이 페이지 안에서 서로 모순된다. 이 절의 patch 를 action replace 로 바꾸고, 두 구절을 각각 '가설 판정(q5-03)은 아래 가설 판정 절차 소절(실행 2026-09-25-84)에 있고'와 '가설 판정(q5-03)은 아래 가설 판정 절차 소절(실행 2026-09-25-84)에 있다'로 고친다. 절 첫 단락의 소절 안내 문장에도 '가설 판정 절차' 소절이 q5-03 답(실행 2026-09-25-84)의 요약이라는 한 구절을 더한다. 절의 나머지 문장·태그·각주는 바꾸지 않는다. — 이 절은 이번 실행에서 바뀌었으므로 게시 시점에 거짓이 되는 문장을 남기지 않아야 한다."
  ],
  "confidence": "low",
  "verification_note": "판정: 조건부 승인. 이번 실행은 원문 열람이 차단된 환경에서 검증됐다(검증 검색 4회, 리서치 8회와 합쳐 12/40). 확인 19건, 미확인 9건, 교차 확인 0건. 강등: f2 사실 → 추정(과장 구절 삭제 후 남는 부분은 사실), f8 사실 → 추정(결론 구절), f11·f12·f13·f14·f18·f19·f20 해석 구절 사실 → 추정(출처 서술 부분은 사실 유지). 원문 미열람 출처: ref-807, ref-808, ref-809, ref-810, ref-063, ref-068, ref-073, ref-074, ref-421, ref-213, ref-214, ref-215, ref-079, ref-081, ref-229, ref-228, ref-105, ref-573, ref-574, ref-283, ref-794, ref-265, ref-271, ref-441, ref-406, ref-632, ref-217(이번 실행 전체). 주의: 가설 판정 절차와 판정 값 규칙은 GRADE·TRL을 옮긴 이 위키의 설계 제안(추정)이다. 가설 1·2의 '부분 지지'와 가설 3의 '미판정'은 물류센터 조건의 직접 근거가 없는 잠정 판정이며, 가설 문장은 [가설] 태그를 유지한다. 판정 규칙의 '부분 지지'와 '미판정' 조건이 겹칠 수 있고 우선순위는 정해지지 않았다. 방위사업청 업무지침은 판과 규칙 번호를 확인하지 못했다. 온톨로지 변경 승인: 없음(제안 없음) / 거부: 없음. 단계 완료 조건: 충족(평가 지표·검증 절차는 아이디어 6절, 가설 판정표는 트랙 개요 3절, 실험 계획 E5-01~E5-04는 실험 페이지에 실림). 단계 전환: 미승인(막힌 질문 q5-04~q5-10, q5-12~q5-15 열림; 단계 5는 마지막 단계이며 트랙 done 전환도 미승인). / 2차 수정 후 재검증. 드리프트 없음, 1차 수정 지시 16건 이행 확인(태그 분리·강등, 벤더 주장·원문 미열람 병기, 기준일, 판정 칸·6절 표기, 실험 계획 '제안' 상태), [분류원문] 보존, 섹션 순서 준수, 링크 유효. 지적 1건: 아이디어 페이지 6절에 q5-03 을 '아직 조사하지 않았다'는 구절 두 개가 남아 새 소절과 모순된다. 참고(patches 범위 밖이라 수정 지시 아님): 단계 5 페이지 H1 아래 상태 줄(열린 질문 9건·답한 질문 1건·완료 조건 미충족)과 트랙 개요 상태 줄의 '현재 단계: 단계 4'가 이번 판정(답한 질문 3건, 열린 질문 11건, 완료 조건 충족, 현재 단계 5)과 맞지 않는다. 퍼블리셔 또는 트랙 페이지 담당이 고쳐야 한다. 트랙 개요 6절의 '현재 제안된 실험은 없다'도 실행 전 기준 문장으로 남아 있다.",
  "retry_reason": null,
  "track_checks": {
    "standard_sources_ok": true,
    "vendor_claims_tagged": true,
...
- 수정 지시(required_fixes):
    - 아이디어 페이지(docs/ideas/floorplan-recognition.md) 6. 검증 방법: 이번 실행에서 '가설 판정 절차 (q5-03)' 소절을 덧붙였는데, 같은 절의 '평가 지표 (q5-01)' 소절 마지막 단락의 '가설 판정(q5-03)은 아직 조사하지 않았고'와 '검증 절차: 현장 모델링 시간 단축 측정 (q5-02)' 소절 마지막 단락의 '가설 판정(q5-03)은 아직 조사하지 않았다'가 그대로 남아 이 페이지 안에서 서로 모순된다. 이 절의 patch 를 action replace 로 바꾸고, 두 구절을 각각 '가설 판정(q5-03)은 아래 가설 판정 절차 소절(실행 2026-09-25-84)에 있고'와 '가설 판정(q5-03)은 아래 가설 판정 절차 소절(실행 2026-09-25-84)에 있다'로 고친다. 절 첫 단락의 소절 안내 문장에도 '가설 판정 절차' 소절이 q5-03 답(실행 2026-09-25-84)의 요약이라는 한 구절을 더한다. 절의 나머지 문장·태그·각주는 바꾸지 않는다. — 이 절은 이번 실행에서 바뀌었으므로 게시 시점에 거짓이 되는 문장을 남기지 않아야 한다.
- 검증 노트: 판정: 조건부 승인. 이번 실행은 원문 열람이 차단된 환경에서 검증됐다(검증 검색 4회, 리서치 8회와 합쳐 12/40). 확인 19건, 미확인 9건, 교차 확인 0건. 강등: f2 사실 → 추정(과장 구절 삭제 후 남는 부분은 사실), f8 사실 → 추정(결론 구절), f11·f12·f13·f14·f18·f19·f20 해석 구절 사실 → 추정(출처 서술 부분은 사실 유지). 원문 미열람 출처: ref-807, ref-808, ref-809, ref-810, ref-063, ref-068, ref-073, ref-074, ref-421, ref-213, ref-214, ref-215, ref-079, ref-081, ref-229, ref-228, ref-105, ref-573, ref-574, ref-283, ref-794, ref-265, ref-271, ref-441, ref-406, ref-632, ref-217(이번 실행 전체). 주의: 가설 판정 절차와 판정 값 규칙은 GRADE·TRL을 옮긴 이 위키의 설계 제안(추정)이다. 가설 1·2의 '부분 지지'와 가설 3의 '미판정'은 물류센터 조건의 직접 근거가 없는 잠정 판정이며, 가설 문장은 [가설] 태그를 유지한다. 판정 규칙의 '부분 지지'와 '미판정' 조건이 겹칠 수 있고 우선순위는 정해지지 않았다. 방위사업청 업무지침은 판과 규칙 번호를 확인하지 못했다. 온톨로지 변경 승인: 없음(제안 없음) / 거부: 없음. 단계 완료 조건: 충족(평가 지표·검증 절차는 아이디어 6절, 가설 판정표는 트랙 개요 3절, 실험 계획 E5-01~E5-04는 실험 페이지에 실림). 단계 전환: 미승인(막힌 질문 q5-04~q5-10, q5-12~q5-15 열림; 단계 5는 마지막 단계이며 트랙 done 전환도 미승인). / 2차 수정 후 재검증. 드리프트 없음, 1차 수정 지시 16건 이행 확인(태그 분리·강등, 벤더 주장·원문 미열람 병기, 기준일, 판정 칸·6절 표기, 실험 계획 '제안' 상태), [분류원문] 보존, 섹션 순서 준수, 링크 유효. 지적 1건: 아이디어 페이지 6절에 q5-03 을 '아직 조사하지 않았다'는 구절 두 개가 남아 새 소절과 모순된다. 참고(patches 범위 밖이라 수정 지시 아님): 단계 5 페이지 H1 아래 상태 줄(열린 질문 9건·답한 질문 1건·완료 조건 미충족)과 트랙 개요 상태 줄의 '현재 단계: 단계 4'가 이번 판정(답한 질문 3건, 열린 질문 11건, 완료 조건 충족, 현재 단계 5)과 맞지 않는다. 퍼블리셔 또는 트랙 페이지 담당이 고쳐야 한다. 트랙 개요 6절의 '현재 제안된 실험은 없다'도 실행 전 기준 문장으로 남아 있다.
