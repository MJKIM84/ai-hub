...
| 분류 적합성 | 예 | — |
| 범위 경계 | 예 | — |
| 중복·모순 | 예 | f15·f16·f17 은 1차 지시대로 oq-019, oq-029, oq-007·oq-023 에 링크로 연결됐다. 새 일반 열린 질문은 만들지 않았다., 기한 변환 규칙 질문은 backlog_updates 에 넣지 않았다. 단계 2 페이지 5절과 초안 6절에서 q3-01 에 연결했다. |
| 용어 일관성 | 예 | — |
| 인용 길이·저작권 | 예 | — |
| 정정 요청 반영 | — | — |
