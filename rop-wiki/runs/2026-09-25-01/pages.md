...
| 동작 | 경로 | 상태 | 변경 요약 |
|---|---|---|---|
| update | docs/categories/b-common-information-and-environment-model/07-cargo-inventory-and-asset-identification-and-tracking.md | draft | 영역 심화: 섹션 3~11 신규 작성(식별 키·EPCIS 이벤트·로봇 적재 보고와 인계 확인·출하 시나리오), 상태 줄 추가, 각주 15건 정의 |
