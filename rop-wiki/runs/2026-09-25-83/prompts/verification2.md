      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-83/pages/tracks/nl-task-chatbot/stage-4-misinterpretation-safeguards.md 의 해당 절을 본다)"
        },
        {
          "section": "3. 조사 결과",
          "action": "append",
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-83/pages/tracks/nl-task-chatbot/task-model-draft.md 의 해당 절을 본다)"
        },
        {
          "section": "2. 개념 목록 표",
          "action": "replace",
...
- 차등 갱신 패치 적용:
    ...
    - docs/tracks/nl-task-chatbot/task-model-draft.md (4개 절)
