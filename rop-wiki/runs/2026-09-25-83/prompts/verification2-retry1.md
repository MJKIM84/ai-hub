  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q4-03 답함(명령 권한·감사 추적), 후속 질문 3건(q4-17·q4-18·q5-17), 결론·완료 조건·출처·이력 갱신. 2차: 단계 상태 줄을 열린 질문 15건·답한 질문 3건으로 맞추고 q4-03 시나리오 예외·성과 칸 문구를 배정 최적성 손실로 고침(전체 content)"
    },
    {
      "path": "docs/tracks/nl-task-chatbot/task-model-draft.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "초안 v0.8 → v0.9: 개념 '명령 권한' 추가(확정, 속성 구성·기본 거부는 후보), 지시 개념 입력자를 인증된 사용자 식별로 정리, 다이어그램·6절 질문 갱신. 2차: H1 을 (v0.9)로 맞춤(전체 content)"
    },
    {
      "path": "docs/ideas/nl-task-chatbot.md",
      "action": "update",
      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-83/pages/ideas/nl-task-chatbot.md 의 해당 절을 본다)"
        }
      ]
    },
    {
      ...
      "patches": [
        {
          ...
          "action": "replace",
          "content": "(절 본문 생략 — runs/2026-09-25-83/pages/tracks/nl-task-chatbot/index.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
...
### runs/2026-09-25-83/format_check.md
...
| 완료·인계 | 해당 없음 |
| 예외·성과 | 거부한 지시도 판정 사유와 함께 감사 추적에 남기는 흐름이 가능해 보인다. [추정][^ref-763][^ref-769][^ref-695] 권한 제약이 배정 최적성에 주는 손실을 잰 자료는 찾지 못했다. [추정][^ref-125][^ref-763][^ref-769] |
...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 212건 / 전체 780건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/glossary/index.md (요약: 용어 200개, slug: 한국어 (영어). 정의는 docs/glossary/<slug>.md)
...
### docs/open-questions.md (요약: 대상 영역 [1, 2, 5, 6, 8, 12, 13, 14, 16, 18, 19, 20, 23, 25, 26, 27] 에 걸린 93건 / 전체 120건)
