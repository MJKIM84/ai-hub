...
### docs/open-questions.md (요약: 대상 영역 [20] 에 걸린 4건 / 전체 69건)
...
- finding f19: 벤더 문서만 근거로 한 [사실] 인데 vendor_claim 표시가 없다(6.2 항목 13)
- finding f20: 벤더 문서만 근거로 한 [사실] 인데 vendor_claim 표시가 없다(6.2 항목 13)
