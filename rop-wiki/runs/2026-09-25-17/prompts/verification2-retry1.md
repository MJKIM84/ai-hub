...
```json
{
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 6. 지도·공간·위치 모델 의 \"7. 관련 표준·프레임워크·오픈소스\" 절을 옮겼다. 2차 수정: GS1 GLN 행을 [사실] 식별 문장과 [추정] 대응 문장으로 나눔"
    },
    {
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 6. 지도·공간·위치 모델 의 \"3. 왜 중요한가\" 절을 옮겼다. 2차 수정: MassRobotics 평면 기준 부재 문장에 '(스키마 파일 기준, 부재 확정 아님)' 한정 추가"
    }
  ],
  ...
  "reference_updates": [
    ...
    },
    {
      ...
      "reliability": "high",
      "accessed": "2026-09-25",
      "summary": "MassRobotics AMR 상호운용 표준 JSON 스키마. 상태 보고의 위치(x·y·z·쿼터니언 각도·planarDatum UUID)를 정의하며 평면 기준 정의 메시지와 위치추정 신뢰도 필드는 스키마에 없다(스키마 파일 기준).",
      "cited_by": [
        "docs/categories/b-common-information-and-environment-model/06-map-space-and-location-model.md"
      ],
      "source_unopened": false
...
### runs/2026-09-25-17/format_check.md
...
created: 2026-09-24
updated: 2026-09-25
sources: [ref-031, ref-051, ref-063, ref-064, ref-065, ref-066, ref-067, ref-069, ref-070, ref-071, ref-073, ref-074, ref-076, ref-078, ref-079, ref-080, ref-105, ref-148, ref-154, ref-155, ref-156, ref-157, ref-158, ref-159, ref-046, ref-161, ref-162, ref-163, ref-164, ref-165, ref-224, ref-230]
last_run: 2026-09-25
version: 2
---
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-051, ref-063, ref-066, ref-069, ref-071, ref-074, ref-079, ref-080, ref-105, ref-148, ref-154, ref-155, ref-156, ref-157, ref-158, ref-159, ref-046, ref-161, ref-164, ref-230]
last_run: 2026-09-25
version: 1
...
| GS1 GLN | 표준 | 물리적 위치와 하위 위치를 식별하는 업무 위치 식별자다. [사실][^ref-164] 지도 위 장소와 대응시킬 업무 쪽 키가 될 것으로 보인다. [추정][^ref-164][^ref-031] | 미열람 |
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-064, ref-067, ref-076, ref-079, ref-080, ref-154, ref-155, ref-158, ref-159, ref-046, ref-161, ref-162, ref-163, ref-164, ref-165, ref-230]
last_run: 2026-09-25
version: 1
...
- [28. 표준·상호운용성·다사업자 거버넌스](../../categories/g-safety-security-intelligence-and-governance/28-standards-interoperability-and-multi-vendor-governance.md) — LIF, ISO 21423, IndoorGML·ISO 19164 는 레이아웃·위치·실내 공간의 교환과 상호운용을 다루는 표준이다. [사실][^ref-046][^ref-161][^ref-158][^ref-159]
...
확인한 규격만 봐도 위치 표현이 서로 다르다. VDA 5050 3.0.0 은 프로젝트별 좌표계 안의 x·y·theta 와 지도 식별자(mapId)로 위치를 보고하게 한다. [사실][^ref-031] Open-RMF API 의 로봇 상태는 지도 이름(map)·x·y·yaw 로 위치를 보고한다. [사실][^ref-155] MassRobotics 상호운용 표준 스키마는 x·y·z·쿼터니언 각도와 참조하는 평면 기준(planarDatum)으로 위치를 두지만, 평면 기준의 원점·좌표계를 정의하는 메시지는 스키마에 없다(스키마 파일 기준, 부재 확정 아님). [사실][^ref-230]
