...
```json
{
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q1-01 답함(분해 접근 여섯 유형·접근별 내용·사람에게 남는 일), 후속 질문 q1-05, 완료 조건 미충족, 출처 17건"
    },
    {
      "path": "docs/tracks/nl-task-chatbot/task-model-draft.md",
      "action": "update",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "3절 선행 연구 쪽 작성(분해 결과 형태 여섯 유형, 사람에게 남는 일, 물류 적용 한계), 제품 사례 미조사 명시",
      "patches": [
        {
          "section": "3. 선행 연구·제품 사례",
          "action": "replace",
  ...
  "additional_research_requests": [
    ...
    "next_ref_id 산정 오류(ref-044~ref-050 충돌) 확인 — pipeline 담당 요청"
  ],
  "fixes_applied": [
    ...
    "원문 미열람 표시 — ref-052, 054, 056, 057, 058, 059, 061, 063, 065, 066 각주 접근일 뒤에 ' (원문 미열람)'을 붙이고 reference_updates 에 source_unopened: true 를 넣었으며, README 7건(ref-051, 053, 055, 062, 064, 067, 068)은 미열람 표시를 하지 않았다.",
  ...
  "area_reflection_proposals": [
    ...
    },
    {
      "area_no": 27,
      "section": "6. 대표 접근법과 기술",
      "summary": "LLM 출력을 실행 전에 접지·점검하는 방법: 기술 가치 함수(SayCan), 고전 계획기에 PDDL 넘김(LLM+P), LTL 식 변환(Lang2LTL). 형식 명세 경유 구조가 오해석 방지와 이어진다는 [추정]. 적용 대상 13. 작업 배정 — MRTA와 양쪽 연결(교차 규칙: 학습 기반 배차). 센서 인식·제어는 연계 대상. 근거 ref-051, ref-052, ref-064, ref-065, ref-055, ref-056."
    },
    {
      "area_no": 27,
      "section": "8. 대표 연구와 자료",
      "summary": "Cohen 외(IJCAI-24) 로봇 언어 접지 서베이(형식 표현–임베딩 스펙트럼, 장단점 평가는 [의견])와 Huang 외(ICML 2022), SayCan, LLM+P, Lang2LTL을 대표 자료로 등록하고 13. 작업 배정 — MRTA 페이지와 연결. 근거 ref-058, ref-066, ref-051, ref-064, ref-055."
    }
  ]
}
```
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-051, ref-052, ref-053, ref-054, ref-055, ref-056, ref-057, ref-058, ref-059, ref-061, ref-062, ref-063, ref-064, ref-065, ref-066, ref-067, ref-068]
last_run: 2026-09-25
version: 2
---
...
- **SayCan**: Ahn 외(2022)는 언어모델이 상위 목표에 대해 각 로봇 기술의 쓸모를 평가하고, 강화학습으로 학습한 언어 조건 가치 함수(어포던스)가 그 기술이 현재 상태에서 실행 가능한지를 평가해 둘을 결합한 점수로 다음 기술을 고른다. [사실][^ref-051][^ref-052]
...
- Huang 외, SayCan, ProgPrompt, Code as Policies, LLM+P, Lang2LTL, SMART-LLM 일곱 접근은 실행 가능한 단위(기술 목록, 가용 동작·객체, 제어 API, PDDL 도메인, 랜드마크 목록, 로봇 능력 목록)를 사람이 미리 정의해 두고 LLM은 그 어휘 안에서 분해하므로, 실행 단위의 정의와 예시 작성은 사람에게 남는 일로 보인다는 것이 이 위키의 정리(추론)다. [추정][^ref-067][^ref-051][^ref-054][^ref-068][^ref-064][^ref-055][^ref-062]
...
[^ref-051]: Google Research, SayCan (google-research/saycan README), 미확인, https://github.com/google-research/google-research/blob/master/saycan/README.md, 접근일 2026-09-25
[^ref-052]: Ahn, M. 외(Google), Do As I Can, Not As I Say: Grounding Language in Robotic Affordances, 2022-04, https://arxiv.org/abs/2204.01691, 접근일 2026-09-25 (원문 미열람)
...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-054, ref-055, ref-057, ref-059, ref-062, ref-063, ref-064, ref-066]
last_run: 2026-09-25
version: 2
---
...
updated: 2026-09-25
version: 2
sources: [ref-051, ref-054, ref-055, ref-057, ref-058, ref-059, ref-061, ref-062, ref-063, ref-064, ref-066, ref-067, ref-068]
confidence: medium
last_run: 2026-09-25
---
