...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-056, ref-092, ref-354, ref-359, ref-541, ref-417, ref-088, ref-351, ref-596, ref-597, ref-598, ref-610]
last_run: 2026-09-25
version: 1
...
- Liang 외, Code as Policies(2022) — 정해진 API 범위 안에서 정책 코드를 생성. [사실][^ref-596]
...
- Agrawal 외, RTAW(2022, ICRA 2023) — 창고 작업 배정의 주의 기반 강화학습(저자 보고, 시뮬레이션 창고 조건, 단일 출처). [사실][^ref-597]
- Sculley 외, Hidden Technical Debt in Machine Learning Systems(NeurIPS 2015) — ML 고유 유지 비용 위험. [사실][^ref-598]
- Breck 외, The ML Test Score(IEEE Big Data 2017) — 28개 시험·감시 항목의 운영 준비도 기준표. [사실][^ref-610]
