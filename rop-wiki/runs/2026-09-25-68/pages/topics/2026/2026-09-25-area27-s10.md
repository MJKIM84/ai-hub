...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-541, ref-417, ref-595, ref-351, ref-597, ref-611]
last_run: 2026-09-25
version: 1
...
- [13. 작업 배정 — MRTA](../../categories/d-planning-and-optimization/13-task-allocation-mrta.md) — 교차 규칙상 학습 기반 배차의 적용 대상이며, RTAW 같은 강화학습 배정이 맞물린다. [추정][^ref-597]
...
- [25. 안전·위험 관리](../../categories/g-safety-security-intelligence-and-governance/25-safety-and-risk-management.md) — 실행 전 안전 판정(SafeGate)과 제품 안전 구성요소 규제(EU AI Act)가 맞물린다. [추정][^ref-417][^ref-595]
- [24. 자산·소프트웨어 수명주기 관리](../../categories/f-deployment-verification-and-maintenance/24-asset-and-software-lifecycle-management.md) — 모델 버전·변경 관리가 맞물린다. [추정][^ref-611]
