...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-354, ref-541, ref-586, ref-592, ref-593, ref-594, ref-595, ref-611]
last_run: 2026-09-25
version: 1
...
| 이름 | 유형 | 이 영역과의 관계 | 출처 |
|---|---|---|---|
| NIST AI RMF 1.0 (NIST AI 100-1) | 프레임워크 | 2023-01-26 자율 적용 프레임워크로 발표되었고, 핵심은 거버넌스(Govern)·맵(Map)·측정(Measure)·관리(Manage) 네 기능이다. [사실][^ref-586] | ref-586 (원문 미열람) |
| ISO/IEC 42001:2023 | 표준 | AI 시스템을 개발·제공·사용하는 조직의 AI 관리 시스템 요구사항. [사실][^ref-592] | ref-592 (원문 미열람) |
| ISO/IEC 23894:2023 | 표준 | ISO 31000 위험관리 원칙을 AI에 적용해 위험 평가·처리·감시·검토·기록을 AI 활동에 통합하도록 안내하는 지침(2023-02). [사실][^ref-593] | ref-593 (원문 미열람) |
| MLflow 모델 레지스트리 | 오픈소스 | 모델 버전·별칭·태그·계보 관리와 별칭 재지정에 의한 운영 모델 교체. [사실][^ref-611] | ref-611 (원문 미열람) |
...
관련 법(표준이 아니므로 표 밖에 둔다): 한국 인공지능 기본법과 시행령은 2026-01-22 시행되었다(기준일 2026-01-22, 개정 법률의 시행일과 고영향 영역 목록은 미확인). [사실][^ref-594] EU AI Act(Regulation (EU) 2024/1689)는 제품 안전 구성요소이거나 제품 자체이고 제3자 적합성 평가 대상인 AI를 고위험으로 분류한다. [사실][^ref-595] EU AI Act의 적용 시점은 개정(AI Omnibus) 논의로 이 페이지에서 확정하지 않는다.
