...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "section": "7. 관련 세부영역",
      "budget_chars": 700,
      "summary": "2차 수정: 10. 설비·건물 시스템 연동 항목을 목록에 더해 프런트매터 related_areas 와 맞춘다.",
      "planned_findings": [
        "f10",
        "f19"
      ]
    ...
    },
    {
      ...
      "section": "5. 구현 가설",
      "budget_chars": 2800,
      "summary": "좌표 정렬과 층·목적지 이름 맞춤 소절과 도면–현장 정합 절차 초안(추정)을 더하고, 기존 소절의 '미조사' 문장을 이번 결과로 고친다. [추정][^ref-153][^ref-079]",
      "planned_findings": [
        "f1",
        "f5",
        "f6",
    ...
    },
    {
      ...
      "budget_chars": 500,
      "summary": "스키마 초안 현재 버전을 v1.1 로 고치고 실행 2026-09-25-76 산출물 변화 단락을 둔다.",
      "planned_findings": []
    }
  ],
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q4-03 답함(3절 {#q4-03} 신설, 추정 중심), 후속 질문 q4-12·q4-13, 완료 조건 2행 충족(1차 예비)·전환 미승인, 출처 16건 추가, 이력 행 추가; 2차 수정: 상태 줄 수치·완료 조건 갱신, 7절에 10. 설비·건물 시스템 연동 추가"
    },
    {
      "path": "docs/tracks/floorplan-recognition/space-graph-schema-draft.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "v1.0 → v1.1: 층 속성 '시스템별 층 식별자(별칭)' 추가(MassRobotics planarDatum 제외), 개념 '좌표계 정렬'은 반영하지 않고 6절 근거 보강, 6절에 층·장소 식별자 대응 근거와 도면–현장 정합 절차 초안(추정) 추가; 2차 수정: H1 을 v1.1 로, 프런트매터 sources 에서 미인용 ref-159·ref-745·ref-750 제거"
    },
    {
      "path": "docs/ideas/floorplan-recognition.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "5절에 '좌표 정렬과 층·목적지 이름 맞춤' 소절(q4-03, 추정 중심)과 q4-02·q4-03 을 합친 '도면–현장 정합 절차 초안(추정)' 소절 추가; 2차 수정: 5절을 replace 로 보내 기존 소절의 'q4-03 미조사·정합 절차 미완성' 문장을 이번 결과로 고치고 메타 문장 삭제",
      "patches": [
        {
          "section": "5. 구현 가설",
          "action": "replace",
          "content": "(절 본문 생략 — runs/2026-09-25-76/pages/ideas/floorplan-recognition.md 의 해당 절을 본다)",
          "frontmatter": {
            "sources": [
              "ref-031",
              "ref-062",
    ...
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "6절: 공간 그래프 스키마 초안 현재 버전을 v1.1 로 고치고 실행 2026-09-25-76 산출물 변화 단락 추가(2차 수정: replace 로 보내 괄호 문장 삭제)",
      "patches": [
        {
          "section": "6. 살아있는 산출물 링크",
          "action": "replace",
          "content": "(절 본문 생략 — runs/2026-09-25-76/pages/tracks/floorplan-recognition/index.md 의 해당 절을 본다)"
        }
      ]
    }
  ],
  ...
  "index_updates": {
    ...
    "category_recent": "2026-09-25 — 6. 지도·공간·위치 모델(건축 도면 자동 인식 트랙 단계 4): 좌표 정렬과 층·목적지 이름 맞춤 조사, 세부영역 반영 제안 6건(6. 지도·공간·위치 모델 4건, 21. 온보딩·설정·현장 시운전 1건, 10. 설비·건물 시스템 연동 1건)",
  ...
  "track_updates": {
    ...
    "overview_progress": "단계 4 진행 중 — 열린 질문 9, 답함 3(q4-01·q4-02·q4-03), 완료 조건 충족, 단계 전환 미승인"
  },
...
### runs/2026-09-25-76/format_check.md
...
- [10. 설비·건물 시스템 연동](../../categories/c-connectivity-and-execution-foundation/10-facility-and-building-system-integration.md) — Open-RMF 승강기 상태가 층을 주석 없는 문자열로만 나타내므로, 지도 층 이름과 승강기 층 이름을 잇는 층 대응표가 필요할 것으로 보이는 지점이다([열린 질문](../../open-questions.md) oq-045). [추정][^ref-286][^ref-743]
...
위 '도면–현장 차이 탐지와 반영' 소절(q4-02)과 '좌표 정렬과 층·목적지 이름 맞춤' 소절(q4-03)을 합치면 다음과 같은 도면–현장 정합 절차 초안이 된다. 이는 이 위키의 종합이며 단일 출처는 없고 신뢰도는 low 이다. [추정][^ref-746][^ref-345][^ref-079][^ref-153][^ref-651][^ref-031][^ref-569][^ref-649]
