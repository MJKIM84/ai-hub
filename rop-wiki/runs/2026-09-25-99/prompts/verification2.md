      ...
      "patches": [
        {
          ...
          "content": "(절 본문 생략 — runs/2026-09-25-99/pages/tracks/nl-task-chatbot/stage-5-verification-and-hypotheses.md 의 해당 절을 본다)"
        },
        {
          "section": "3. 조사 결과",
          "action": "append",
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/tracks/nl-task-chatbot/stage-5-verification-and-hypotheses.md (8개 절)
