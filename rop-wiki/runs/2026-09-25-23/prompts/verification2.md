...
```json
{
  ...
  "outline": [
    ...
    },
    {
      ...
      "budget_chars": 900,
      "summary": "비교표는 채워졌으나 요구 목록은 일부만 반영돼 단계 전환은 미승인이다.",
      "planned_findings": [
        "f24"
      ]
    },
  ...
  "pages": [
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "q1-03·q1-06·q1-07 답함(3절 소제목·앵커), q1-02 팩트시트 문장 판별 정리, KnowRob 판 구분 병기, 4·5·6·7·8·9절과 상태 줄 갱신, 후속 질문 q6-05. 상태 줄이 H2 밖이라 patches 대신 전체 content 로 보냄"
    },
    {
      "path": "docs/tracks/manual-capability-ontology/ontology-draft.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "v0.2 → v0.3: 기능 한정자(요구/제공), 개념 실행 상태 추가, 장착 장비 속성 2건·확정, 다이어그램 갱신, 6절에 요구 목록 초안·거부된 변경 3건 질문. H1 버전 표기가 H2 밖이라 전체 content 로 보냄"
    },
    {
      "path": "docs/tracks/manual-capability-ontology/model-standard-comparison.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "학술 온톨로지 행(IEEE 1872 CORA, IEEE 1872.2, KnowRob·SOMA, SSN/SOSA) 다섯 정보 항목 채움, VDA 5050 행에 2.1.0 태그 기준·3.0.0 필드 변화 반영, 빠진 정보 요약 갱신, 상태 줄 갱신(H2 밖이라 전체 content)"
    },
    {
      "path": "docs/tracks/manual-capability-ontology/index.md",
      "action": "update",
      "status": "draft",
      "diff_summary": "6. 살아있는 산출물 링크: 온톨로지 초안 v0.3, 비교표 학술 온톨로지 행 채움, 백로그 수치 갱신",
      "patches": [
        {
          "section": "6. 살아있는 산출물 링크",
          "action": "replace",
          "content": "(절 본문 생략 — runs/2026-09-25-23/pages/tracks/manual-capability-ontology/index.md 의 해당 절을 본다)"
        }
      ]
    },
    {
      ...
      "action": "update",
      "status": "draft",
      "diff_summary": "3절에 능력 매칭 선행 연구, 4절에 충전·적재·장착 장비 표현(실행 2026-09-25-23) 추가",
      "patches": [
        {
          "section": "3. 선행 연구·제품 사례",
          "action": "append",
          "content": "(절 본문 생략 — runs/2026-09-25-23/pages/ideas/robot-capability-ontology.md 의 해당 절을 본다)"
        },
        {
  ...
  "index_updates": {
    "home_recent": "2026-09-25 — 매뉴얼 기반 로봇 기능 온톨로지 단계 1: q1-03·q1-06·q1-07 답함, 모델·표준 비교표 학술 온톨로지 행 완성, 능력 온톨로지 초안 v0.3(요구·제공 한정자, 실행 상태, 장착 장비 속성)",
  ...
  "additional_research_requests": [
    ...
    "파이프라인 담당 요청(조사 아님): 트랙 단계 페이지·온톨로지 초안·비교표의 상태 줄과 H1 버전 표기는 첫 H2 앞에 있어 patches 로 갱신할 수 없다. 이번 실행은 그 세 페이지를 전체 content 로 보냈다. patches 가 H2 앞 머리 영역을 다룰 수 있게 하거나 상태 줄을 자동 영역으로 바꾸는 처리가 필요하다."
  ],
  "fixes_applied": [
    ...
    "docs/ideas/robot-capability-ontology.md: 각주 정의 3개를 참고문헌에서 만들어 붙임: ref-348, ref-352, ref-353"
  ],
  "track_updates": {
...
- 판정: 통과
- 차등 갱신 패치 적용:
    - docs/tracks/manual-capability-ontology/index.md (1개 절)
    - docs/ideas/robot-capability-ontology.md (2개 절)
```
