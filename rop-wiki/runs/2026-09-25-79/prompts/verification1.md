...
### docs/references/index.md (요약: 이번 대상 페이지가 인용한 159건 / 전체 695건. 목록에 없는 출처는 새 id 로 적는다 — 같은 URL 이 이미 있으면 퍼블리셔가 기존 id 로 합친다)
...
### docs/glossary/index.md (요약: 용어 179개, slug: 한국어 (영어). 정의는 docs/glossary/<slug>.md)
