...
```json
{
  ...
  "pages": [
    ...
    },
    {
      ...
      "action": "create",
      "status": "draft",
      "diff_summary": "자동 분리: 8. 실시간 세계 상태·데이터 일관성 의 \"10. 다른 연구영역과의 연결 (번호와 이름을 함께 표기)\" 절(1,091자)을 옮겼다. 형식 수정: 세부영역 링크 9건을 주제 페이지 위치 기준 경로(../../categories/…)로 고침"
    },
    {
...
- [7. 화물·재고·자산 식별과 추적](../../categories/b-common-information-and-environment-model/07-cargo-inventory-and-asset-identification-and-tracking.md) — EPCIS 의 발생·기록 시각과 오류 선언, 로봇 적재물 보고와 WMS 기록의 대조가 두 영역에 걸친다. [사실][^ref-045][^ref-044]
...
- [9. 로봇·제조사 관제 연동](../../categories/c-connectivity-and-execution-foundation/09-robot-and-vendor-fleet-manager-integration.md) — VDA 5050 의 상태 발행 조건과 연결 상태가 세계 상태의 입력 주기와 품질을 정한다(3.0.0 판, 공식 저장소 main 기준, 확인일 2026-09-25). [사실][^ref-031]
...
- [19. 모니터링·이상 탐지·원인 분석](../../categories/e-collaboration-and-field-operations/19-monitoring-anomaly-detection-and-root-cause-analysis.md) — 연결 끊김 통지(CONNECTION_BROKEN)와 STALE 표시는 이상 탐지의 입력으로 연결된다. [사실][^ref-031][^ref-383]
