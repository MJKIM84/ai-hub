...
- **신규** (열림 · 제기 2026-09-25 · 실행 2026-09-25-24) 출처 충돌: 김지형(2023)의 게재 학술지를 한 검색 요약은 지능정보논문지로, KoreaScience 는 한국인터넷방송통신학회논문지(DOI 10.7236/JIIBC.2023.23.4.189)로 적는다. 어느 쪽이 맞는가?[^ref-296]
