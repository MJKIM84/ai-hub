...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-601, ref-602, ref-186, ref-604, ref-470, ref-608, ref-609, ref-406]
last_run: 2026-09-25
version: 1
...
- [15. 다중 로봇 경로·교통 관리 — MAPF](../../categories/d-planning-and-optimization/15-multi-robot-path-and-traffic-management-mapf.md) — MAPF 벤치마크, FMS 안의 현실적 평가, 창고 AGV 교착 분석이 경로·교통 관리 논리를 시험 대상으로 삼는다. [사실][^ref-186][^ref-604][^ref-609]
- [12. 명령·작업 실행의 신뢰성](../../categories/c-connectivity-and-execution-foundation/12-command-and-task-execution-reliability.md) — 런타임 검증 틀은 안전하지 않은 메시지·서비스 요청을 걸러 낼 수 있어 명령 실행 보장과 이어진다. [사실][^ref-602]
- [19. 모니터링·이상 탐지·원인 분석](../../categories/e-collaboration-and-field-operations/19-monitoring-anomaly-detection-and-root-cause-analysis.md) — 런타임 검증은 운영 중 사건을 감시·기록한다. [사실][^ref-602]
- [20. 예외 복구·재계획·업무 연속성](../../categories/e-collaboration-and-field-operations/20-exception-recovery-replanning-and-business-continuity.md) — 계획 실패 시 복구 방식을 비교한 연구가 있어 복구 설계를 시험으로 확인하는 연결점이 된다. [사실][^ref-604]
- [24. 자산·소프트웨어 수명주기 관리](../../categories/f-deployment-verification-and-maintenance/24-asset-and-software-lifecycle-management.md) — 펌웨어·어댑터 업데이트마다 장애 시나리오를 다시 돌리는 회귀 시험이 필요해 보인다. [추정][^ref-601][^ref-406]
