...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-228, ref-230, ref-523, ref-403, ref-553, ref-554, ref-555, ref-559]
last_run: 2026-09-25
version: 1
...
- [23. 시험·형식 검증·벤치마크](../../categories/f-deployment-verification-and-maintenance/23-testing-formal-verification-and-benchmarking.md) — 업데이트 뒤 정상·장애 상황의 회귀 시험이 재검증 범위 산정의 결과를 받는다. [의견][^ref-559]
...
- [26. 사이버보안·접근권한·개인정보](../../categories/g-safety-security-intelligence-and-governance/26-cybersecurity-access-control-and-privacy.md) — 보안 패치의 배포·설치가 이 영역의 배포 절차와 겹친다. [의견][^ref-554]
- [25. 안전·위험 관리](../../categories/g-safety-security-intelligence-and-governance/25-safety-and-risk-management.md) — 펌웨어·안전 파라미터 변경 뒤 위험성 재평가와 실질적 변경 판단이 필요하다. [의견][^ref-559][^ref-555]
...
- [19. 모니터링·이상 탐지·원인 분석](../../categories/e-collaboration-and-field-operations/19-monitoring-anomaly-detection-and-root-cause-analysis.md) — 상태 감시·고장 진단 결과와 오류 코드가 정비 판단의 입력이 된다. [의견][^ref-553]
