...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-031, ref-634, ref-636, ref-637, ref-638]
last_run: 2026-09-25
version: 1
...
대표 규격인 VDA 5050 은 VDA 와 VDMA 가 개발하고 카를스루에 공대(KIT) 물류연구소(IFL)가 위탁을 받아 개발을 주도하며 공식 GitHub 저장소를 관리한다(확인일 2026-09-25). [사실][^ref-031][^ref-634] 명세는 사용이 선택적이고 구속력이 없다고 스스로 밝힌다. [사실][^ref-031] 공식 저장소 README 는 VDA 웹사이트의 공식 PDF 가 GitHub 내용보다 우선하며, 어느 판에 대해서도 지원·유지보수·문제 해결을 받을 법적 권리가 없다고 적는다. [사실][^ref-634] 규격을 만든 기구에 현장 연동 오류의 수정을 기대할 수 없으므로, 수정과 변경 승인은 현장 사업자 사이의 약속으로 정해야 한다. [의견]

데이터도 여러 사업자가 함께 만든다. EU 데이터법(Regulation (EU) 2023/2854)은 2023-12-13 채택되어 2024-01-11 발효됐으며, 제품 제조사와 데이터 보유자에게 데이터 공유·상호운용성 의무를, 데이터 처리 서비스 제공자에게 고객의 사업자 전환 허용 의무를 둔다. [사실][^ref-636] 주요 조항의 적용 개시일은 미확인이다.

한국 산업디지털전환촉진법은 상당한 투자와 노력으로 산업데이터를 새로 생성한 자에게 사용·수익 권리를 주고, 2인 이상이 공동으로 생성하거나 제3자에게 제공한 경우 당사자 약정이 없으면 각자 사용·수익 권리를 가진다고 정한다(법률 제18692호, 2022-01-04 공포 기준). [사실][^ref-637][^ref-638] 2025-05-27 일부개정 판에서 같은 조문인지는 미확인이다.
