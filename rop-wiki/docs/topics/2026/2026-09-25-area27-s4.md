...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-092, ref-359, ref-618, ref-088, ref-351, ref-626]
last_run: 2026-09-25
version: 1
...
- **AI 관리 시스템(Artificial Intelligence Management System, AIMS)** — ISO/IEC 42001:2023이 수립·실행·유지·지속 개선 요구사항을 정하는 조직 차원의 관리 체계다. [사실][^ref-618]
- **모델 레지스트리(Model Registry)** — MLflow의 모델 레지스트리는 등록 모델마다 버전·별칭·태그와 계보(어느 실험·실행이 만들었는지)를 관리한다. [사실][^ref-626]
