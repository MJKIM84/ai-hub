...
created: 2026-09-25
updated: 2026-09-25
sources: [ref-005, ref-006, ref-031, ref-079, ref-186, ref-188]
last_run: 2026-09-25
version: 1
...
- **[다중 에이전트 경로 찾기](../../glossary/mapf.md)(Multi-Agent Path Finding, MAPF)** — 여러 에이전트가 서로 충돌하지 않고 동시에 따라갈 경로를 계획하는 문제다. 목적함수로는 마지막 도착 시각(makespan)이나 행동 비용의 합(sum of costs)이 쓰인다. [사실][^ref-186]
...
- **행동 의존 그래프(Action Dependency Graph)** — MAPF 계획에서 로봇 사이 통과 순서를 의존 관계로 기록해, 지연이 생겨도 그 순서를 지키며 계획을 실행하게 하는 그래프다. [사실][^ref-188]
