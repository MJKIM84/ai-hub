---
title: "ref-388 — 복수 포장대와 피킹-패킹 전환 정책을 운영하는 물류센터에서의 작업자 스케줄링"
type: reference
ref_id: ref-388
ref_title: 복수 포장대와 피킹-패킹 전환 정책을 운영하는 물류센터에서의 작업자 스케줄링
...
[홈](../index.md) › [참고문헌](index.md) › ref-388

# ref-388 — 복수 포장대와 피킹-패킹 전환 정책을 운영하는 물류센터에서의 작업자 스케줄링
...
|---|---|
| id | ref-388 |
| 기관 | Tran Bo Tao Huong, 이광헌, 홍순도(대한산업공학회지) |
| 제목 | 복수 포장대와 피킹-패킹 전환 정책을 운영하는 물류센터에서의 작업자 스케줄링 |
| 발행일 | 2025 |
| URL | <https://www.kci.go.kr/kciportal/ci/sereArticleSearch/ciSereArtiView.kci?sereArticleSearchBean.artiId=ART003194570> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 복수 포장대와 피킹-패킹 전환 정책을 운영하는 물류센터의 작업자 배치·스케줄링 연구(대한산업공학회지 51(2), 142-149). 결과 수치 미확인.

등록 실행: 2026-09-25-34 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-388]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
