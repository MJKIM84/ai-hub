---
title: "ref-107 — 물류시설의 개발 및 운영에 관한 법률"
type: reference
ref_id: ref-107
ref_title: 물류시설의 개발 및 운영에 관한 법률
org: 법제처 국가법령정보센터
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-107

# ref-107 — 물류시설의 개발 및 운영에 관한 법률
...
원문 미열람. 물류시설 개발·운영의 근거 법률로 제21조의4에 스마트물류센터 인증 근거를 둔다(시행규칙 서식은 2025-04-01 개정).

등록 실행: 2026-09-25-10 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-107]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
