---
title: "ref-617 — NIST Risk Management Framework Aims to Improve Trustworthiness of Artificial Intelligence"
type: reference
ref_id: ref-617
ref_title: NIST Risk Management Framework Aims to Improve Trustworthiness of Artificial Intelligence
org: NIST
...
[홈](../index.md) › [참고문헌](index.md) › ref-617

# ref-617 — NIST Risk Management Framework Aims to Improve Trustworthiness of Artificial Intelligence
...
| id | ref-617 |
| 기관 | NIST |
| 제목 | NIST Risk Management Framework Aims to Improve Trustworthiness of Artificial Intelligence |
| 발행일 | 2023-01-26 |
| URL | <https://nist.gov/news-events/news/2023/01/nist-risk-management-framework-aims-improve-trustworthiness-artificial> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. NIST AI RMF 1.0(NIST AI 100-1) 발표문. 네 기능 Govern·Map·Measure·Manage.

등록 실행: 2026-09-25-68 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-617]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
