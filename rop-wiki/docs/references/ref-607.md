---
title: "ref-607 — 시험평가 | KIRIA 첨단로봇 실증지원 디지털 플랫폼"
type: reference
ref_id: ref-607
ref_title: 시험평가 | KIRIA 첨단로봇 실증지원 디지털 플랫폼
org: 한국로봇산업진흥원(KIRIA)
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-607

# ref-607 — 시험평가 | KIRIA 첨단로봇 실증지원 디지털 플랫폼
...
| id | ref-607 |
| 기관 | 한국로봇산업진흥원(KIRIA) |
| 제목 | 시험평가 | KIRIA 첨단로봇 실증지원 디지털 플랫폼 |
| 발행일 | 미확인 |
| URL | <https://kiria.org/rp/kiria/tva/inr/page.dn> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. 한국로봇산업진흥원의 표준 기반 로봇 시험평가와 주행 성능 시험 항목 안내 페이지.

등록 실행: 2026-09-25-59 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-607]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
