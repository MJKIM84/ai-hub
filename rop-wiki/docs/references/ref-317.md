---
title: "ref-317 — 승강기협회 '로봇-승강기 연동 표준개발'로 승강기 4차산업 견인"
type: reference
ref_id: ref-317
ref_title: 승강기협회 '로봇-승강기 연동 표준개발'로 승강기 4차산업 견인
org: 전기신문
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-317

# ref-317 — 승강기협회 '로봇-승강기 연동 표준개발'로 승강기 4차산업 견인
...
| id | ref-317 |
| 기관 | 전기신문 |
| 제목 | 승강기협회 '로봇-승강기 연동 표준개발'로 승강기 4차산업 견인 |
| 발행일 | 미확인 |
| URL | <https://www.electimes.com/news/articleView.html?idxno=320147> |
| 유형 | 기사 |
| 신뢰도 | low |
...
원문 미열람. 대한승강기협회 주도 승강기·로봇 협의체의 연동 프로토콜(안)·시나리오(안) 협의를 전한 기사.

등록 실행: 2026-09-25-25 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-317]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
