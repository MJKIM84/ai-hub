---
title: "ref-203 — SEMI E84: Carrier Handoff"
type: reference
ref_id: ref-203
ref_title: 'SEMI E84: Carrier Handoff'
org: PEER Group
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-203

# ref-203 — SEMI E84: Carrier Handoff
...
원문 미열람. 반도체 자동화 소프트웨어 업체의 SEMI E84 해설 페이지로, 신호 교환으로 인계 준비·진행·완료를 확인한다고 설명한다.

등록 실행: 2026-09-25-42 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-203]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
