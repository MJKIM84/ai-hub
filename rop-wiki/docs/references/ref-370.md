---
title: "ref-370 — Behavior Trees in Robotics and AI: An Introduction"
type: reference
ref_id: ref-370
ref_title: 'Behavior Trees in Robotics and AI: An Introduction'
...
[홈](../index.md) › [참고문헌](index.md) › ref-370

# ref-370 — Behavior Trees in Robotics and AI: An Introduction
...
원문 미열람. 로봇·AI 에서 행동 트리의 구조, 모듈성·반응성, 설계 원칙을 소개하는 입문서(프리프린트, 이후 책으로 출간).

등록 실행: 2026-09-25-31 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-370]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
