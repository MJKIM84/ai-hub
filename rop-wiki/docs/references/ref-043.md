---
title: "ref-043 — 자산관리쉘 표준을 이용한 자율이동로봇 모니터링 시스템 설계"
type: reference
ref_id: ref-043
ref_title: 자산관리쉘 표준을 이용한 자율이동로봇 모니터링 시스템 설계
org: 신민종, 한영석, 정재윤
published: '2024'
...
[홈](../index.md) › [참고문헌](index.md) › ref-043

# ref-043 — 자산관리쉘 표준을 이용한 자율이동로봇 모니터링 시스템 설계
...
| id | ref-043 |
| 기관 | 신민종, 한영석, 정재윤 |
| 제목 | 자산관리쉘 표준을 이용한 자율이동로봇 모니터링 시스템 설계 |
| 발행일 | 2024 |
| URL | <https://www.kci.go.kr/kciportal/ci/sereArticleSearch/ciSereArtiView.kci?sereArticleSearchBean.artiId=ART003140560> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 한국전자거래학회지 29(4), 203-213쪽 게재 논문(2024). 게재 사실만 확인했고 본문 내용은 미확인.

등록 실행: 2026-09-25-02 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-043]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
