---
title: "ref-766 — 개인정보의 안전성 확보조치 기준"
type: reference
ref_id: ref-766
ref_title: 개인정보의 안전성 확보조치 기준
...
[홈](../index.md) › [참고문헌](index.md) › ref-766

# ref-766 — 개인정보의 안전성 확보조치 기준
...
원문 미열람. 개인정보처리시스템 접근권한 차등 부여와 권한 변경 기록 3년 보관 등을 정한 고시(현행판 여부 미확인).

등록 실행: 2026-09-25-83 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-766]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
