...
[홈](../index.md) › [참고문헌](index.md) › ref-587
...
원문 미열람. 개인정보 보호법 본문. 제25조의2 이동형 영상정보처리기기의 운영 제한.

등록 실행: 2026-09-25-64 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-587]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
...
- [변경 이력](../changelog.md)
- [이동형 영상정보처리기기 (Mobile Video Information Processing Device)](../glossary/mobile-video-information-processing-device.md)
