---
title: "ref-639 — osra-policies-and-procedures — README"
type: reference
ref_id: ref-639
ref_title: osra-policies-and-procedures — README
...
[홈](../index.md) › [참고문헌](index.md) › ref-639

# ref-639 — osra-policies-and-procedures — README
...
|---|---|
| id | ref-639 |
| 기관 | Open Source Robotics Alliance (Open Robotics) |
| 제목 | osra-policies-and-procedures — README |
| 발행일 | 미확인 |
| URL | <https://github.com/openrobotics/osra-policies-and-procedures> |
| 유형 | 오픈소스 문서 |
| 신뢰도 | medium |
...
OSRA 정책·절차 문서 저장소. TGC 문서 승인·이사회 비준, PMC 의 저장소 목록·작업반 헌장 비준, 개정 제안 절차.

등록 실행: 2026-09-25-69 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-639]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
...
| 열람 경로 | GitHub raw 미러 <https://raw.githubusercontent.com/openrobotics/osra-policies-and-procedures/main/README.md> |
| 원문 텍스트 | 없음 |
