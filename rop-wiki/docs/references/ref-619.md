---
title: "ref-619 — ISO/IEC 23894:2023 - AI — Guidance on risk management"
type: reference
ref_id: ref-619
ref_title: ISO/IEC 23894:2023 - AI — Guidance on risk management
org: ISO/IEC
published: 2023-02
...
[홈](../index.md) › [참고문헌](index.md) › ref-619

# ref-619 — ISO/IEC 23894:2023 - AI — Guidance on risk management
...
| id | ref-619 |
| 기관 | ISO/IEC |
| 제목 | ISO/IEC 23894:2023 - AI — Guidance on risk management |
| 발행일 | 2023-02 |
| URL | <https://www.iso.org/standard/77304.html> |
| 유형 | 표준 |
| 신뢰도 | medium |
...
원문 미열람. ISO 31000 을 AI 에 적용한 위험관리 지침 소개 페이지.

등록 실행: 2026-09-25-68 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-619]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
