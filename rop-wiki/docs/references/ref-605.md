---
title: "ref-605 — ASTM Committee F45 on Driverless Automatic Guided Industrial Vehicles"
type: reference
ref_id: ref-605
ref_title: ASTM Committee F45 on Driverless Automatic Guided Industrial Vehicles
org: NIST
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-605

# ref-605 — ASTM Committee F45 on Driverless Automatic Guided Industrial Vehicles
...
| id | ref-605 |
| 기관 | NIST |
| 제목 | ASTM Committee F45 on Driverless Automatic Guided Industrial Vehicles |
| 발행일 | 미확인 |
| URL | <https://www.nist.gov/programs-projects/astm-committee-f45-driverless-automatic-guided-industrial-vehicles> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. 무인 자동 유도 산업 차량의 용어·시험 방법을 개발하는 ASTM F45 위원회와 NIST 참여를 소개하는 과제 페이지.

등록 실행: 2026-09-25-59 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-605]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
