---
title: "ref-474 — '이동식 산업용 로봇' 안전 가이드 어떤 내용 담고 있나?"
type: reference
ref_id: ref-474
ref_title: '''이동식 산업용 로봇'' 안전 가이드 어떤 내용 담고 있나?'
org: 로봇신문
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-474

# ref-474 — '이동식 산업용 로봇' 안전 가이드 어떤 내용 담고 있나?
...
| id | ref-474 |
| 기관 | 로봇신문 |
| 제목 | '이동식 산업용 로봇' 안전 가이드 어떤 내용 담고 있나? |
| 발행일 | 미확인 |
| URL | <https://www.irobotnews.com/news/articleView.html?idxno=32130> |
| 유형 | 기사 |
| 신뢰도 | low |
...
원문 미열람. 2023-07 이동식 산업용 로봇 안전 가이드의 충돌방지·비상정지 내용을 소개한 기사.

등록 실행: 2026-09-25-46 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-474]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
