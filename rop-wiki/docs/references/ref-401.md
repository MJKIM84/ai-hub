---
title: "ref-401 — 클라우드에 연결된 개별 로봇 및 로봇그룹의 작업 계획 기술 개발"
type: reference
ref_id: ref-401
ref_title: 클라우드에 연결된 개별 로봇 및 로봇그룹의 작업 계획 기술 개발
...
[홈](../index.md) › [참고문헌](index.md) › ref-401

# ref-401 — 클라우드에 연결된 개별 로봇 및 로봇그룹의 작업 계획 기술 개발
...
|---|---|
| id | ref-401 |
| 기관 | KISTI ScienceON 수록 국가R&D 과제 보고서(수행기관 미확인) |
| 제목 | 클라우드에 연결된 개별 로봇 및 로봇그룹의 작업 계획 기술 개발 |
| 발행일 | 미확인 |
| URL | <https://scienceon.kisti.re.kr/srch/selectPORSrchReport.do?cn=TRKO202400003952> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. 클라우드 기반 개별·다중 로봇 작업 수립·할당·재조정·학습 기술을 제조·물류에서 실증하는 국내 과제 보고서.

등록 실행: 2026-09-25-33 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-401]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
