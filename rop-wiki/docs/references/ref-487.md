---
title: "ref-487 — 재해경감 우수기업 인증제도"
type: reference
ref_id: ref-487
ref_title: 재해경감 우수기업 인증제도
org: 행정안전부
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-487

# ref-487 — 재해경감 우수기업 인증제도
...
원문 미열람. 재해경감을 위한 기업의 자율활동 지원에 관한 법률에 따른 기업재난관리표준과 재해경감 우수기업 인증 절차 안내.

등록 실행: 2026-09-25-50 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-487]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
