---
title: "ref-475 — ｢대구 이동식 협동로봇 규제자유특구｣ 산업표준 제정으로, 이동식 협동로봇 상용화 길 열렸다!"
type: reference
ref_id: ref-475
ref_title: ｢대구 이동식 협동로봇 규제자유특구｣ 산업표준 제정으로, 이동식 협동로봇 상용화 길 열렸다!
...
[홈](../index.md) › [참고문헌](index.md) › ref-475

# ref-475 — ｢대구 이동식 협동로봇 규제자유특구｣ 산업표준 제정으로, 이동식 협동로봇 상용화 길 열렸다!
...
|---|---|
| id | ref-475 |
| 기관 | 중소벤처기업부(대한민국 정책브리핑) |
| 제목 | ｢대구 이동식 협동로봇 규제자유특구｣ 산업표준 제정으로, 이동식 협동로봇 상용화 길 열렸다! |
| 발행일 | 2024-11 |
| URL | <https://www.korea.kr/briefing/pressReleaseView.do?newsId=156658517> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. 대구 규제자유특구 실증을 거친 이동식 협동로봇 안전기준 KS 제정을 알린 보도자료.

등록 실행: 2026-09-25-46 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-475]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
