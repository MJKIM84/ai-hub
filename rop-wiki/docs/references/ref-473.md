---
title: "ref-473 — 고정식 이동식 산업용 로봇의 협동작업 안전 가이드 배포"
type: reference
ref_id: ref-473
ref_title: 고정식 이동식 산업용 로봇의 협동작업 안전 가이드 배포
org: 고용노동부
published: 2023-07
...
[홈](../index.md) › [참고문헌](index.md) › ref-473

# ref-473 — 고정식 이동식 산업용 로봇의 협동작업 안전 가이드 배포
...
| id | ref-473 |
| 기관 | 고용노동부 |
| 제목 | 고정식 이동식 산업용 로봇의 협동작업 안전 가이드 배포 |
| 발행일 | 2023-07 |
| URL | <https://www.moel.go.kr/policy/policydata/view.do?bbs_seq=20230700065> |
| 유형 | 정부·연구기관 |
| 신뢰도 | medium |
...
원문 미열람. 고용노동부·한국산업안전보건공단의 고정식·이동식 산업용 로봇 협동작업 안전 가이드 게시 자료.

등록 실행: 2026-09-25-46 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-473]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
