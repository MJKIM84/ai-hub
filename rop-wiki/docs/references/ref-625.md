---
title: "ref-625 — The ML Test Score: A Rubric for ML Production Readiness and Technical Debt Reduction"
type: reference
ref_id: ref-625
ref_title: 'The ML Test Score: A Rubric for ML Production Readiness and Technical Debt Reduction'
...
[홈](../index.md) › [참고문헌](index.md) › ref-625

# ref-625 — The ML Test Score: A Rubric for ML Production Readiness and Technical Debt Reduction
...
|---|---|
| id | ref-625 |
| 기관 | Breck, E. 외 (Google Research) |
| 제목 | The ML Test Score: A Rubric for ML Production Readiness and Technical Debt Reduction |
| 발행일 | 2017 |
| URL | <https://research.google/pubs/the-ml-test-score-a-rubric-for-ml-production-readiness-and-technical-debt-reduction/> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 28개 시험·감시 항목으로 ML 운영 준비도를 점수화하는 기준표(IEEE Big Data 2017).

등록 실행: 2026-09-25-68 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-625]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
