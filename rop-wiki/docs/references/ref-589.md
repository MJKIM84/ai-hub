---
title: "ref-589 — 근로자참여 및 협력증진에 관한 법률"
type: reference
ref_id: ref-589
ref_title: 근로자참여 및 협력증진에 관한 법률
org: 법제처 국가법령정보센터
published: 미확인
...
[홈](../index.md) › [참고문헌](index.md) › ref-589

# ref-589 — 근로자참여 및 협력증진에 관한 법률
...
원문 미열람. 제20조(협의 사항)에 '사업장 내 근로자 감시 설비의 설치'를 두는 법률(호 번호 미확인).

등록 실행: 2026-09-25-64 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-589]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
