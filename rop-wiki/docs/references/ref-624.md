---
title: "ref-624 — Hidden Technical Debt in Machine Learning Systems"
type: reference
ref_id: ref-624
ref_title: Hidden Technical Debt in Machine Learning Systems
org: Sculley, D. 외
published: '2015'
...
[홈](../index.md) › [참고문헌](index.md) › ref-624

# ref-624 — Hidden Technical Debt in Machine Learning Systems
...
| id | ref-624 |
| 기관 | Sculley, D. 외 |
| 제목 | Hidden Technical Debt in Machine Learning Systems |
| 발행일 | 2015 |
| URL | <https://papers.nips.cc/paper/5656-hidden-technical-debt-in-machine-learning-systems> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. ML 시스템 고유의 기술 부채와 위험 요인(NeurIPS 2015).

등록 실행: 2026-09-25-68 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-624]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
