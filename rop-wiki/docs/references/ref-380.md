---
title: "ref-380 — Design and control of warehouse order picking: A literature review"
type: reference
ref_id: ref-380
ref_title: 'Design and control of warehouse order picking: A literature review'
...
[홈](../index.md) › [참고문헌](index.md) › ref-380

# ref-380 — Design and control of warehouse order picking: A literature review
...
|---|---|
| id | ref-380 |
| 기관 | de Koster, R., Le-Duc, T., & Roodbergen, K. J. |
| 제목 | Design and control of warehouse order picking: A literature review |
| 발행일 | 2007 |
| URL | <https://pure.eur.nl/en/publications/design-and-control-of-warehouse-order-picking-a-literature-review/> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 수동 주문 피킹의 레이아웃·보관 배정·경로·배치·구역화 결정 문제를 정리한 EJOR 문헌 검토.

등록 실행: 2026-09-25-34 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-380]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
...
- [변경 이력](../changelog.md)
- [주문 배치 (Order Batching)](../glossary/order-batching.md)
