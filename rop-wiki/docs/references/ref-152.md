---
title: "ref-152 — Task Allocation in Mobile Robot Fleets: A review"
type: reference
ref_id: ref-152
ref_title: 'Task Allocation in Mobile Robot Fleets: A review'
...
[홈](../index.md) › [참고문헌](index.md) › ref-152

# ref-152 — Task Allocation in Mobile Robot Fleets: A review
...
|---|---|
| id | ref-152 |
| 기관 | Meseguer Valenzuela, A., & Blanes Noguera, F. |
| 제목 | Task Allocation in Mobile Robot Fleets: A review |
| 발행일 | 2025-01 |
| URL | <https://arxiv.org/abs/2501.08726> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 이동로봇 플릿의 작업 배정 문제와 AI 기반 방법을 포함한 최적화 알고리즘을 검토한 리뷰 프리프린트.

등록 실행: 2026-09-25-15 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-152]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
