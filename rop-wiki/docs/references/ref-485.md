---
title: "ref-485 — Multiagent Rollout with Reshuffling for Warehouse Robots Path Planning"
type: reference
ref_id: ref-485
ref_title: Multiagent Rollout with Reshuffling for Warehouse Robots Path Planning
...
[홈](../index.md) › [참고문헌](index.md) › ref-485

# ref-485 — Multiagent Rollout with Reshuffling for Warehouse Robots Path Planning
...
|---|---|
| id | ref-485 |
| 기관 | Emanuelsson, W., Penacho Riveiros, A., Li, Y., Johansson, K. H., & Mårtensson, J. (KTH) |
| 제목 | Multiagent Rollout with Reshuffling for Warehouse Robots Path Planning |
| 발행일 | 2023 |
| URL | <https://arxiv.org/abs/2211.08201> |
| 유형 | 논문 |
| 신뢰도 | medium |
...
원문 미열람. 창고 로봇 경로 계획용 다중 에이전트 롤아웃 방법으로, 온라인 재계획으로 로봇 고장에 적응하는 예제를 보인다(IFAC 게재, 프리프린트).

등록 실행: 2026-09-25-50 · 검증: 1차 조건부 승인 / 2차 통과

## 인용된 페이지

이 출처를 프런트매터 `sources` 또는 각주 `[^ref-485]` 로 인용했거나 이 페이지로 링크한 페이지의 목록이다. 퍼블리셔가 docs 전체를 스캔해 자동으로 갱신한다.
