...
| 건축 도면 자동 인식 | [단계 1. 선행 연구·제품 사례 조사](tracks/floorplan-recognition/stage-1-prior-work-and-products.md) (1 / 5) | active | 34 | q5-02 — 현장 모델링 시간 단축 효과를 어떤 기준(수작업 대비 소요 시간, 수정 횟수)으로 측정하는가? ([답](tracks/floorplan-recognition/stage-5-verification-and-hypotheses.md#q5-02)) | [트랙 개요](tracks/floorplan-recognition/index.md) |
