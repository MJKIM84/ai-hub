...
- 2026-09-24 · 갱신 · agents/verifier.md — 내용 검증 에이전트 프롬프트 1.2 → 1.3: 소속 대분류 상자 글자 단위 대조, 질문–발견 사항 대응 규약 검사 추가 (실행 manual-2026-09-24)
- 2026-09-24 · 생성 · docs/ — 위키 뼈대 생성(홈·소개·대분류·세부영역·횡단·트랙 시드) (실행 build-2026-09-24)
