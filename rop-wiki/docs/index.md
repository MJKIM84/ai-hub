...
| 자연어 업무 지시 챗봇 | [단계 1. 선행 연구·제품 사례 조사](tracks/nl-task-chatbot/stage-1-prior-work-and-products.md) (1 / 5) | active | 40 | q5-01 — 해석·분해 정확도, 배정 적합성, 일정 품질을 각각 어떤 지표로 측정하는가? ([답](tracks/nl-task-chatbot/stage-5-verification-and-hypotheses.md#q5-01)) | [트랙 개요](tracks/nl-task-chatbot/index.md) |
