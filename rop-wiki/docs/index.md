...
- 2026-09-26 · 생성 · [2026-W39 주간 정리](logs/weekly/2026-W39.md) — 2026-W39 주간 정리 신규 작성(실행 90회 정리, 링크·출처 점검 3건, 참고문헌 중복 2묶음) (실행 2026-09-26-01)
- 2026-09-26 · 갱신 · [ref-637 — 산업 디지털 전환 촉진법 (법률 제18692호)](references/ref-637.md) — 각주 형식 절에 퍼센트 인코딩 URL 을 적고 제명 변경 가능성을 [추정]·원문 미열람으로 병기, needs_update (등록 URL 교체는 pipeline 담당 요청) (실행 2026-09-26-01)
- 2026-09-26 · 폐기 · [ref-709 — 국가표준(KS) 제정으로 로봇의 엘리베이터 탑승 돕는다](references/ref-709.md) — ref-315 와 같은 보도자료를 가리키는 중복 항목으로 deprecated 처리, 대체 페이지 ref-315(프런트매터 replaced_by 추가) (실행 2026-09-26-01)
- 2026-09-26 · 요약 · [2026-W39 주간 정리](logs/weekly/2026-W39.md) — 주간 정리 2026-W39: 이번 주 실행 90회 정리, ref-637 URL 인코딩 표기·needs_update, ref-709 deprecated(대체 ref-315), 참고문헌 중복 후보 기록 (실행 2026-09-26-01)
