...
| 자연어 업무 지시 챗봇 | [단계 1. 선행 연구·제품 사례 조사](tracks/nl-task-chatbot/stage-1-prior-work-and-products.md) (1 / 5) | active | 40 | q4-01 — LLM의 잘못된 해석이 로봇 배정으로 이어지지 않게 하는 확인 절차는 어떻게 두는가? ([답](tracks/nl-task-chatbot/stage-4-misinterpretation-safeguards.md#q4-01)) | [트랙 개요](tracks/nl-task-chatbot/index.md) |
