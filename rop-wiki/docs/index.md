...
| 자연어 업무 지시 챗봇 | [단계 1. 선행 연구·제품 사례 조사](tracks/nl-task-chatbot/stage-1-prior-work-and-products.md) (1 / 5) | active | 46 | q5-02 — 가상 현장·가상 로봇으로 지시 시나리오를 재현해 챗봇을 시험하는 방법과 그 한계는 무엇인가? ([답](tracks/nl-task-chatbot/stage-5-verification-and-hypotheses.md#q5-02)) | [트랙 개요](tracks/nl-task-chatbot/index.md) |
