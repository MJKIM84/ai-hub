...
| 건축 도면 자동 인식 | [단계 1. 선행 연구·제품 사례 조사](tracks/floorplan-recognition/stage-1-prior-work-and-products.md) (1 / 5) | active | 29 | q4-01 — 인식 결과를 로봇 내비게이션 지도로 바꿀 때 필요한 보정은 무엇인가? ([답](tracks/floorplan-recognition/stage-4-map-conversion-and-site-alignment.md#q4-01)) | [트랙 개요](tracks/floorplan-recognition/index.md) |
